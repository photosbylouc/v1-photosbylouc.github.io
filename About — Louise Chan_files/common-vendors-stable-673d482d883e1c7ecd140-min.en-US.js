...
*/ typeof _ != "undefined" && (_._YUI = _);
      var _ = function () {
        ...
        if (
          (r(u, _)
            ? (u._init(),
              _.GlobalConfig && u.applyConfig(_.GlobalConfig),
              a && u.applyConfig(a),
              d || u._setup())
            : (u = new _()),
          d)
      ...
      (function () {
        var v,
          ...
          A = { "io.xdrReady": 1, "io.xdrResponse": 1, "SWF.eventHandler": 1 },
          ...
          f = function (x, S, D, M) {
            x && x.addEventListener
              ? x.addEventListener(S, D, M)
              : x && x.attachEvent && x.attachEvent("on" + S, D);
          },
          b = function (x, S, D, M) {
            if (x && x.removeEventListener)
              try {
                x.removeEventListener(S, D, M);
              } catch (L) {}
            else x && x.detachEvent && x.detachEvent("on" + S, D);
          },
          N = function () {
            (_.Env.DOMReady = !0), E && b(s, "DOMContentLoaded", N);
          },
          O = function () {
            (_.Env.windowLoaded = !0),
              (_.Env.DOMReady = !0),
              E && b(window, "load", O);
          },
          y = function (x, S) {
            ...
            return (
              D
                ? ((D.ignoreRegistered = !1),
                  (D.onEnd = null),
                  (D.data = null),
                  (D.required = []),
                  (D.loadType = null))
                : ((D = new x.Loader(x.config)), (x.Env._loader = D)),
              w && w.loader && (M = [].concat(M, _.Env.loaderExtras)),
              (_.Env.core = x.Array.dedupe([].concat(_.Env.core, M))),
              D
            );
          },
          C = function (x, S) {
        ...
        (v = {
          stats: {
            ...
            getSerializedDataForReporter: function () {
              var x = {},
                S = v.stats.getAll();
              return (
                Y.Object.keys(S).forEach(function (D) {
                  var M = S[D],
                    L = M.create,
                    w = M.initializer,
                    P = M.destructor;
                  x.hasOwnProperty(L) || (x[L] = {}),
                    x[L].hasOwnProperty(w) || (x[L][w] = {}),
                    x[L][w].hasOwnProperty(P) || (x[L][w][P] = []),
                    x[L][w][P].push(D);
                }),
                x
              );
            ...
            for (D in x)
              x.hasOwnProperty(D) &&
                ...
                L && D == "modules"
                  ...
                  ? C(w, S)
                  : D == "win"
                  ? ((M[D] = (S && S.contentWindow) || S),
                    (M.doc = M[D] ? M[D].document : null))
                  : D == "_yuid" || (M[D] = S));
            R && R._config(x);
          },
          _config: function (x) {
          ...
          _init: function () {
            ...
            if (((D.version = n), !L)) {
              if (
                ((D.Env = {
                  ...
                  parseBasePath: function (P, R) {
                    ...
                    return (
                      k &&
                        ((F =
                          RegExp.leftContext || P.slice(0, P.indexOf(k[0]))),
                        (X = k[3]),
                        k[1] && (F += "?" + k[1]),
                        (F = { filter: X, path: F })),
                      F
                ...
                (L._yidx = ++M._yidx),
                  (L._guidp = ("yui_" + n + "_" + L._yidx + "_" + p).replace(
                    /[^a-z0-9_]+/g,
                    "_"
                  ));
              else if (_._YUI) {
            ...
            (D.constructor = _),
              ...
              s && !s.getElementById(i)
                ? ((S = s.createElement("div")),
                  (S.innerHTML =
                    '<div id="' +
                    i +
                    '" style="position: absolute !important; visibility: hidden !important"></div>'),
                  (_.Env.cssStampEl = S.firstChild),
                  s.body
                    ? s.body.appendChild(_.Env.cssStampEl)
                    : c.insertBefore(_.Env.cssStampEl, c.firstChild))
                : s &&
                  s.getElementById(i) &&
                  !_.Env.cssStampEl &&
                  (_.Env.cssStampEl = s.getElementById(i)),
              (D.config.lang = D.config.lang || "en-US"),
              (D.config.base = _.config.base || D.Env.getBase(D.Env._BASE_RE)),
              (!x || !"mindebug".indexOf(x)) && (x = "min"),
              (x = x && "-" + x),
              (D.config.loaderPath =
                _.config.loaderPath || "loader/loader" + x + ".js");
          },
          _setup: function () {
            var x,
              S = this,
          ...
          applyTo: function (x, S, D) {
            if (!(S in A))
              return this.log(S + ": applyTo not allowed", "warn", "yui"), null;
            var M = t[x],
              L,
              w,
              P;
            if (M) {
              for (L = S.split("."), w = M, P = 0; P < L.length; P = P + 1)
                (w = w[L[P]]),
                  w || this.log("applyTo not found: " + S, "warn", "yui");
          ...
          add: function (x, S, D, M) {
            M = M || {};
            var L = _.Env,
              w = { name: x, fn: S, version: D, details: M },
              P = {},
              R,
              k,
              F,
          ...
          _attach: function (x, S) {
            ...
            for (D = 0; D < te; D++)
              if (((M = x[D]), (L = F[M]), re.push(M), G && G.conditions[M]))
                for (H in G.conditions[M])
                  G.conditions[M].hasOwnProperty(H) &&
                    ((z = G.conditions[M][H]),
                    (K = z && ((z.ua && B.UA[z.ua]) || (z.test && z.test(B)))),
                    K && re.push(z.name));
            for (x = re, te = x.length, D = 0; D < te; D++)
              if (!j[x[D]]) {
                ...
                if (!L)
                  (Z = G && G.getModuleInfo(M)),
                    Z && ((L = Z), (S = !0)),
                    !S &&
                      M &&
                      M.indexOf("skin-") === -1 &&
                      M.indexOf("css") === -1 &&
                      (B.Env._missed.push(M),
                      (B.Env._missed = B.Array.dedupe(B.Env._missed)),
                      B.message("NOT loaded: " + M, "warn", "yui"));
                else {
                  for (j[M] = !0, H = 0; H < B.Env._missed.length; H++)
                    B.Env._missed[H] === M &&
                      (B.message(
                        "Found: " + M + " (was reported as missing earlier)",
                        "warn",
                        "yui"
                      ),
                      B.Env._missed.splice(H, 1));
                  if (G && !G._canBeAttached(M)) return !0;
                  if (G && V && V[M] && V[M].temp) {
                    G.getRequires(V[M]), (P = []), (Z = G.getModuleInfo(M));
                    for (H in Z.expanded_map)
                      Z.expanded_map.hasOwnProperty(H) && P.push(H);
                    B._attach(P);
                  }
                  if (
                    ((w = L.details),
                  ...
                  if (L.fn) {
                    if (
                      ((se = [B, M]),
                      $ && ((ie = {}), (ee = {}), se.push(ie, ee), P))
                    )
                      for (J = P.length, H = 0; H < J; H++)
                        ie[P[H]] = W.hasOwnProperty(P[H]) ? W[P[H]] : B;
                    ...
                    $ &&
                      ((W[M] = ee),
                      (Q = L.details.condition),
                      Q && Q.when === "instead" && (W[Q.trigger] = ee));
                  }
                  if (R) {
          ...
          use: function () {
            ...
            if (
              (D.Lang.isFunction(S)
                ? (x.pop(),
                  D.config.delayUntil &&
                    (S = D._delayCallback(S, D.config.delayUntil)))
                : (S = null),
              D.Lang.isArray(x[0]) && (x = x[0]),
              D.config.cacheUse)
            ) {
              for (; (L = x[M++]); )
                if (!w._attached[L]) {
            ...
            typeof x[x.length - 1] == "function" &&
              ...
              x.push(function (D) {
                var M,
                  ...
                  P = {};
                for (M = 0; M < L; M++)
                  w.hasOwnProperty(x[M]) && (P[x[M]] = w[x[M]]);
                S.call(void 0, D, P);
              })),
              this.use.apply(this, x);
          },
          _notify: function (x, S, D) {
            if (!S.success && this.config.loadErrorFn)
              this.config.loadErrorFn.call(this, this, x, S, D);
            else if (x)
              if (
                (this.Env._missed &&
                  this.Env._missed.length &&
                  ((S.msg = "Missing modules: " + this.Env._missed.join()),
                  (S.success = !1)),
          ...
          _use: function (x, S) {
                  ...
                  for (ne = J.length, Q = 0; Q < ne; Q++)
                    (ie = J[Q]),
                      ...
                      !F[ie] &&
                        ...
                        ue
                          ? ((F[ie] = !0),
                            (ae = ue.details.requires),
                            (oe = ue.details.use))
                          : P._loaded[n][ie]
                          ? (F[ie] = !0)
                          : W.push(ie),
                        ae && ae.length && se(ae),
                        oe && oe.length && se(oe, 1));
                }
              },
              $ = function (J) {
                var Z = J || { success: !0, msg: "not dynamic" },
                  Q,
                  ee,
                  ie = !0,
                  ne = Z.data;
                (w._loading = !1),
                  ne &&
                    ...
                    (Q = W.length),
                    Q &&
                      [].concat(W).sort().join() == ee.sort().join() &&
                      (Q = !1)),
                  Q && ne
                    ? ((w._loading = !0),
                      w._use(W, function () {
                    ...
                    : (ne && (ie = w._attach(ne)), ie && w._notify(S, Z, x)),
                  w._useQueue &&
                    w._useQueue.size() &&
                    !w._loading &&
                    w._use.apply(w, w._useQueue.next());
              };
            if (H === "*") {
              x = [];
            ...
            return (
              (R.loader || R["loader-base"]) &&
                !w.Loader &&
                w._attach(["loader" + (R.loader ? "" : "-base")]),
              j &&
                w.Loader &&
                x.length &&
                ((M = y(w)),
                M.require(x),
                (M.ignoreRegistered = !0),
                (M._boot = !0),
                M.calculate(null, re ? null : "js"),
                (x = M.sorted),
                (M._boot = !1)),
              se(x),
              (D = W.length),
              D && ((W = V.dedupe(W)), (D = W.length)),
              j && D && w.Loader
                ? ((w._loading = !0),
                  (M = y(w)),
                  (M.onEnd = $),
                  (M.context = w),
                  (M.data = x),
                  (M.ignoreRegistered = !1),
                  M.require(W),
                  M.insert(null, re ? null : "js"))
                : j && D && w.Get && !k.bootstrapped
                ? ((w._loading = !0),
                  (L = function () {
                    (w._loading = !1),
                      (B.running = !1),
                      (k.bootstrapped = !0),
                      (P._bootstrapping = !1),
                      w._attach(["loader"]) && w._use(x, S);
                  }),
                  P._bootstrapping
                    ? B.add(L)
                    : ((P._bootstrapping = !0),
                      w.Get.script(G.base + G.loaderPath, { onEnd: L })))
                : ((K = w._attach(x)), K && $()),
              w
            );
          },
          ...
          error: function (x, S, D) {
            ...
            if (
              (M.config &&
                M.config.errorFn &&
                (L = M.config.errorFn.apply(M, arguments)),
              L)
            )
              M.message(x, "error", "" + D);
          ...
          stamp: function (x, S) {
            ...
            if (!x) return x;
            if (
              (x.uniqueID && x.nodeType && x.nodeType !== 9
                ? (D = x.uniqueID)
                : (D = typeof x == "string" ? x : x._yuid),
              !D && ((D = this.guid()), !S))
            )
              try {
                x._yuid = D;
        ...
        (_.applyConfig = function (x) {
          !x ||
            ...
            (_.GlobalConfig = this.config));
        }),
          _._init(),
          E ? (f(s, "DOMContentLoaded", N), f(window, "load", O)) : (N(), O()),
          (_.Env.add = f),
          (_.Env.remove = b),
          typeof exports == "object" &&
            ((exports.YUI = e.exports = _),
            (_.setLoadHook = function (x) {
              _._getLoadHook = x;
            }),
            (_._getLoadHook = null)),
          (_.Env[n] = {});
        ...
        _.add(
          ...
          function (v, u) {
            ...
            (n._isNative = function (S) {
              ...
              (n.sub = function (S, D) {
                return S.replace
                  ? S.replace(i, function (M, L) {
                      return n.isUndefined(D[L]) ? M : D[L];
                    })
                  : S;
              }),
              (n.trim =
                n._isNative(d.trim) && !l.trim()
                  ? function (S) {
              ...
              (n.trimLeft =
                n._isNative(d.trimLeft) && !l.trimLeft()
                  ? function (S) {
                      return S.trimLeft();
                    }
                  : function (S) {
              ...
              (n.trimRight =
                n._isNative(d.trimRight) && !l.trimRight()
                  ? function (S) {
                      return S.trimRight();
                    }
                  : function (S) {
            ...
            (v.Array = p),
              (p.dedupe = c._isNative(Object.create)
                ? function (S) {
                ...
                : function (S) {
                    var D = {},
                      ...
                      P;
                    for (L = 0, P = S.length; L < P; ++L)
                      (w = S[L]), t.call(D, w) || ((D[w] = 1), M.push(w));
                    return M;
                  }),
              (p.each = p.forEach =
                c._isNative(o.forEach)
                  ? function (S, D, M) {
                      return o.forEach.call(S || [], D, M || v), v;
                    }
                  : function (S, D, M) {
                      for (var L = 0, w = (S && S.length) || 0; L < w; ++L)
                        L in S && D.call(M || v, S[L], L, S);
                      return v;
                    }),
              (p.hash = function (S, D) {
                var M = {},
                  ...
                  w,
                  P;
                for (w = 0, P = S.length; w < P; ++w)
                  w in S && (M[S[w]] = L > w && w in D ? D[w] : !0);
                return M;
              }),
              (p.indexOf = c._isNative(o.indexOf)
                ? function (S, D, M) {
              ...
              (p.test = function (S) {
                var D = 0;
                if (c.isArray(S)) D = 1;
                else if (c.isObject(S))
                  try {
                    "length" in S &&
                      !S.tagName &&
                      !(S.scrollTo && S.document) &&
                      !S.apply &&
                      (D = 2);
                  } catch (M) {}
                return D;
            ...
            (f.prototype = {
              ...
              (v.Queue = f),
              (_.Env._loaderQueue = _.Env._loaderQueue || new f());
            var b = "__",
              t = Object.prototype.hasOwnProperty,
              N = v.Lang.isObject;
            (v.cached = function (S, D, M) {
              return (
                ...
                function (L) {
                  var w =
                    arguments.length > 1
                      ? Array.prototype.join.call(arguments, b)
                      : String(L);
                  return (
                    (!(w in D) || (M && D[w] == M)) &&
                      (D[w] = S.apply(S, arguments)),
                    D[w]
                  );
                }
              );
              ...
              (v.merge = function () {
                for (
                  var S = 0, D = arguments.length, M = {}, L, w;
                  S < D;
                  ++S
                ) {
                  w = arguments[S];
              ...
              (v.mix = function (S, D, M, L, w, P) {
                ...
                if (w) {
                  if (
                    (w === 2 && v.mix(S.prototype, D.prototype, M, L, 0, P),
                    (F = w === 1 || w === 3 ? D.prototype : D),
                    (V = w === 1 || w === 4 ? S.prototype : S),
                    !F || !V)
                  )
                    return S;
                } else (F = D), (V = S);
                if (((R = M && !P), L))
                  for (X = 0, H = L.length; X < H; ++X)
                    (B = L[X]),
                      !!t.call(F, B) &&
                        ((k = R ? !1 : B in V),
                        P && k && N(V[B], !0) && N(F[B], !0)
                          ? v.mix(V[B], F[B], M, null, 0, P)
                          : (M || !k) && (V[B] = F[B]));
                else {
                  for (B in F)
                    !t.call(F, B) ||
                      ...
                      P && k && N(V[B], !0) && N(F[B], !0)
                        ? v.mix(V[B], F[B], M, null, 0, P)
                        : (M || !k) && (V[B] = F[B]));
                  v.Object._hasEnumBug &&
                    v.mix(V, F, M, v.Object._forceEnum, w, P);
                }
                return S;
              });
            var c = v.Lang,
              t = Object.prototype.hasOwnProperty,
              O,
              y = (v.Object = c._isNative(Object.create)
                ? function (S) {
              ...
              I = (y._hasEnumBug = !{ valueOf: 0 }.propertyIsEnumerable(
                "valueOf"
              )),
              U = (y._hasProtoEnumBug = function () {}.propertyIsEnumerable(
                "prototype"
              )),
            ...
            (y.hasKey = x),
              (y.keys =
                c._isNative(Object.keys) && !U
                  ...
                  : function (S) {
                      ...
                      else for (L in S) x(S, L) && D.push(L);
                      if (I)
                        for (M = 0, w = C.length; M < w; ++M)
                          (L = C[M]), x(S, L) && D.push(L);
                      return D;
                    }),
              (y.values = function (S) {
                for (var D = y.keys(S), M = 0, L = D.length, w = []; M < L; ++M)
                  w.push(S[D[M]]);
                return w;
              }),
              (y.size = function (S) {
              ...
              (_.Env.parseUA = function (S) {
                ...
                return (
                  (w.userAgent = P),
                  (w.secure = k && k.toLowerCase().indexOf("https") === 0),
                  P &&
                    (/windows|win32/i.test(P)
                      ? (w.os = "windows")
                      : /macintosh|mac_powerpc/i.test(P)
                      ? (w.os = "macintosh")
                      : /android/i.test(P)
                      ? (w.os = "android")
                      : /symbos/i.test(P)
                      ...
                      : /linux/i.test(P)
                      ? (w.os = "linux")
                      : /rhino/i.test(P) && (w.os = "rhino"),
                    /KHTML/.test(P) && (w.webkit = 1),
                    /IEMobile|XBLWP7/.test(P) && (w.mobile = "windows"),
                    /Fennec/.test(P) && (w.mobile = "gecko"),
                    (F = P.match(/AppleWebKit\/([^\s]*)/)),
                    F &&
                      F[1] &&
                      ((w.webkit = D(F[1])),
                      (w.safari = w.webkit),
                      /PhantomJS/.test(P) &&
                        ((F = P.match(/PhantomJS\/([^\s]*)/)),
                        F && F[1] && (w.phantomjs = D(F[1]))),
                      / Mobile\//.test(P) || /iPad|iPod|iPhone/.test(P)
                        ? ((w.mobile = "Apple"),
                          (F = P.match(/OS ([^\s]*)/)),
                          F && F[1] && (F = D(F[1].replace("_", "."))),
                          (w.ios = F),
                          (w.os = "ios"),
                          (w.ipad = w.ipod = w.iphone = 0),
                          (F = P.match(/iPad|iPod|iPhone/)),
                          F && F[0] && (w[F[0].toLowerCase()] = w.ios))
                        : ((F = P.match(/NokiaN[^\/]*|webOS\/\d\.\d/)),
                          F && (w.mobile = F[0]),
                          /webOS/.test(P) &&
                            ((w.mobile = "WebOS"),
                            (F = P.match(/webOS\/([^\s]*);/)),
                            F && F[1] && (w.webos = D(F[1]))),
                          / Android/.test(P) &&
                            (/Mobile/.test(P) && (w.mobile = "Android"),
                            (F = P.match(/Android ([^\s]*);/)),
                            F && F[1] && (w.android = D(F[1]))),
                          /Silk/.test(P) &&
                            ((F = P.match(/Silk\/([^\s]*)/)),
                            F && F[1] && (w.silk = D(F[1])),
                            w.android ||
                              ((w.android = 2.34), (w.os = "Android")),
                            /Accelerated=true/.test(P) && (w.accel = !0))),
                      (F = P.match(/OPR\/(\d+\.\d+)/)),
                      F && F[1]
                        ? (w.opera = D(F[1]))
                        : ((F = P.match(/(Chrome|CrMo|CriOS)\/([^\s]*)/)),
                          F && F[1] && F[2]
                            ? ((w.chrome = D(F[2])),
                              (w.safari = 0),
                              F[1] === "CrMo" && (w.mobile = "chrome"))
                            : ((F = P.match(/AdobeAIR\/([^\s]*)/)),
                              F && (w.air = F[0])))),
                    (F = P.match(/Ubuntu\ (\d+\.\d+)/)),
                    F &&
                      F[1] &&
                      ((w.os = "linux"),
                      (w.ubuntu = D(F[1])),
                      (F = P.match(/\ WebKit\/([^\s]*)/)),
                      F && F[1] && (w.webkit = D(F[1])),
                      (F = P.match(/\ Chromium\/([^\s]*)/)),
                      F && F[1] && (w.chrome = D(F[1])),
                      / Mobile$/.test(P) && (w.mobile = "Ubuntu")),
                    w.webkit ||
                      (/Opera/.test(P)
                        ? ((F = P.match(/Opera[\s\/]([^\s]*)/)),
                          F && F[1] && (w.opera = D(F[1])),
                          ...
                          /Opera Mobi/.test(P) &&
                            ((w.mobile = "opera"),
                            (F = P.replace("Opera Mobi", "").match(
                              /Opera ([^\s]*)/
                            )),
                            F && F[1] && (w.opera = D(F[1]))),
                          (F = P.match(/Opera Mini[^;]*/)),
                          F && (w.mobile = F[0]))
                        : ((F = P.match(
                            /MSIE ([^;]*)|Trident.*; rv:([0-9.]+)/
                          )),
                  ...
                  M &&
                    ...
                    (w.touchEnabled =
                      "ontouchstart" in M ||
                      ("msMaxTouchPoints" in L && L.msMaxTouchPoints > 0)),
                  S ||
                    (typeof m == "object" &&
                      m.versions &&
                      m.versions.node &&
                      ((w.os = m.platform), (w.nodejs = D(m.versions.node))),
                    (_.Env.UA = w)),
                  w
                );
              }),
              (v.UA = _.Env.UA || _.Env.parseUA()),
              (v.UA.compareVersions = function (S, D) {
                var M, L, w, P, R, k;
                if (S === D) return 0;
                for (
                  L = (S + "").split("."),
            ...
            (v.Get = r =
              {
                ...
                abort: function (i) {
                  ...
                  if (!i.abort) {
                    if (
                      ...
                      (h = this._pending),
                      (i = null),
                      h && h.transaction.id === g)
                    )
                      (i = h.transaction), (this._pending = null);
                    else
                ...
                _getEnv: function () {
                  ...
                  return (this._env = {
                    async:
                      (i && i.createElement("script").async === !0) ||
                      l.ie >= 10,
                    cssFail:
                      l.gecko >= 9 || l.compareVersions(l.webkit, 535.24) >= 0,
                    cssLoad:
                      ((!l.gecko && !l.webkit) ||
                        l.gecko >= 9 ||
                        l.compareVersions(l.webkit, 535.24) >= 0) &&
                      !(l.chrome && l.chrome <= 18),
                ...
                _getTransaction: function (i, l) {
                  ...
                  for (
                    n.isArray(i) || (i = [i]),
                      l = v.merge(this.options, l),
                      l.attributes = v.merge(
                    ...
                    v.mix(h, l, !1, null, 0, !0),
                      h.type ||
                        (this.REGEX_CSS.test(s)
                          ? (h.type = "css")
                          : (!this.REGEX_JS.test(s), (h.type = "js"))),
                      v.mix(
                        h,
                        h.type === "js" ? this.jsOptions : this.cssOptions,
                        !1,
                        null,
                        0,
                        !0
                      ),
                      h.attributes.id || (h.attributes.id = v.guid()),
                      h.win
                        ? (h.doc = h.win.document)
                        : (h.win = h.doc.defaultView || h.doc.parentWindow),
                ...
                _load: function (i, l, g, A) {
                  var E;
                  return (
                    typeof g == "function" && ((A = g), (g = {})),
                    g || (g = {}),
                    (g.type = i),
                    (g._onFinish = r._onTransactionFinish),
                    this._env || this._getEnv(),
                    (E = this._getTransaction(l, g)),
                    this._queue.push({ callback: A, transaction: E }),
                    this._next(),
                    E
                  );
                },
                ...
                _next: function () {
                  ...
                  this._pending ||
                    ((i = this._queue.shift()),
                    i &&
                      ((this._pending = i), i.transaction.execute(i.callback)));
                },
                _purge: function (i) {
                  for (
                    var l = this._purgeNodes, g = i !== l, A, E;
                    (E = i.pop());
              ...
              (a.prototype = {
                ...
                abort: function (i) {
                  (this._pending = null),
                    ...
                    (this._queue = []),
                    (this._reqsWaiting = 0),
                    this.errors.push({ error: i || "Aborted" }),
                    this._finish();
                },
                execute: function (i) {
                  var l = this,
                  ...
                  if (A === "done") {
                    ...
                    return;
                  } else if ((i && l._callbacks.push(i), A === "executing"))
                    return;
                  for (
                    l._state = "executing",
                      l._queue = s = [],
                      l.options.timeout &&
                        (l._timeout = setTimeout(function () {
                          l.abort("Timeout");
                        }, l.options.timeout)),
                      l._reqsWaiting = g.length,
                      E = 0,
                      h = g.length;
                    E < h;
                    ++E
                    ...
                    (c = g[E]),
                      c.async || c.type === "css" ? l._insert(c) : s.push(c);
                  l._next();
                },
                purge: function () {
                  r._purge(this.nodes);
                ...
                _createNode: function (i, l, g) {
                  ...
                  for (E in l)
                    l.hasOwnProperty(E) && A.setAttribute(d[E] || E, l[E]);
                  return A;
                },
                _finish: function () {
                  ...
                  if (this._state !== "done") {
                    for (
                      this._state = "done", E = 0, h = this._callbacks.length;
                      E < h;
                      ++E
                    )
                      this._callbacks[E].call(g, i, this);
                    (A = this._getEventData()),
                      i
                        ? (l.onTimeout &&
                            i[i.length - 1].error === "Timeout" &&
                            l.onTimeout.call(g, A),
                          l.onFailure && l.onFailure.call(g, A))
                        : l.onSuccess && l.onSuccess.call(g, A),
                      l.onEnd && l.onEnd.call(g, A),
                      l._onFinish && l._onFinish();
                  }
                },
                ...
                _getInsertBefore: function (i) {
                  ...
                  return g
                    ...
                    : ((A = r._insertCache),
                      ...
                      (g = A[E])
                        ? g
                        : (g = l.getElementsByTagName("base")[0])
                        ? (A[E] = g)
                        : ((g = l.head || l.getElementsByTagName("head")[0]),
                          g
                            ? (g.appendChild(l.createTextNode("")),
                              (A[E] = g.lastChild))
                            : (A[E] = l.getElementsByTagName("script")[0])));
                },
                _insert: function (i) {
                  var l = r._env,
                  ...
                  E ||
                    (A
                      ...
                      ? (o = "style")
                      : (o = "link"),
                    (E = i.node = this._createNode(o, i.attributes, i.doc)));
                  function t() {
                  ...
                  A
                    ? (E.setAttribute("src", i.url),
                      i.async
                        ? (E.async = !0)
                        : (l.async && (E.async = !1),
                          l.preservesScriptOrder || (this._pending = i)))
                    : !l.cssLoad && s.gecko
                    ? (E.innerHTML =
                        (i.attributes.charset
                          ? '@charset "' + i.attributes.charset + '";'
                          : "") +
                        '@import "' +
                        i.url +
                        '";')
                    : E.setAttribute("href", i.url),
                    A &&
                    s.ie &&
                    (s.ie < 9 ||
                      ...
                      : (s.ie >= 10
                          ...
                          : ((E.onerror = t), (E.onload = p)),
                        !l.cssFail &&
                          !A &&
                          (c = setTimeout(t, i.timeout || 3e3))),
                    this.nodes.push(E),
                ...
                _poll: function (i) {
                  ...
                  if (
                    !(
                      i &&
                      (g || (g = l._pendingCSS = []), g.push(i), l._pollTimer)
                    )
                  ) {
                    for (l._pollTimer = null, E = 0; E < g.length; ++E)
                      if (((o = g[E]), A)) {
                        for (
                          t = o.doc.styleSheets, s = t.length, c = o.node.href;
                          --s >= 0;
                        ...
                        try {
                          (h = !!o.node.sheet.cssRules),
                            g.splice(E, 1),
                            (E -= 1),
                            l._progress(null, o);
                        } catch (p) {}
                    g.length &&
                      (l._pollTimer = setTimeout(function () {
                        l._poll.call(l);
                ...
                _progress: function (i, l) {
                  var g = this.options;
                  i &&
                    ((l.error = i), this.errors.push({ error: i, request: l })),
                    (l.node._yuiget_finished = l.finished = !0),
                    g.onProgress &&
                      g.onProgress.call(
                        g.context || this,
                        this._getEventData(l)
                      ),
                    l.autopurge &&
                      (r._autoPurge(this.options.purgethreshold),
                      r._purgeNodes.push(l.node)),
                    this._pending === l && (this._pending = null),
                    (this._reqsWaiting -= 1),
                    this._next();
                },
              });
          ...
          function (v, u) {
            ...
            d("load", "0", {
              ...
              test: function (r) {
                ...
                return i && i.style
                  ? "MozTransition" in i.style ||
                      "WebkitTransition" in i.style ||
                      "transition" in i.style
                  : !1;
              },
              ...
              d("load", "3", {
                ...
                test: function (r) {
                  ...
                  return (
                    ...
                    (E =
                      !a("style", "opacity") && !a("style", "computedStyle")),
                    E
                  );
                },
                trigger: "dom-style",
                ...
                test: function (r) {
                  var a = r.config.doc,
                    i =
                      ...
                      r.config.defaultGraphicEngine == "canvas",
              ...
              d("load", "12", {
                ...
                test: function (r) {
                  ...
                  return (
                    r.UA.ie &&
                    (!("onhashchange" in r.config.win) || !a || a < 8)
                  );
                },
              ...
              d("load", "14", {
                ...
                test: function (r) {
                  var a = r.config.global.JSON,
                    i =
                      Object.prototype.toString.call(a) === "[object JSON]" &&
                      a,
          ...
          function (v, u) {
            ...
            v.mix(v.namespace("Intl"), {
              lookupBestLang: function (d, r) {
                ...
                for (
                  v.Lang.isString(d) && (d = d.split(n)), a = 0;
                  a < d.length;
                  a += 1
                )
                  if (((i = d[a]), !(!i || i === "*")))
        ...
        _.add(
          ...
          function (v, u) {
            var n = v,
              d = "yui:log",
              r = "undefined",
              a = { debug: 1, info: 2, warn: 4, error: 8 };
                ...
                f.debug &&
                  ...
                  typeof g != "undefined" &&
                    ...
                    s && !(g in s)
                      ...
                      ? (E = !s[g])
                      : h && g in h && (E = h[g]),
                    typeof l == "undefined" && (l = "info"),
                    (p.config.logLevel = p.config.logLevel || "debug"),
                    (t = a[p.config.logLevel.toLowerCase()]),
                    l in a && a[l] < t && (E = 1)),
                  E ||
                    (f.useBrowserConsole &&
                      ((c = g ? g + ": " + i : i),
                      p.Lang.isFunction(f.logFn)
                        ? f.logFn.call(p, i, l, g)
                        : typeof console !== r && console.log
                        ? ((o = l && console[l] && l in a ? l : "log"),
                          console[o](c))
                        : typeof opera !== r && opera.postError(c)),
                    b &&
                      !A &&
                      (b === p &&
                        !b.getEvent(d) &&
                        b.publish(d, { broadcast: 2 }),
                      b.fire(d, { msg: i, cat: l, src: g })))),
                p
              );
            }),
              (n.message = function () {
        ...
        _.add(
          ...
          function (v, u) {
            ...
            (v.later = function (d, r, a, i, l) {
              (d = d || 0),
                (i = v.Lang.isUndefined(i) ? n : v.Array(i)),
                (r = r || v.config.win || v);
              var g = !1,
                A = r && v.Lang.isString(a) ? r[a] : a,
                E = function () {
                  g ||
                    (A.apply ? A.apply(r, i || n) : A(i[0], i[1], i[2], i[3]));
                },
                h = l
                  ? v.config.win.setInterval(E, d)
                  : v.config.win.setTimeout(E, d);
              return {
                id: h,
                interval: l,
                cancel: function () {
                  (g = !0),
                    this.interval
                      ? v.config.win.clearInterval(h)
                      : v.config.win.clearTimeout(h);
                },
              };
            }),
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = "running",
            ...
            A;
          (e.Anim = function () {
            e.Anim.superclass.constructor.apply(this, arguments),
              (e.Anim._instances[e.stamp(this)] = this);
          }),
            (e.Anim.NAME = "anim"),
            (e.Anim._instances = {}),
            (e.Anim.RE_DEFAULT_UNIT =
              /^width|height|top|right|bottom|left|margin.*|padding.*|border.*$/i),
            (e.Anim.DEFAULT_UNIT = "px"),
            (e.Anim.DEFAULT_EASING = function (h, s, c, o) {
              return (c * h) / o + s;
            }),
            (e.Anim._intervalTime = 20),
            (e.Anim.behaviors = {
              left: {
                get: function (h, s) {
            ...
            (e.Anim.behaviors.top = e.Anim.behaviors.left),
            (e.Anim.DEFAULT_SETTER = function (h, s, c, o, t, p, f, b) {
              var N = h._node,
                O = N._node,
                y = f(t, l(c), l(o) - l(c), p);
              O
                ? "style" in O && (s in O.style || s in e.DOM.CUSTOM_STYLES)
                  ? ((b = b || ""), N.setStyle(s, y + b))
                  : "attributes" in O && s in O.attributes
                  ? N.setAttribute(s, y)
                  : s in O && (O[s] = y)
                : N.set
                ? N.set(s, y)
            ...
            (e.Anim.ATTRS = {
              node: {
                setter: function (h) {
                  return (
                    h && (typeof h == "string" || h.nodeType) && (h = e.one(h)),
                    (this._node = h),
                    h
                  );
                },
          ...
          var E = {
            run: function () {
              return (
                this.get(r) ? this._resume() : this.get(T) || this._start(),
                this
              );
            },
            pause: function () {
            ...
            _added: !1,
            _start: function () {
              this._set(m, new Date() - this.get(_)),
                (this._actualFrames = 0),
                this.get(r) || this._initAnimAttr(),
                (g[e.stamp(this)] = this),
                e.Anim._startTimer(),
                this.fire(v);
            },
            ...
            _end: function (h) {
              ...
              h && this._runAttrs(s, s, this.get(a)),
                this._set(m, null),
                this._set(_, 0),
                this._set(r, !1),
                delete g[e.stamp(this)],
                this.fire(n, { elapsed: this.get(_) });
            },
            _runFrame: function () {
            ...
            _runAttrs: function (h, s, c) {
              ...
              for (y in o)
                o[y].to &&
                  ((N = o[y]),
                  (O =
                    y in t && "set" in t[y] ? t[y].set : e.Anim.DEFAULT_SETTER),
                  b
                    ? O(this, y, N.from, N.to, f, s, p, N.unit)
                    : O(this, y, N.from, N.to, h, s, p, N.unit));
            },
            _lastFrame: function () {
            ...
            _initAnimAttr: function () {
              ...
              e.each(
                s,
                function (N, O) {
                  typeof N == "function" && (N = N.call(this, t)),
                    (f = h[O]),
                    f === void 0
                      ? (f =
                          O in o && "get" in o[O]
                            ? o[O].get(this, O)
                            : e.Anim.DEFAULT_GETTER(this, O))
                      : typeof f == "function" && (f = f.call(this, t));
                  ...
                  if (
                    ...
                    (p = C ? C[2] : y ? y[2] : ""),
                    !p &&
                      e.Anim.RE_DEFAULT_UNIT.test(O) &&
                      (p = e.Anim.DEFAULT_UNIT),
                    !f || !b)
                  ) {
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          (e.Anim.getUpdatedColorValue = function (m, _, v, u, n) {
            return (
              (m = e.Color.re_RGB.exec(e.Color.toRGB(m))),
              (_ = e.Color.re_RGB.exec(e.Color.toRGB(_))),
              (!m || m.length < 3 || !_ || _.length < 3) &&
                e.error("invalid from or to passed to color behavior"),
              "rgb(" +
                [
                  Math.floor(n(v, T(m[1]), T(_[1]) - T(m[1]), u)),
                  Math.floor(n(v, T(m[2]), T(_[2]) - T(m[2]), u)),
                  Math.floor(n(v, T(m[3]), T(_[3]) - T(m[3]), u)),
                ].join(", ") +
                ")"
            );
          }),
        ...
        function (e, q) {
          (e.Anim.behaviors.curve = {
            ...
            (e.Anim.getBezier = function (T, m) {
              ...
              for (n = 1; n < _; ++n)
                for (u = 0; u < _ - n; ++u)
                  (v[u][0] = (1 - m) * v[u][0] + m * v[parseInt(u + 1, 10)][0]),
                    (v[u][1] =
                      (1 - m) * v[u][1] + m * v[parseInt(u + 1, 10)][1]);
              return [v[0][0], v[0][1]];
            });
        },
        "3.17.2",
        ...
        function (e, q) {
          var T = {
            ...
            elasticIn: function (m, _, v, u, n, d) {
              ...
              return m === 0
                ...
                : (d || (d = u * 0.3),
                  !n || n < Math.abs(v)
                    ? ((n = v), (r = d / 4))
                    : (r = (d / (2 * Math.PI)) * Math.asin(v / n)),
                  -(
                    n *
                    Math.pow(2, 10 * (m -= 1)) *
                    Math.sin(((m * u - r) * (2 * Math.PI)) / d)
                  ) + _);
            },
            ...
            backOut: function (m, _, v, u, n) {
              return (
                typeof n == "undefined" && (n = 1.70158),
                v * ((m = m / u - 1) * m * ((n + 1) * m + n) + 1) + _
              );
            },
            backBoth: function (m, _, v, u, n) {
              return (
                typeof n == "undefined" && (n = 1.70158),
                (m /= u / 2) < 1
                  ? (v / 2) * (m * m * (((n *= 1.525) + 1) * m - n)) + _
                  : (v / 2) *
                      ((m -= 2) * m * (((n *= 1.525) + 1) * m + n) + 2) +
                    _
              );
            },
            ...
            bounceOut: function (m, _, v, u) {
              return (m /= u) < 1 / 2.75
                ? v * (7.5625 * m * m) + _
                : m < 2 / 2.75
                ? v * (7.5625 * (m -= 1.5 / 2.75) * m + 0.75) + _
                : m < 2.5 / 2.75
                ? v * (7.5625 * (m -= 2.25 / 2.75) * m + 0.9375) + _
                : v * (7.5625 * (m -= 2.625 / 2.75) * m + 0.984375) + _;
            },
            bounceBoth: function (m, _, v, u) {
              return m < u / 2
                ? e.Easing.bounceIn(m * 2, 0, v, u) * 0.5 + _
                : e.Easing.bounceOut(m * 2 - u, 0, v, u) * 0.5 + v * 0.5 + _;
            },
          };
          e.Easing = T;
        },
        ...
        function (e, q) {
          ...
          e.Anim.behaviors.scroll = {
            set: function (m, _, v, u, n, d, r) {
              var a = m._node,
                i = [
                  r(n, T(v[0]), T(u[0]) - T(v[0]), d),
                  r(n, T(v[1]), T(u[1]) - T(v[1]), d),
                ];
              i[0] && a.set("scrollLeft", i[0]),
                i[1] && a.set("scrollTop", i[1]);
            },
            get: function (m) {
              var _ = m._node;
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = e.Array,
            m = e.Lang,
            _ = Array.prototype;
          (T.lastIndexOf = m._isNative(_.lastIndexOf)
            ? function (v, u, n) {
            ...
            : function (v, u, n) {
                var d = v.length,
                  r = d - 1;
                if (
                  ((n || n === 0) && (r = Math.min(n < 0 ? d + n : n, d)),
                  r > -1 && d > 0)
                ) {
                  for (; r > -1; --r) if (r in v && v[r] === u) return r;
                }
                return -1;
              }),
            ...
            (T.filter = m._isNative(_.filter)
              ? function (v, u, n) {
                  return _.filter.call(v, u, n);
                }
              : function (v, u, n) {
                  for (var d = 0, r = v.length, a = [], i; d < r; ++d)
                    d in v && ((i = v[d]), u.call(n, i, d, v) && a.push(i));
                  return a;
                }),
            ...
            (T.map = m._isNative(_.map)
              ? function (v, u, n) {
                  return _.map.call(v, u, n);
                }
              : function (v, u, n) {
                  for (
                    var d = 0, r = v.length, a = _.concat.call(v);
                    d < r;
                    ++d
                  )
                    d in v && (a[d] = u.call(n, v[d], d, v));
                  return a;
                }),
            (T.reduce = m._isNative(_.reduce)
              ? function (v, u, n, d) {
                  return _.reduce.call(
                    v,
                    function (r, a, i, l) {
              ...
              : function (v, u, n, d) {
                  for (var r = 0, a = v.length, i = u; r < a; ++r)
                    r in v && (i = n.call(d, i, v[r], r, v));
                  return i;
                }),
            ...
            (T.partition = function (v, u, n) {
              var d = { matches: [], rejects: [] };
              return (
                T.each(v, function (r, a) {
            ...
            (T.flatten = function (v) {
              var u = [],
                ...
                r;
              if (!v) return u;
              for (n = 0, d = v.length; n < d; ++n)
                (r = v[n]),
                  m.isArray(r) ? u.push.apply(u, T.flatten(r)) : u.push(r);
              return u;
            });
        },
        "3.17.2",
        ...
        function (e, q) {
          e.Array.invoke = function (T, m) {
            var _ = e.Array(arguments, 2, !0),
              ...
              u = [];
            return (
              e.Array.each(e.Array(T), function (n, d) {
    ...
    241601: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          function v(u) {
            u !== void 0
              ? (this._items = e.Lang.isArray(u) ? u : T(u))
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          (T.defaults = e.mix(
            ...
            e.config.queueDefaults || {}
          )),
            e.extend(T, e.EventTarget, {
              _running: !1,
              _init: function () {
                e.EventTarget.call(this, { prefix: "queue", emitFacade: !0 }),
                  (this._q = []),
                  (this.defaults = {}),
                  this._initEvents();
              },
              ...
              next: function () {
                for (
                  var r;
                  this._q.length &&
                  ((r = this._q[0] = this._prepare(this._q[0])),
                  r && r.until());

                )
                  this.fire(_, { callback: r }), (r = null);
                return r || null;
              },
              ...
              _prepare: function (r) {
                ...
                var a = e.merge(
                  ...
                  i = e.bind(function () {
                    i._running || i.iterations--,
                      d(i.fn) && i.fn.apply(i.context || e, e.Array(i.args));
                  }, this);
                return e.mix(i, a);
              },
              run: function () {
                ...
                for (
                  ...
                  r &&
                  !this.isRunning() &&
                  ((a = r.timeout < 0 ? this._execute(r) : this._schedule(r)),
                  !!a);
                  r = this.next()
                );
              ...
              _execute: function (r) {
                (this._running = r._running = !0),
                  (this._executing = r),
                  r.iterations--,
                  this.fire(m, { callback: r });
                var a = this._running && r.autoContinue;
                return (
                  (this._running = r._running = !1), (this._executing = !1), a
                );
              },
              _schedule: function (r) {
                return (
                  (this._running = e.later(r.timeout, this, function () {
              ...
              add: function () {
                return (
                  this.fire("add", { callbacks: e.Array(arguments, 0, !0) }),
                  this
                );
              },
              ...
              pause: function () {
                return (
                  this._running && n(this._running) && this._running.cancel(),
                  (this._running = !1),
                  this
                );
              },
    ...
    917645: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          e.mix(T, e.AttributeCore, !1, null, 1),
            e.mix(T, e.AttributeExtras, !1, null, 1),
            e.mix(T, e.AttributeObservable, !0, null, 1),
            (T.INVALID_VALUE = e.AttributeCore.INVALID_VALUE),
            (T._ATTR_CFG = e.AttributeCore._ATTR_CFG.concat(
              e.AttributeObservable._ATTR_CFG
            )),
            (T.protectAttrs = e.AttributeCore.protectAttrs),
            (e.Attribute = T);
        },
        "3.17.2",
        {
    ...
    659413: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          (o.INVALID_VALUE = {}),
            (c = o.INVALID_VALUE),
            (o._ATTR_CFG = [u, v, a, i, l, d, n, g, E]),
            (o.protectAttrs = function (t) {
              if (t) {
                t = e.merge(t);
            ...
            (o.prototype = {
              ...
              addAttr: function (t, p, f) {
                ...
                return (
                  ...
                  (C = N.get(t, A)),
                  f && !C
                    ? (N.data[t] = { lazy: p, added: !0 })
                    : (!C || p.isLazyAdd) &&
                      ((I = i in p),
                      I && ((y = p.value), (p.value = void 0)),
                      (p.added = !0),
                      (p.initializing = !0),
                      (O[t] = p),
                      I && b.set(t, y),
              ...
              _setAttr: function (t, p, f, b) {
                ...
                return (
                  t.indexOf(_) !== -1 &&
                    ((x = t), (S = t.split(_)), (t = S.shift())),
                  C && C[t] && this._addOutOfOrder(t, C[t]),
                  (I = O.data[t] || {}),
                  I.lazy && ((I = I.lazy), this._addLazyAttr(t, I)),
                  (U = I.value === void 0),
                  y && t in y && !I._bypassProxy && (U = !1),
                  (M = I.writeOnce),
                  (L = I.initializing),
                  !U && !b && (M && (N = !1), I.readOnly && (N = !1)),
                  !L && !b && M === r && (N = !1),
                  N &&
                    (U || (D = this.get(t)),
                    S &&
                      ((p = T.setValue(e.clone(D), S, p)),
                      p === void 0 && (N = !1)),
                    N &&
                      (!this._fireAttrChange || L
                        ? this._setAttrVal(t, x, D, p, f, I)
                        : this._fireAttrChange(t, x, D, p, f, I))),
                  this
                );
              },
              _addOutOfOrder: function (t, p) {
                var f = {};
                (f[t] = p),
                  delete this._tCfgs[t],
                  this._addAttrs(f, this._tVals);
              },
              _getAttr: function (t) {
                var p = t,
                  f = this._tCfgs,
                  ...
                  y;
                return (
                  t.indexOf(_) !== -1 && ((b = t.split(_)), (t = b.shift())),
                  f && f[t] && this._addOutOfOrder(t, f[t]),
                  (y = this._state.data[t] || {}),
                  y.lazy && ((y = y.lazy), this._addLazyAttr(t, y)),
                  (O = this._getStateVal(t, y)),
                  (N = y.getter),
                  N && !N.call && (N = this[N]),
                  (O = N ? N.call(this, O, p) : O),
                  (O = b ? T.getValue(O, b) : O),
                  O
                );
              },
              _getStateVal: function (t, p) {
                ...
                return (
                  p || (p = this._state.getAll(t) || {}),
                  f && t in f && !p._bypassProxy ? f[t] : p.value
                );
              },
              _setStateVal: function (t, p) {
                var f = this._stateProxy;
                f && t in f && !this._state.get(t, E)
                  ? (f[t] = p)
                  : this._state.add(t, i, p);
              },
              ...
              _getAttrs: function (t) {
                ...
                for (
                  ...
                  (f = t[b]),
                    (!O || this._getStateVal(f) != this._state.get(f, h)) &&
                      (p[f] = this.get(f));
                return p;
              },
              addAttrs: function (t, p, f) {
                return (
                  t &&
                    ((this._tCfgs = t),
                    (this._tVals = p ? this._normAttrVals(p) : null),
                    this._addAttrs(t, this._tVals, f),
                  ...
                  t.hasOwnProperty(y) &&
                    (y.indexOf(_) !== -1
                      ? ((b = y.split(_)),
                        ...
                        (f = f || {}),
                        (O = f[N] = f[N] || []),
                        (O[O.length] = { path: b, value: t[y] }))
                      : (p[y] = t[y]));
                return { simple: p, complex: f };
              },
              _getAttrInitVal: function (t, p, f) {
                ...
                if (
                  (!C &&
                    f &&
                    ((I = f.simple),
                    I && I.hasOwnProperty(t) && ((b = I[t]), (y = !0))),
                  N &&
                    !y &&
                    (N.call || (N = this[N]),
                    N && ((O = N.call(this, t)), (b = O))),
                  !C &&
                    f &&
                    ((U = f.complex),
                    U && U.hasOwnProperty(t) && b !== void 0 && b !== null))
                )
                  for (L = U[t], x = 0, S = L.length; x < S; ++x)
                    (D = L[x].path), (M = L[x].value), T.setValue(b, D, M);
                return b;
              },
              _initAttrs: function (t, p, f) {
                ...
                t &&
                  !O &&
                  !y &&
                  this.addAttrs(e.AttributeCore.protectAttrs(t), p, f);
              },
            }),
            (e.AttributeCore = o);
        },
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = "broadcast",
            m = "published",
            _ = "initValue",
            v = { readOnly: 1, writeOnce: 1, getter: 1, broadcast: 1 };
          function u() {}
          (u.prototype = {
            modifyAttr: function (n, d) {
              ...
              if (r.attrAdded(n)) {
                ...
                for (a in d)
                  v[a] &&
                    d.hasOwnProperty(a) &&
                    (i.add(n, a, d[a]), a === T && i.remove(n, m));
              }
            },
            ...
            reset: function (n) {
              ...
              return (
                n
                  ? (d._isLazyAttr(n) && d._addLazyAttr(n),
                    d.set(n, d._state.get(n, _)))
                  : e.Object.each(d._state.data, function (r, a) {
                      d.reset(a);
                    }),
                d
              );
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = e.EventTarget,
            ...
            _ = "broadcast";
          function v() {
            (this._ATTR_E_FACADE = {}), T.call(this, { emitFacade: !0 });
          }
          (v._ATTR_CFG = [_]),
            (v.prototype = {
              set: function (u, n, d) {
              ...
              _fireAttrChange: function (u, n, d, r, a, i) {
                ...
                i || (i = A.data[u] || {}),
                  i.published ||
                    ((s = l._publish(g)),
                    (s.emitFacade = !0),
                    (s.defaultTargetOnly = !0),
                    (s.defaultFn = l._defAttrChangeFn),
                    (h = i.broadcast),
                    h !== void 0 && (s.broadcast = h),
                    (i.published = !0)),
                  a
                    ? ((E = e.merge(a)), (E._attrOpts = a))
                    : (E = l._ATTR_E_FACADE),
                  (E.attrName = u),
                  (E.subAttrName = n),
                  (E.prevVal = d),
                  (E.newVal = r),
                  l._hasPotentialSubscribers(g)
                    ? l.fire(g, E)
                    : this._setAttrVal(u, n, d, r, a, i);
              },
              _defAttrChangeFn: function (u, n) {
                var d = u._attrOpts;
                d && delete u._attrOpts,
                  this._setAttrVal(
                    u.attrName,
                    u.subAttrName,
                    u.prevVal,
                    ...
                    ? n || (u.newVal = this.get(u.attrName))
                    : n || u.stopImmediatePropagation();
              },
            }),
            e.mix(v, T, !1, null, 1),
            (e.AttributeObservable = v),
            (e.AttributeEvents = v);
        },
        "3.17.2",
        { requires: ["event-custom"] }
    ...
    922770: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          (u._ATTR_CFG = _._ATTR_CFG.concat(v._ATTR_CFG)),
            (u._NON_ATTRS_CFG = _._NON_ATTRS_CFG.concat(v._NON_ATTRS_CFG)),
            (u.NAME = "base"),
            (u.ATTRS = T.protectAttrs(_.ATTRS)),
            (u.modifyAttrs = _.modifyAttrs),
            e.mix(u, _, !1, null, 1),
            e.mix(u, m, !1, null, 1),
            e.mix(u, v, !0, null, 1),
    ...
    230070: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          function a(l, g, A) {
            A._ATTR_CFG &&
              ((g._ATTR_CFG_HASH = null), r.apply(null, arguments));
          }
          function i(l, g, A) {
          ...
          (m._build = function (l, g, A, E, h, s) {
            ...
            for (b = 0, N = A.length; b < N; b++)
              (O = A[b]),
                ...
                C && (y[v] = C),
                I && (y[u] = I),
                o._yuibuild.exts.push(O);
            return (
              E && e.mix(o.prototype, E, !0),
              h && (e.mix(o, c._clean(h, t), !0), p(o, h, t)),
              (o.prototype.hasImpl = c._impl),
              f &&
                ((o.NAME = l),
                (o.prototype.constructor = o),
                (o.modifyAttrs = g.modifyAttrs)),
              o
            );
          }),
            (d = m._build),
            e.mix(d, {
              _mixCust: function (l, g, A) {
                var E, h, s, c, o, t;
                if (
                  (A && ((E = A.aggregates), (h = A.custom), (s = A.statics)),
                  s && e.mix(l, g, !0, s),
                  E)
                )
                  for (t = 0, o = E.length; t < o; t++)
                    (c = E[t]),
                      !l.hasOwnProperty(c) &&
                        ...
                        (l[c] = _.isArray(g[c]) ? [] : {}),
                      e.aggregate(l, g, !0, [c]);
                if (h) for (t in h) h.hasOwnProperty(t) && h[t](t, l, g);
              },
              _tmpl: function (l) {
                function g() {
              ...
              _cfg: function (l, g, A) {
                for (
                  ...
                  (c = f._buildCfg),
                    c &&
                      (c.aggregates && (E = E.concat(c.aggregates)),
                      c.custom && e.mix(h, c.custom, !0),
                      c.statics && (s = s.concat(c.statics))),
                ...
                return (
                  o && (E = E.concat(o)),
                  t && e.mix(h, g.cfgBuild, !0),
                  p && (s = s.concat(p)),
                  { aggregates: E, custom: h, statics: s }
                );
              },
              _clean: function (l, g) {
                var A,
                ...
                for (E = 0, h = c.length; E < h; E++)
                  (A = c[E]), s.hasOwnProperty(A) && delete s[A];
                return s;
              },
            }),
            ...
            (m.create = function (l, g, A, E, h) {
              return (
                e.config.win === e.config.win.top && YUI.stats.markCreate(l),
                d(l, g, A, E, h)
              );
            }),
            (m.mix = function (l, g) {
              return (
                l._CACHED_CLASS_DATA && (l._CACHED_CLASS_DATA = null),
                d(null, l, g, null, null, { dynamic: !1 })
              );
            }),
            (T._buildCfg = {
              aggregates: n.concat(),
              custom: { ATTRS: i, _ATTR_CFG: a, _NON_ATTRS_CFG: r },
            }),
            (m._buildCfg = {
              aggregates: n.concat(),
              custom: { ATTRS: i, _ATTR_CFG: a, _NON_ATTRS_CFG: r },
    ...
    60471: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          (E._ATTR_CFG = g._ATTR_CFG.concat("cloneDefaultValue")),
            (E._NON_ATTRS_CFG = ["plugins"]),
            (E.NAME = "baseCore"),
            (E.ATTRS = {
            ...
            (E.prototype = {
              _initBase: function (h) {
                ...
                this._initPlugins && s && s.call(this),
              ...
              _baseInit: function (h) {
                this._initHierarchy(h),
                  this._initPlugins && this._initPlugins(h),
                  this._set(v, !0);
              },
              destroy: function () {
              ...
              _getClasses: function () {
                return (
                  this._classes || this._initHierarchyData(), this._classes
                );
              },
              ...
              _getInstanceAttrCfgs: function (h) {
                ...
                for (b in h)
                  if (
                    ...
                    (c = s[b] = A({}, N, y)),
                    (o = c.value),
                    o && typeof o == "object" && this._cloneDefaultValue(b, c),
                    O && O.hasOwnProperty(b))
                  ) {
                    p = h._subAttrs[b];
                    for (f in p)
                      (t = p[f]),
                        t.path && T.setValue(c.value, t.path, t.value);
                  }
                return s;
              },
              ...
              _initHierarchyData: function () {
                ...
                if (((c = h), !s)) {
                  for (; c; ) {
                    if (
                      ((y[y.length] = c),
                      c.ATTRS && (C[C.length] = c.ATTRS),
                      b && ((p = c._ATTR_CFG), (f = f || {}), p))
                    )
                ...
                (this._classes = s.classes),
                  (this._attrs = s.attrs),
                  (this._nonAttrs = s.nonAttrs);
              },
                  ...
                  for (f = h.length - 1; f >= 0; --f) {
                    ...
                    for (s in c)
                      c.hasOwnProperty(s) &&
                        ...
                        (p = null),
                        s.indexOf(_) !== -1 &&
                          ((p = s.split(_)), (s = p.shift())),
                        (N = O[s]),
                        p && N && N.value
                          ? ((o = O._subAttrs),
                            o || (o = O._subAttrs = {}),
                            o[s] || (o[s] = {}),
                            (o[s][p.join(_)] = { value: t.value, path: p }))
                          : p ||
                            (N
                              ? (N.valueFn && d in t && (N.valueFn = null),
                                A(N, t, b))
                              : (O[s] = t)));
                  }
                return O;
              ...
              _initHierarchy: function (h) {
                ...
                for (f = D; f >= 0; f--)
                  if (
                    ((c = x[f]),
                    (o = c.prototype),
                    (C = c._yuibuild && c._yuibuild.exts),
                    e.config.win === e.config.win.top &&
                      YUI.stats.markInitializer(c.NAME),
                    o.hasOwnProperty(n) && (U[U.length] = o.initializer),
                    C)
                  )
                    for (b = 0, N = C.length; b < N; b++)
                      (O = C[b]),
                        e.config.win === e.config.win.top &&
                          YUI.stats.markInitializer(O.NAME),
                        O.apply(this, arguments),
                        (y = O.prototype),
                        y.hasOwnProperty(n) && (U[U.length] = y.initializer);
                for (
                  I = this._getInstanceAttrCfgs(S),
                    this._preAddAttrs && this._preAddAttrs(I, h, s),
                    this._allowAdHocAttrs &&
                      this.addAttrs(this._filterAdHocAttrs(S, h), h, s),
                    this.addAttrs(I, h, s),
                    t = 0,
                    p = U.length;
                  t < p;
              ...
              _destroyHierarchy: function () {
                ...
                for (c = 0, o = N.length; c < o; c++) {
                  if (
                    ((h = N[c]),
                    (s = h.prototype),
                    (f = h._yuibuild && h._yuibuild.exts),
                    f)
                  )
                    for (t = 0, p = f.length; t < p; t++)
                      (b = f[t].prototype),
                        b.hasOwnProperty(l) &&
                          (e.config.win === e.config.win.top &&
                            YUI.stats.markDestructor(f[t].NAME),
                          b.destructor.apply(this, arguments));
                  s.hasOwnProperty(l) &&
                    (e.config.win === e.config.win.top &&
                      YUI.stats.markDestructor(h.NAME),
                    s.destructor.apply(this, arguments));
                }
              },
              toString: function () {
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = e.Lang,
            ...
            d = e.BaseCore;
          function r() {}
          (r._ATTR_CFG = n._ATTR_CFG.concat()),
            (r._NON_ATTRS_CFG = ["on", "after", "bubbleTargets"]),
            (r.prototype = {
              _initAttribute: function () {
                d.prototype._initAttribute.apply(this, arguments),
                  n.call(this),
                  (this._eventPrefix =
                    this.constructor.EVENT_PREFIX || this.constructor.NAME),
              ...
              init: function (a) {
                ...
                return (
                  (l.emitFacade = !0),
                  (l.fireOnce = !0),
                  (l.defaultTargetOnly = !0),
                  (l.defaultFn = this._defInitFn),
                  this._preInitEventCfg(a),
                  l._hasPotentialSubscribers()
                    ? this.fire(i, { cfg: a })
                    : (this._baseInit(a),
                      (l.fired = !0),
                      (l.firedWith = [{ cfg: a }])),
              ...
              _preInitEventCfg: function (a) {
                ...
                if (A || u in this)
                  if (
                    ((g = A ? a && a.bubbleTargets : this._bubbleTargets),
                    T.isArray(g))
                  )
            ...
            (e.ClassNameManager = (function () {
              ...
              return {
                getClassName: e.cached(function () {
                  ...
                  return (
                    n[n.length - 1] !== !0 ? n.unshift(v) : n.pop(), n.join(u)
                  );
                }),
              };
            })());
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = /^#?([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})(\ufffe)?/,
            ...
            v = { HEX: "hex", RGB: "rgb", RGBA: "rgba" },
            u = { hex: "toHex", rgb: "toRGB", rgba: "toRGBA" };
          e.Color = {
            KEYWORDS: {
              black: "000",
              silver: "c0c0c0",
            ...
            toArray: function (n) {
              var d = e.Color.findType(n).toUpperCase(),
                ...
                l;
              return (
                d === "HEX" && n.length < 5 && (d = "HEX3"),
                d.charAt(d.length - 1) === "A" && (d = d.slice(0, -1)),
                (r = e.Color["REGEX_" + d]),
                r &&
                  ((a = r.exec(n) || []),
                  (i = a.length),
            ...
            fromArray: function (n, d) {
              if (((n = n.concat()), typeof d == "undefined"))
                return n.join(", ");
              var r = "{*}";
              for (
                d = e.Color["STR_" + d.toUpperCase()],
                  n.length === 3 &&
                    d.match(/\{\*\}/g).length === 4 &&
                    n.push(1);
                d.indexOf(r) >= 0 && n.length > 0;

              )
                d = d.replace(r, n.shift());
              return d;
            },
            findType: function (n) {
              ...
              return (
                d > 0 && (r = n.substr(0, d)),
                r && e.Color.TYPES[r.toUpperCase()]
                  ? e.Color.TYPES[r.toUpperCase()]
                  : "hex"
              );
            },
            ...
            _convertTo: function (n, d) {
              ...
              return (
                r === "keyword" &&
                  ((n = e.Color._keywordToHex(n)), (r = "hex")),
                r === "hex" &&
                  n.length < 5 &&
                  ...
                  (n =
                    ...
                    n.charAt(2))),
                r === d ||
                  (r.charAt(r.length - 1) === "a" && (r = r.slice(0, -1)),
                  (i = d.charAt(d.length - 1) === "a"),
                  i && ((d = d.slice(0, -1)), (l = e.Color._getAlpha(n))),
                  (A = d.charAt(0).toUpperCase() + d.substr(1).toLowerCase()),
                  (g = e.Color["_" + r + "To" + A]),
                  g ||
                    (r !== "rgb" &&
                      d !== "rgb" &&
                      ((n = e.Color["_" + r + "ToRgb"](n)),
                      (r = "rgb"),
                      (g = e.Color["_" + r + "To" + A]))),
                  g && (n = g(n, i)),
                  i &&
                    (e.Lang.isArray(n) || (n = e.Color.toArray(n)),
                    n.push(l),
                    (n = e.Color.fromArray(n, a.toUpperCase())))),
                n
              );
            },
    ...
    975042: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          function A(E) {
            (!v(E) || E === "") &&
              l("Subcookie name must be a non-empty string.");
          }
          e.Cookie = {
            _createCookieString: function (E, h, s, c) {
              ...
              return (
                u(c) &&
                  (t instanceof Date && (o += "; expires=" + t.toUTCString()),
                  v(p) && p !== "" && (o += "; path=" + p),
                  v(f) && f !== "" && (o += "; domain=" + f),
                  c.secure === !0 && (o += "; secure")),
                o
            ...
            _parseCookieHash: function (E) {
              var h = E.split("&"),
                ...
                c = {};
              if (E.length)
                for (var o = 0, t = h.length; o < t; o++)
                  (s = h[o].split("=")), (c[a(s[0])] = a(s[1]));
              return c;
            },
            _parseCookieString: function (E, h, s) {
              ...
              if (v(E) && E.length > 0)
                for (
                  ...
                  if (((b = t[N].match(/([^=]+)=/i)), b instanceof Array))
                    try {
                      (p = a(b[1])), (f = o(t[N].substring(b[1].length + 1)));
                    } catch (y) {}
                  else (p = a(t[N])), (f = "");
                  !n(s) && s.reverseCookieLoading
                    ? n(c[p]) && (c[p] = f)
                    : (c[p] = f);
                }
              return c;
            ...
            get: function (E, h) {
              ...
              return (
                d(h)
                  ...
                  ? (o = h.converter)
                  : (h = {}),
                (s = this._parseCookieString(i.cookie, !h.raw, h)),
                (c = s[E]),
                n(c) ? _ : d(o) ? o(c) : c
              );
            },
            ...
            remove: function (E, h) {
              return (
                g(E),
                (h = e.merge(h || {}, { expires: new Date(0) })),
                this.set(E, "", h)
              );
            },
            removeSub: function (E, h, s) {
              ...
              if (u(c) && c.hasOwnProperty(h))
                if ((delete c[h], s.removeIfEmpty)) {
                  for (var o in c)
                    if (c.hasOwnProperty(o) && !d(c[o]) && !n(c[o]))
                      return this.setSubs(E, c, s);
            ...
            set: function (E, h, s) {
              g(E),
                n(h) && l("Cookie.set(): Value cannot be undefined."),
                (s = s || {});
            ...
            setSub: function (E, h, s, c) {
              g(E),
                A(h),
                n(s) &&
                  l("Cookie.setSub(): Subcookie value cannot be undefined.");
              var o = this.getSubs(E);
              return u(o) || (o = {}), (o[h] = s), this.setSubs(E, o, c);
            },
            setSubs: function (E, h, s) {
              g(E),
                u(h) || l("Cookie.setSubs(): Cookie value must be an object.");
              var c = this._createCookieString(
                E,
                this._createCookieHashString(h),
                !1,
                s
              );
              return (i.cookie = c), c;
          ...
          e.mix(e.namespace("XML"), {
            parse: function (T) {
              ...
              return (
                typeof T == "string" &&
                  ((_ = e.config.win),
                  _.ActiveXObject !== void 0
                    ? ((m = new ActiveXObject("Microsoft.XMLDOM")),
                      (m.async = !1),
                      m.loadXML(T))
                    : _.DOMParser !== void 0
                    ? (m = new DOMParser().parseFromString(T, "text/xml"))
                    : _.Windows !== void 0 &&
                      ((m = new Windows.Data.Xml.Dom.XmlDocument()),
                      m.loadXml(T))),
                m === null ||
                  m.documentElement === null ||
                  m.documentElement.nodeName === "parsererror",
                m
              );
            },
          }),
            (e.namespace("Parsers").xml = e.XML.parse),
            e.namespace("DataType"),
            (e.DataType.XML = e.XML);
        },
        "3.17.2"
      );
    },
        ...
        function (e, q) {
          ...
          e.mix(m, {
            ...
            setAttribute: function (o, t, p, f) {
              o &&
                t &&
                o.setAttribute &&
                ((t = m.CUSTOM_ATTRIBUTES[t] || t), o.setAttribute(t, p, f));
            },
            getAttribute: function (o, t, p) {
              ...
              return (
                o &&
                  t &&
                  o.getAttribute &&
                  ((t = m.CUSTOM_ATTRIBUTES[t] || t),
                  (f =
                    o.tagName === "BUTTON" && t === "value"
                      ? m.getValue(o)
                      : o.getAttribute(t, p)),
                  f === null && (f = "")),
                f
            ...
            getValue: function (o) {
              ...
              return (
                o &&
                  o[_] &&
                  ((p = m.VALUE_GETTERS[o[_].toLowerCase()]),
                  p ? (t = p(o)) : (t = o.value)),
                t === u && (t = u),
                typeof t == "string" ? t : ""
              );
            ...
            setValue: function (o, t) {
              ...
              o &&
                o[_] &&
                ((p = m.VALUE_SETTERS[o[_].toLowerCase()]),
                (t = t === null ? "" : t),
                p ? p(o, t) : (o.value = t));
            },
            creators: {},
            ...
            n("value-set", "select", {
              test: function () {
                ...
                return (
                  (o.innerHTML = "<option>1</option><option>2</option>"),
                  (o.value = "2"),
                  o.value && o.value === "2"
                );
              },
            ...
            d("value-set", "select") ||
              (m.VALUE_SETTERS.select = function (o, t) {
                for (
                  var p = 0, f = o.getElementsByTagName("option"), b;
                  (b = f[p++]);
            ...
            e.mix(m.VALUE_GETTERS, {
              button: function (o) {
                return o.attributes && o.attributes.value
            ...
            e.mix(m.VALUE_SETTERS, {
              button: function (o, t) {
                ...
                p ||
                  ((p = o[v].createAttribute("value")), o.setAttributeNode(p)),
                  (p.value = t);
              },
            }),
            e.mix(m.VALUE_GETTERS, {
              ...
              select: function (o) {
                ...
                return (
                  p &&
                    ...
                    (o.multiple ||
                      (o.selectedIndex > -1 &&
                        (t = m.getValue(p[o.selectedIndex])))),
                  t
                );
              },
            });
          ...
          e.mix(e.DOM, {
            ...
            addClass: function (o, t) {
              o &&
                !e.DOM.hasClass(o, t) &&
                (o.className = e.Lang.trim([o.className, t].join(" ")));
            },
            removeClass: function (o, t) {
              t &&
                a(o, t) &&
                ((o.className = e.Lang.trim(
                  o.className.replace(
                    e.DOM._getRegExp("(?:^|\\s+)" + t + "(?:\\s+|$)"),
                    " "
                  )
                )),
                a(o, t) && i(o, t));
          ...
          var l = /<([a-z]+)/i,
            ...
            A = function (o, t) {
              ...
              return (
                (p.innerHTML = o),
                (!p.firstChild || p.firstChild.tagName !== t.toUpperCase()) &&
                  (f = !1),
                f
              );
            },
          ...
          e.mix(e.DOM, {
            ...
            _create: function (o, t, p) {
              ...
              return (
                f
                  ? (f = f.cloneNode(!1))
                  : (f = m._fragClones[p] = t.createElement(p)),
                (f.innerHTML = o),
                f
              );
            },
            _children: function (o, t) {
              ...
              if (
                (f &&
                  f.tags &&
                  (t ? (f = o.children.tags(t)) : (N = f.tags("!").length)),
                !f || (!f.tags && t) || N)
              )
                for (b = f || o.childNodes, f = []; (O = b[p++]); )
                  O.nodeType === 1 && (!t || t === O.tagName) && f.push(O);
              return f || [];
            },
            create: function (o, t) {
              typeof o == "string" && (o = e.Lang.trim(o)),
                (t = t || e.config.doc);
              var p = l.exec(o),
                f = m._create,
                b = g,
              ...
              return (
                o != null &&
                  (p &&
                    p[1] &&
                    ((O = b[p[1].toLowerCase()]),
                    typeof O == "function" ? (f = O) : (y = O)),
                  (C = f(o, t, y)),
                  (I = C.childNodes),
                  I.length === 1
                    ? (N = C.removeChild(I[0]))
                    : I[0] && I[0].className === "yui3-big-dummy"
                    ? ((c = C.selectedIndex),
                      I.length === 2
                        ? (N = I[0].nextSibling)
                        : (C.removeChild(I[0]), (N = m._nl2frag(I, t))))
                    : (N = m._nl2frag(I, t))),
                N
              );
            },
            _nl2frag: function (o, t) {
              ...
              if (o && (o.push || o.item) && o[0])
                for (
                  t = t || o[0].ownerDocument,
                    p = t.createDocumentFragment(),
                    o.item && (o = e.Array(o, 0, !0)),
                    f = 0,
                    b = o.length;
                  f < b;
                  f++
            ...
            addHTML: function (o, t, p) {
              ...
              if (t != null) {
                if (t.nodeType) y = t;
                  ...
                  for (
                    y = e.config.doc.createDocumentFragment();
                    (N = t[b++]);
                ...
                if (y && p.parentNode) p.parentNode.insertBefore(y, p);
                  ...
                  switch (p) {
                    ...
                    case "after":
                      y &&
                        (o.nextSibling
                          ? f.insertBefore(y, o.nextSibling)
                          : f.appendChild(y));
                      break;
                    default:
                      y && o.appendChild(y);
              ...
              return (
                o.nodeName == "SELECT" && c > 0 && (o.selectedIndex = c - 1), O
              );
            },
            wrap: function (o, t) {
            ...
            unwrap: function (o) {
              ...
              if (t)
                if (((b = t.parentNode), b)) {
                  for (o = t.firstChild; o !== p; )
                    (f = o.nextSibling), b.insertBefore(o, t), (o = f);
                  b.replaceChild(p, t);
            ...
            e.mix(e.DOM, {
              ...
              _setSize: function (o, t, p) {
                ...
                var f = 0;
                (o.style[t] = p + "px"),
                  (f = t === "height" ? o.offsetHeight : o.offsetWidth),
                  f > p &&
                    ((p = p - (f - p)),
                    p < 0 && (p = 0),
                    (o.style[t] = p + "px"));
          ...
          var T = "nodeType",
            ...
            E = {
              ...
              getId: function (h) {
                var s;
                return (
                  h.id && !h.id.tagName && !h.id.item
                    ? (s = h.id)
                    : h.attributes &&
                      h.attributes.id &&
                      (s = h.attributes.id.value),
                  s
                );
              },
              setId: function (h, s) {
              ...
              ancestor: function (h, s, c, o) {
                ...
                return (
                  c && (t = !s || s(h) ? h : null),
                  t || E.elementByAxis(h, d, s, null, o)
                );
              },
              ...
              allById: function (h, s) {
                ...
                if (s.querySelectorAll)
                  o = s.querySelectorAll('[id="' + h + '"]');
                else if (s.all) {
                  if (
                    ((c = s.all(h)),
                    c &&
                      (c.nodeName &&
                        (c.id === h ? (o.push(c), (c = g)) : (c = [c])),
                      c.length))
                  )
                    for (t = 0; (p = c[t++]); )
                      (p.id === h ||
              ...
              _getRegExp: function (h, s) {
                return (
                  ...
                  E._regexCache[h + s] ||
                    (E._regexCache[h + s] = new RegExp(h, s)),
                  E._regexCache[h + s]
                );
              },
              _getDoc: function (h) {
                ...
                return (
                  h &&
                    (s = h[T] === 9 ? h : h[m] || h.document || e.config.doc),
                  s
                );
              },
              _getWin: function (h) {
              ...
              _batch: function (h, s, c, o, t, p) {
                ...
                if (s && h)
                  for (; (N = h[b++]); )
                    (f = f = s.call(E, N, c, o, t, p)),
                      typeof f != "undefined" && (O || (O = []), O.push(f));
        ...
        function (e, q) {
          (function (T) {
            var m = "documentElement",
              ...
              c;
            T.UA.ie &&
              (T.config.doc[_] !== "BackCompat" ? (c = m) : (c = "body")),
              T.mix(h, {
                    ...
                    ? function (o) {
                        ...
                        return (
                          o &&
                            ...
                            x.contains
                              ? (U = x.contains(o))
                              : (U = T.DOM.contains(x, o)),
                            U
                              ? ((I = C.defaultView),
                                I && "pageXOffset" in I
                                  ? ((p = I.pageXOffset), (f = I.pageYOffset))
                                  : ((p = c
                                      ? C[c].scrollLeft
                                      : h.docScrollX(o, C)),
                                    (f = c
                                ...
                                T.UA.ie &&
                                  (!C.documentMode ||
                                    C.documentMode < 8 ||
                                    b === a) &&
                                  ((O = x.clientLeft), (y = x.clientTop)),
                                (N = o[A]()),
                                (t = [N.left, N.top]),
                                (O || y) && ((t[0] -= O), (t[1] -= y)),
                                (f || p) &&
                                  (!T.UA.ios || T.UA.ios >= 4.2) &&
                                  ((t[0] += p), (t[1] += f)))
                              : (t = h._getOffset(o))),
                          t
                        );
                          ...
                          if (h.inDoc(o)) {
                            for (
                              t = [o.offsetLeft, o.offsetTop],
                                p = o.ownerDocument,
                                f = o,
                                b = !!(T.UA.gecko || T.UA.webkit > 519);
                              (f = f.offsetParent);

                            )
                              (t[0] += f.offsetLeft),
                                (t[1] += f.offsetTop),
                                b && (t = h._calcBorders(f, t));
                            if (h.getStyle(o, v) != u) {
                              for (f = o; (f = f.parentNode); )
                                (N = f.scrollTop),
                                  (O = f.scrollLeft),
                                  T.UA.gecko &&
                                    h.getStyle(f, "overflow") !== "visible" &&
                                    (t = h._calcBorders(f, t)),
                                  (N || O) && ((t[0] -= O), (t[1] -= N));
                              (t[0] += h.docScrollX(o, p)),
                                (t[1] += h.docScrollY(o, p));
                            } else
                              (t[0] += h.docScrollX(o, p)),
                                (t[1] += h.docScrollY(o, p));
                  ...
                  function () {
                    ...
                    return (
                      p &&
                        ...
                        (t.appendChild(o.createElement("p")).style.height =
                          "1px"),
                ...
                setXY: function (o, t, p) {
                  ...
                  o &&
                    ...
                    ((b = h.getStyle(o, v)),
                    (N = h._getOffset(o)),
                    b == "static" && ((b = n), f(o, v, b)),
                    (y = h.getXY(o)),
                    t[0] !== null &&
                      f(o, d, Math.floor(t[0] - y[0] + N[0]) + "px"),
                    t[1] !== null &&
                      f(o, r, Math.floor(t[1] - y[1] + N[1]) + "px"),
                    p ||
                      ((O = h.getXY(o)),
                      (O[0] !== t[0] || O[1] !== t[1]) && h.setXY(o, t, !0)));
                },
                setX: function (o, t) {
                ...
                _calcBorders: function (o, t) {
                  ...
                  return (
                    T.UA.gecko && s.test(o.tagName) && ((p = 0), (f = 0)),
                    (t[0] += f),
                    (t[1] += p),
                    t
                  );
                ...
                _getDocSize: function (o) {
                  var t = o ? h._getDoc(o) : T.config.doc,
                    p = t[m];
                  return (
                    t[_] != "CSS1Compat" && (p = t.body),
                    { height: p.scrollHeight, width: p.scrollWidth }
                  );
                },
              });
          })(e),
      ...
      YUI.add(
        ...
        function (e, q) {
            ...
            N = {
              ...
              get: function (y, C) {
                ...
                return (
                  y &&
                    ((U = b(y)[C]),
                    C === u && e.DOM.CUSTOM_STYLES[u]
                      ? (I = e.DOM.CUSTOM_STYLES[u].get(y))
                      : !U || (U.indexOf && U.indexOf(m) > -1)
                      ? (I = U)
                      : e.DOM.IE.COMPUTED[C]
                      ? (I = e.DOM.IE.COMPUTED[C](y, C))
                      : p.test(U)
                      ? (I = N.getPixel(y, C) + m)
                      : (I = U)),
                  I
                  ...
                  I === n || I.indexOf("%") > -1
                    ? ((M = y["offset" + U]),
                      D !== "BackCompat" &&
                        ...
                        S[1] &&
                          ((M -= N.getPixel(y, "padding" + S[1])),
                          (M -= N.getBorderWidth(
                            y,
                            "border" + S[1] + "Width",
                            1
                          )))))
                    : (!y.style[x] && !y.style[C] && (y.style[C] = I),
                      (M = y.style[x])),
                  M + m
                );
              },
              ...
              getBorderWidth: function (y, C, I) {
                ...
                return (
                  U.indexOf(m) < 0 &&
                    (N.borderMap[U] && y.currentStyle.borderStyle !== "none"
                      ? (U = N.borderMap[U])
                      : (U = 0)),
                  I ? parseFloat(U) : U
                );
              ...
              getVisibility: function (y, C) {
                for (var I; (I = y.currentStyle) && I[C] === "inherit"; )
                  y = y.parentNode;
                return I ? I[C] : h;
              },
              getColor: function (y, C) {
                ...
                return (
                  (!I || I === E) &&
                    e.DOM.elementByAxis(y, "parentNode", null, function (U) {
              ...
              (e.DOM.CUSTOM_STYLES[u] = {
                ...
                set: function (y, C, I) {
                  var U,
                    ...
                    S = x[_];
                  (I = I || y.style),
                    C === "" && ((U = u in x ? x[u] : 1), (C = U)),
                    typeof S == "string" &&
                      ((I[_] =
                        S.replace(/alpha([^)]*\))/gi, "") +
                        (C <= 1 ? "alpha(" + u + "=" + C * 100 + ")" : "")),
                      I[_] || I.removeAttribute(_),
                      x[T] || (I.zoom = 1));
                },
              });
          try {
          ...
          o("style", "computedStyle") ||
            ((O[g] = O[A] = N.getOffset),
            (O.color = O.backgroundColor = N.getColor),
            (O[d] = O[r] = O[a] = O[i] = O[l] = N.getBorderWidth),
            (O.marginTop =
              O.marginRight =
              O.marginBottom =
              O.marginLeft =
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          e.Array.each(h, function (c) {
              ...
              setStyle: function (c, o, t, p) {
                ...
                if (p) {
                  if (
                    (t === null || t === ""
                      ? (t = "")
                      : !isNaN(Number(t)) && s.test(o) && (t += g.DEFAULT_UNIT),
                    o in f)
                  )
                    if (f[o].set) {
                      f[o].set(c, t, p);
            ...
            l[T][v][n] !== void 0
              ? (g.CUSTOM_STYLES[u] = n)
              : l[T][v][d] !== void 0 && (g.CUSTOM_STYLES[u] = d),
            e.UA.webkit &&
              (g[a] = function (c, o) {
                var t = c[_][m],
                  p = t[a](c, "")[o];
            ...
            (e.DOM._getOffset = function (c) {
              ...
              return (
                c &&
                  ((o = g.getStyle(c, "position")),
                  (t = [
                    parseInt(g[a](c, "left"), 10),
                    parseInt(g[a](c, "top"), 10),
                  ]),
                  isNaN(t[0]) &&
                    ((t[0] = parseInt(g.getStyle(c, "left"), 10)),
                    isNaN(t[0]) &&
                      (t[0] = o === "relative" ? 0 : c.offsetLeft || 0)),
                  isNaN(t[1]) &&
                    ((t[1] = parseInt(g.getStyle(c, "top"), 10)),
                    isNaN(t[1]) &&
                      (t[1] = o === "relative" ? 0 : c.offsetTop || 0))),
                t
              );
            }),
            A &&
              ((g.CUSTOM_STYLES.transform = {
                set: function (c, o, t) {
                  t[A] = o;
                },
                get: function (c) {
    ...
    245518: function () {
      (function () {
        ...
        if (_.doScroll && !q._ieready) {
          ...
          /*! DOMReady: based on work by: Dean Edwards/John Resig/Matthias Miller/Diego Perini */ self !==
          self.top
            ? ((e = function () {
                m.readyState == "complete" && (q.remove(m, v, e), q.ieready());
              }),
              q.add(m, v, e))
            : (q._dri = setInterval(function () {
                try {
                  _.doScroll("left"),
                    clearInterval(q._dri),
                    (q._dri = null),
                    q._ieready();
                } catch (n) {}
              }, u));
          ...
          function (e, q) {
            ...
            function m(a) {
              ...
              return (
                ...
                (i.stopPropagation = l.stopPropagation),
                (i.stopImmediatePropagation = l.stopImmediatePropagation),
            ...
            var _ = e.config.doc && e.config.doc.implementation,
              ...
              u = { 0: 1, 4: 2, 2: 3 },
              n = { mouseout: "toElement", mouseover: "fromElement" },
                ...
                init: function () {
                  ...
                  (this.target = d(a.srcElement)),
                    "clientX" in a &&
                      ...
                      (A = g.body),
                      (E = g.documentElement),
                      (i += E.scrollLeft || (A && A.scrollLeft) || 0),
                      (l += E.scrollTop || (A && A.scrollTop) || 0),
                      (this.pageX = i),
                      (this.pageY = l)),
                    a.type == "mouseout"
                      ? (h = a.toElement)
                      : a.type == "mouseover" && (h = a.fromElement),
                    (this.relatedTarget = d(h || a.relatedTarget)),
                    (this.which = this.button =
                      a.keyCode || u[a.button] || a.button);
                },
            ...
            if (
              (e.extend(T, e.DOM2EventFacade, r),
              e.extend(m, e.DOM2EventFacade, r),
              (m.prototype.init = function () {
                ...
                (this.altKey = a.altKey),
                  ...
                  (this.type = (i && i.type) || a.type),
                  (this.clientX = a.clientX),
                  (this.clientY = a.clientY),
                  (this.keyCode = this.charCode = a.keyCode),
                  (this.which = this.button =
                    a.keyCode || u[a.button] || a.button);
                for (A in g) g.hasOwnProperty(A) && l(this, A, g[A]);
                this._touch &&
                  this._touch(a, this._currentTarget, this._wrapper);
              }),
              (m._lazyProperties = {
                target: function () {
                ...
                wheelDelta: function () {
                  var a = this._event;
                  if (a.type === "mousewheel" || a.type === "DOMMouseScroll")
                    return a.detail
                      ? a.detail * -1
                      : Math.round(a.wheelDelta / 80) ||
                          (a.wheelDelta < 0 ? -1 : 1);
                },
                pageX: function () {
                  var a = this._event,
                  ...
                  return (
                    i === void 0 &&
                      ((l = e.config.doc),
                      (g = l.body && l.body.scrollLeft),
                      (A = l.documentElement.scrollLeft),
                      (i = a.clientX + (A || g || 0))),
                    i
                  );
                },
                pageY: function () {
                  ...
                  return (
                    i === void 0 &&
                      ((l = e.config.doc),
                      (g = l.body && l.body.scrollTop),
                      (A = l.documentElement.scrollTop),
                      (i = a.clientY + (A || g || 0))),
                    i
                  );
                },
              ...
              if (v)
                try {
                  Object.defineProperty(
                    e.config.doc.createEventObject(),
                    "z",
                    {}
                  );
                } catch (a) {
    ...
    68367: function () {
      YUI.add(
        "event-base",
        function (e, q) {
          e.publish("domready", { fireOnce: !0, async: !0 }),
            YUI.Env.DOMReady
              ? e.fire("domready")
              : e.Do.before(
                  function () {
          ...
          e.extend(u, Object, {
            init: function () {
              var n = this._event,
                ...
                a = n.pageY,
                i,
                l = this._currentTarget;
              (this.altKey = n.altKey),
                (this.ctrlKey = n.ctrlKey),
                (this.metaKey = n.metaKey),
                (this.shiftKey = n.shiftKey),
                (this.type = (d && d.type) || n.type),
                (this.clientX = n.clientX),
                (this.clientY = n.clientY),
                (this.pageX = r),
                (this.pageY = a),
                (i = n.keyCode || n.charCode),
                T.webkit && i in _ && (i = _[i]),
                (this.keyCode = i),
                (this.charCode = i),
                (this.which = n.which || n.charCode || i),
                (this.button = this.which),
                (this.target = v(n.target)),
                (this.currentTarget = v(l)),
                (this.relatedTarget = v(n.relatedTarget)),
                (n.type == "mousewheel" || n.type == "DOMMouseScroll") &&
                  (this.wheelDelta = n.detail
                    ? n.detail * -1
                    : Math.round(n.wheelDelta / 80) ||
                      (n.wheelDelta < 0 ? -1 : 1)),
                this._touch && this._touch(n, l, this._wrapper);
            },
            stopPropagation: function () {
            ...
            halt: function (n) {
              n ? this.stopImmediatePropagation() : this.stopPropagation(),
                this.preventDefault();
            },
          }),
            (u.resolve = v),
            ...
            (function () {
                ...
                o = (function () {
                  ...
                  return {
                    ...
                    startInterval: function () {
                      o._interval ||
                        (o._interval = setInterval(o._poll, o.POLL_INTERVAL));
                    },
                    onAvailable: function (y, C, I, U, x, S) {
                      var D = e.Array(y),
                        M,
                        L;
                      for (M = 0; M < D.length; M = M + 1)
                        f.push({
                          id: D[M],
                          fn: C,
                          obj: I,
                      ...
                      return (
                        (p = this.POLL_RETRYS),
                        e.config.win.setTimeout(o._poll, 0),
                        (L = new e.EventHandle({
                          _delete: function () {
                            if (L.handle) {
                              L.handle.detach();
                        ...
                        S ||
                          ((S = e.publish(M, {
                            ...
                            contextFn: function () {
                              return U
                                ? S.el
                                : ((S.nodeRef = S.nodeRef || e.one(S.el)),
                                  S.nodeRef);
                            },
                          })),
                          (S.overrides = {}),
                    ...
                    _attach: function (y, C) {
                      var I,
                        ...
                        F = C && C.capture,
                        X = C && C.overrides;
                      if ((y[y.length - 1] === E && (I = !0), !P || !P.call))
                        return !1;
                      if (h(R))
                        return (
                          (U = []),
                          e.each(R, function (B, H) {
                      ...
                      if (e.Lang.isString(R)) {
                        if (I) x = e.DOM.byId(R);
                          ...
                          switch (((x = e.Selector.query(R)), x.length)) {
                            case 0:
                              x = null;
                              break;
                            case 1:
                      ...
                      return R
                        ? (e.Node &&
                            e.instanceOf(R, e.Node) &&
                            (R = e.Node.getDOMNode(R)),
                          (S = o._createWrapper(R, w, F, I, k)),
                          X && e.mix(S.overrides, X),
                          R == r &&
                            w == "load" &&
                            YUI.Env.windowLoaded &&
                            (M = !0),
                          I && y.pop(),
                          (D = y[3]),
                          (L = S._on(P, D, y.length > 4 ? y.slice(4) : null)),
                          M && S.fire(),
                          L)
                        : !1;
                    },
                    detach: function (y, C, I, U) {
                      var x = e.Array(arguments, 0, !0),
                        ...
                        w,
                        P;
                      if ((x[x.length - 1] === E && (S = !0), y && y.detach))
                        return y.detach();
                      if (
                        (typeof I == "string" &&
                          (S
                            ? (I = e.DOM.byId(I))
                            : ((I = e.Selector.query(I)),
                              (D = I.length),
                              D < 1 ? (I = null) : D == 1 && (I = I[0]))),
                        !I)
                      )
                        return !1;
                      if (I.detach) return x.splice(2, 1), I.detach.apply(I, x);
                      if (h(I)) {
                        for (M = !0, L = 0, D = I.length; L < D; ++L)
                          (x[2] = I[L]),
                            (M = e.Event.detach.apply(e.Event, x) && M);
                        return M;
                      }
                      return !y || !C || !C.call
                        ? o.purgeElement(I, !1, y)
                        : ((w = "event:" + e.stamp(I) + y),
                          (P = b[w]),
                          P ? P.detach(C) : !1);
                    },
                    getEvent: function (y, C, I) {
                      ...
                      return I
                        ? U
                        : new e.DOMEventFacade(
                            U,
                            C,
                            b["event:" + e.stamp(C) + y.type]
                          );
                    },
                        ...
                        for (
                              ...
                              try {
                                L.compat
                                  ? (L.override
                                    ...
                                    L.fn.call(w, L.obj))
                                  : ((w = L.obj || e.one(M)),
                                    L.fn.apply(w, e.Lang.isArray(P) ? P : []));
                              } catch (R) {}
                            },
                            y = 0,
                            C = f.length;
                          ...
                          (I = f[y]),
                            I &&
                              ...
                              ((U = I.compat
                                ? e.DOM.byId(I.id)
                                : e.Selector.query(I.id, null, !0)),
                              U ? (S(U, I), (f[y] = null)) : x.push(I));
                    ...
                    purgeElement: function (y, C, I) {
                      var U = e.Lang.isString(y)
                          ? e.Selector.query(y, null, !0)
                          : y,
                      ...
                      if (C && U)
                        for (
                          x = x || [],
                            M = e.Selector.query("*", U),
                            D = M.length,
                            S = 0;
                          S < D;
                          ++S
                        )
                          (L = o.getListeners(M[S], I)), L && (x = x.concat(L));
                      if (x)
                    ...
                    _clean: function (y) {
                      var C = y.key,
                        I = y.domkey;
                      i(y.el, y.type, y.fn, y.capture),
                        delete b[C],
                        delete e._yuievt.events[C],
                        O[I] &&
                          (delete O[I][C], e.Object.size(O[I]) || delete O[I]);
                    },
                    getListeners: function (y, C) {
                      ...
                      return U
                        ? (S
                            ? (D[C] && D[C].eventDef && (S += "_synth"),
                              U[S] && x.push(U[S]),
                              (S += "native"),
                              U[S] && x.push(U[S]))
                            : e.each(U, function (M, L) {
                                x.push(M);
                              }),
                          x.length ? x : null)
                        : null;
              ...
              if (
                ((e.Event = o),
                d.injected || YUI.Env.windowLoaded ? l() : a(r, "load", l),
                e.UA.ie && (e.on(A, o._poll), e.UA.ie < 7))
              )
                try {
                  a(r, "unload", g);
                } catch (t) {}
              (o.Custom = e.CustomEvent),
                (o.Subscriber = e.Subscriber),
                (o.Target = e.EventTarget),
                (o.Handle = e.EventHandle),
                (o.Facade = e.EventFacade),
                o._poll();
            })(),
        ...
        function (e, q) {
          ...
          var T = 0,
            ...
            _ = {
              ...
              before: function (f, b, N, O) {
                ...
                return (
                  O &&
                    ((C = [f, O].concat(e.Array(arguments, 4, !0))),
                    (y = e.rbind.apply(e, C))),
                  this._inject(T, y, b, N)
                );
              },
              ...
              _inject: function (f, b, N, O) {
                ...
                return (
                  ...
                  (C = N._yuiaop),
                  C[O] ||
                    ((C[O] = new e.Do.Method(N, O)),
                    (N[O] = function () {
                      return C[O].exec.apply(C[O], arguments);
                    })),
                  (I = y + e.stamp(b) + O),
                  C[O].register(I, b, f),
                  new e.EventHandle(C[O], I)
                );
              },
              detach: function (f) {
                f.detach && f.detach();
          ...
          (e.Do = _),
            ...
            (_.Method.prototype.exec = function () {
              var f = e.Array(arguments, 0, !0),
                ...
                I = !1;
              for (b in y)
                if (y.hasOwnProperty(b) && ((N = y[b].apply(this.obj, f)), N))
              ...
              I || (N = this.method.apply(this.obj, f)),
                (_.originalRetVal = N),
                (_.currentRetVal = N);
              for (b in C)
                if (C.hasOwnProperty(b)) {
                  if (
                    ((O = C[b].apply(this.obj, f)),
                    O && O.constructor === _.Halt)
                  )
                    return O.retVal;
                  O &&
                    O.constructor === _.AlterReturn &&
                    ((N = O.newRetVal), (_.currentRetVal = N));
                }
              return N;
            }),
          ...
          (e.CustomEvent = function (f, b) {
            ...
            (e.CustomEvent.prototype = {
              ...
              getSubs: function () {
                var f = this.sibling,
                  ...
                  y;
                return (
                  f && ((O = f._subscribers), (y = f._afters)),
                  O
                    ? b
                      ? (b = b.concat(O))
                      : (b = O.concat())
                ...
                return (
                  this.fireOnce &&
                    ...
                    this.emitFacade &&
                      ...
                      this._addFacadeToArgs(C),
                    this.async
                      ? e.config.win.setTimeout(
                          e.bind(this._notify, this, y, C),
                          0
                        )
                      : this._notify(y, C)),
                  O === u
                    ? (this._afters || (this._afters = []),
                      this._afters.push(y))
                    : (this._subscribers || (this._subscribers = []),
                      this._subscribers.push(y)),
                  this._kds &&
                    (O === u
                      ? (this.afters[y.id] = y)
                      : (this.subscribers[y.id] = y)),
                  new e.EventHandle(this, y)
                );
              },
              ...
              detach: function (f, b) {
                ...
                if (C)
                  for (N = C.length; N >= 0; N--)
                    (O = C[N]),
                      O && (!f || f === O.fn) && (this._delete(O, C, N), y++);
                if (I)
                  for (N = I.length; N >= 0; N--)
                    (O = I[N]),
                      O && (!f || f === O.fn) && (this._delete(O, I, N), y++);
                return y;
              },
              ...
              _fire: function (f) {
                return this.fireOnce && this.fired
                  ? !0
                  : ((this.fired = !0),
                    this.fireOnce && (this.firedWith = f),
                    this.emitFacade ? this.fireComplex(f) : this.fireSimple(f));
              },
              fireSimple: function (f) {
                if (
                  ((this.stopped = 0), (this.prevented = 0), this.hasSubs())
                ) {
                  var b = this.getSubs();
              ...
              _procSubs: function (f, b, N) {
                ...
                for (y = 0, C = f.length; y < C; y++)
                  if (
                    ...
                    O &&
                      O.fn &&
                      (this._notify(O, b, N) === !1 && (this.stopped = 2),
                      this.stopped === 2))
                  )
                    return !1;
                return !0;
              ...
              _broadcast: function (f) {
                if (!this.stopped && this.broadcast) {
                  var b = f.concat();
                  b.unshift(this.type),
                    this.host !== e && e.fire.apply(e, b),
                    this.broadcast === 2 && e.Global.fire.apply(e.Global, b);
                }
              },
              ...
              _delete: function (f, b, N) {
                var O = f._when;
                b || (b = O === u ? this._afters : this._subscribers),
                  b &&
                    ((N = v.indexOf(b, f, 0)),
                    f && b[N] === f && b.splice(N, 1)),
                  this._kds &&
                    (O === u
                  ...
                  this.monitored &&
                    this.host &&
                    this.host._monitor("detach", this, { ce: this, sub: f }),
                  f && (f.deleted = !0);
              },
            }),
            ...
            (e.Subscriber.prototype = {
              ...
              notify: function (f, b) {
                var N = this.context,
                  O = !0;
                if (
                  (N || (N = b.contextFn ? b.contextFn() : b.context),
                  e.config && e.config.throwFail)
                )
            ...
            (e.EventHandle.prototype = {
              batch: function (f, b) {
                f.call(b || this, this),
                  e.Lang.isArray(this.evt) &&
                    e.Array.each(this.evt, function (N) {
                      N.batch.call(b || N, f);
                    });
              },
              detach: function () {
          ...
          var g = e.Lang,
            ...
            p = function (f) {
              ...
              b ||
                ...
                f &&
                  (l(N, f, !0),
                  f.chain !== void 0 && (b.chain = f.chain),
                  f.prefix && (N.prefix = f.prefix));
            };
          (p.prototype = {
            constructor: p,
            once: function () {
            ...
            on: function (f, b, N) {
              ...
              return (
                ...
                g.isObject(f)
                  ? g.isFunction(f)
                    ? e.Do.before.apply(e.Do, arguments)
                    : ((C = b),
                      (I = N),
                      (U = r.call(arguments, 0)),
                      (x = []),
                      g.isArray(f) && (B = !0),
                      (w = f._after),
                      delete f._after,
                      e.each(
                        ...
                        function (H, V) {
                          g.isObject(H) &&
                            ((C = H.fn || (g.isFunction(H) ? H : C)),
                            (I = H.context || I));
                          var G = w ? h : "";
                          (U[0] = G + (B ? H : V)),
                            (U[1] = C),
                            (U[2] = I),
                            x.push(this.on.apply(this, U));
                        },
                        this
                      ),
                      O.chain ? this : new e.EventHandle(x))
                  : ((D = y[0]),
                    (w = y[2]),
                    (R = y[3]),
                    k && e.instanceOf(this, k) && R in k.DOM_EVENTS
                      ? ((U = r.call(arguments, 0)),
                        U.splice(2, 0, k.getDOMNode(this)),
                        e.on.apply(e, U))
                      : ((f = y[1]),
                        e.instanceOf(this, YUI) &&
                          ((P = e.Env.evt.plugins[f]),
                          (U = r.call(arguments, 0)),
                          (U[0] = R),
                          k &&
                            ((F = U[2]),
                            e.instanceOf(F, e.NodeList)
                              ? (F = e.NodeList.getDOMNodes(F))
                              : e.instanceOf(F, k) && (F = k.getDOMNode(F)),
                            (X = R in k.DOM_EVENTS),
                            X && (U[2] = F)),
                          P
                            ? (M = P.on.apply(e, U))
                            : (!f || X) && (M = e.Event._attach(U))),
                        M ||
                          ((S = O.events[f] || this.publish(f)),
                          (M = S._on(
                            b,
                            N,
                            arguments.length > 3 ? r.call(arguments, 3) : null,
                            w ? "after" : !0
                          )),
                          f.indexOf("*:") !== -1 && (this._hasSiblings = !0)),
                        D &&
                          ((L[D] = L[D] || {}),
                          (L[D][f] = L[D][f] || []),
                          L[D][f].push(M)),
                ...
                k = function (F, X, B) {
                  ...
                  if (H)
                    for (G = H.length - 1; G >= 0; --G)
                      (V = H[G].evt),
                        (V.host === B || V.el === B) && H[G].detach();
                };
              if (x) {
                if (
                  ((w = M[x]),
                  (f = U[1]),
                  (L = I ? e.Node.getDOMNode(this) : this),
                  w)
                ) {
                  if (f) k(w, f, L);
                  else for (y in w) w.hasOwnProperty(y) && k(w, y, L);
                  return this;
                }
              } else {
                if (g.isObject(f) && f.detach) return f.detach(), this;
                if (I && (!S || S in C.DOM_EVENTS))
                  return (
                    (P = r.call(arguments, 0)),
                    (P[2] = C.getDOMNode(this)),
                    e.detach.apply(e, P),
                    this
                  );
              }
              if (((D = e.Env.evt.plugins[S]), e.instanceOf(this, YUI))) {
                if (((P = r.call(arguments, 0)), D && D.detach))
                  return D.detach.apply(e, P), this;
                if (!f || (!D && C && f in C.DOM_EVENTS))
                  return (P[0] = f), e.Event.detach.apply(e.Event, P), this;
              }
            ...
            publish: function (f, b) {
              ...
              return (
                typeof f == "string"
                  ? (C && (f = o(f, C)), (N = this._publish(f, y, b)))
                  : ((N = {}),
                    e.each(
                      f,
                      function (I, U) {
                        C && (U = o(U, C)),
                          (N[U] = this._publish(U, y, I || b));
                      },
                      this
                    )),
                N
            ...
            _publish: function (f, b, N) {
              ...
              return (
                (O = x[f]),
                ((C.monitored && !O) || (O && O.monitored)) &&
                  this._monitor("publish", f, { args: arguments }),
                O ||
                  ((O = x[f] = new e.CustomEvent(f, b)),
                  b || ((O.host = I), (O.context = U))),
                N && l(O, N, !0),
                O
              );
            },
            _monitor: function (f, b, N) {
              ...
              b &&
                (typeof b == "string"
                  ? ((C = b), (y = this.getEvent(b, !0)))
                  : ((y = b), (C = b.type)),
                ((this._yuievt.config.monitored && (!y || y.monitored)) ||
                  (y && y.monitored)) &&
                  ((O = C + "_" + f),
                  (N.monitored = f),
                  this.fire.call(this, O, N)));
            },
            fire: function (f) {
              ...
              if (
                (b && N <= 3
                  ? N === 2
                    ? (D = [arguments[1]])
                    : N === 3
                    ? (D = [arguments[1], arguments[2]])
                    : (D = [])
                  : (D = r.call(arguments, b ? 1 : 0)),
                b || (O = f && f.type),
                I && (O = o(O, I)),
                (x = y.events[O]),
                this._hasSiblings &&
                  ((S = this.getSibling(O, x)),
                  S && !x && (x = this.publish(O))),
                ((C.monitored && (!x || x.monitored)) || (x && x.monitored)) &&
                  this._monitor("fire", x || O, { args: D }),
                x)
              )
                S && (x.sibling = S), (U = x._fire(D));
              else {
                if (y.hasTargets) return this.bubble({ type: O }, D, this);
                U = !0;
              }
            ...
            getSibling: function (f, b) {
              ...
              return (
                f.indexOf(A) > -1 &&
                  ((f = c(f)),
                  (N = this.getEvent(f, !0)),
                  N && (N.applyConfig(b), (N.bubbles = !1), (N.broadcast = 0))),
                N
              );
            },
            getEvent: function (f, b) {
              var N, O;
              return (
                b || ((N = this._yuievt.config.prefix), (f = N ? o(f, N) : f)),
            ...
            e.mix(e, p.prototype),
            p.call(e, { bubbles: !1 }),
            (YUI.Env.globalEvents = YUI.Env.globalEvents || new p()),
          ...
          (e.EventFacade = function (a, i) {
            ...
            (n.fireComplex = function (a) {
              var i,
                ...
                S = C._yuievt,
                D;
              if (x && y.queuable && y.type !== x.next.type)
                return x.queue || (x.queue = []), x.queue.push([y, a]), !0;
              if (
                ((D = y.hasSubs() || S.hasTargets || y.broadcast),
                (y.target = y.target || C),
                (y.currentTarget = C),
                (y.details = a.concat()),
                D)
                ...
                if (
                  ...
                  (o = c[0]),
                  (t = c[1]),
                  (y.stopped = y.type !== i.type ? 0 : i.stopped),
                  (y.prevented = y.type !== i.type ? 0 : i.prevented),
                  y.stoppedFn &&
                    ((s = new e.EventTarget({ fireOnce: !0, context: C })),
                    (y.events = s),
                    s.on("stopped", y.stoppedFn)),
                  (y._facade = null),
                  (l = y._createFacade(a)),
                  o && y._procSubs(o, a, l),
                  y.bubbles &&
                    ...
                    ((U = i.bubbling),
                    (i.bubbling = y.type),
                    i.type !== y.type && ((i.stopped = 0), (i.prevented = 0)),
                    (h = C.bubble(y, a, null, i)),
                    (y.stopped = Math.max(y.stopped, i.stopped)),
                    (y.prevented = Math.max(y.prevented, i.prevented)),
                    (i.bubbling = U)),
                  (b = y.prevented),
                  b
                    ? ((N = y.preventedFn), N && N.apply(C, a))
                    : ((O = y.defaultFn),
                      O &&
                        ((!y.defaultTargetOnly && !i.defaultTargetOnly) ||
                          C === l.target) &&
                        O.apply(C, a)),
                  y.broadcast && y._broadcast(a),
                  t && !y.prevented && y.stopped < 2)
                )
                  if (
                    ((p = i.afterQueue), i.id === y.id || y.type !== S.bubbling)
                  ) {
                    if ((y._procSubs(t, a, l), p)) for (; (I = p.last()); ) I();
                  } else
                    (f = t),
                      i.execDefaultCnt &&
                        ((f = e.merge(f)),
                      ...
                      p || (i.afterQueue = new e.Queue()),
                      i.afterQueue.add(function () {
                        y._procSubs(f, a, l);
                      });
                if (((y.target = null), i.id === y.id)) {
                  if (((A = i.queue), A))
                    for (; A.length; )
                      (g = A.pop()), (E = g[0]), (i.next = E), E._fire(g[1]);
                  y.stack = null;
                }
                (h = !y.stopped),
                  y.type !== S.bubbling &&
                ...
                (O = y.defaultFn),
                  O &&
                    ((l = y._createFacade(a)),
                    (!y.defaultTargetOnly || C === l.target) && O.apply(C, a));
              return (y._facade = null), h;
            }),
            (n._hasPotentialSubscribers = function () {
              return (
                this.hasSubs() || this.host._yuievt.hasTargets || this.broadcast
              );
            }),
            (n._createFacade = n._getFacade =
              function (a) {
                var i = this.details,
                  l = i && i[0],
                  g = l && typeof l == "object",
                  A = this._facade;
                return (
                  A || (A = new e.EventFacade(this, this.currentTarget)),
                  g
                    ? (r(A, l), l.type && (A.type = l.type), a && (a[0] = A))
                    : a && a.unshift(A),
                  (A.details = this.details),
                  (A.target = this.originalTarget || this.target),
            ...
            (d.removeTarget = function (a) {
              ...
              return (
                i &&
                  (delete i[e.stamp(a, !0)],
                  _.size(i) === 0 && (this._yuievt.hasTargets = !1)),
                this
              );
            }),
              ...
              if (!a || (!a.stopped && A)) {
                for (c in A)
                  if (A.hasOwnProperty(c)) {
                    if (
                      ((h = A[c]),
                      (s = h._yuievt.events[p]),
                      h._hasSiblings && (t = h.getSibling(p, s)),
                      t && !s && (s = h.publish(p)),
                      (b = h._yuievt.bubbling),
                      (h._yuievt.bubbling = p),
                      !s)
                    )
                      h._yuievt.hasTargets && h.bubble(a, i, f, g);
                    else if (
                      (t && (s.sibling = t),
                      (s.target = f),
                      (s.originalTarget = f),
                      ...
                      (s.emitFacade = !0),
                      (s.stack = g),
                      (E = E && s.fire.apply(s, i || a.details || [])),
                      (s.broadcast = o),
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          function r(a, i, l, g) {
            ...
            if (v(a)) {
              if (((b = []), u(a)))
                for (p = 0, f = a.length; p < f; ++p)
                  (A[0] = a[p]), b.push(e.delegate.apply(e, A));
              else {
                A.unshift(null);
                for (p in a)
                  a.hasOwnProperty(p) &&
                    ((A[0] = p), (A[1] = a[p]), b.push(e.delegate.apply(e, A)));
              }
              return new e.EventHandle(b);
            }
            if (
              ((h = a.split(/\|/)),
              h.length > 1 && ((t = h.shift()), (A[0] = a = h.shift())),
              (s = e.Node.DOM_EVENTS[a]),
              v(s) && s.delegate && (N = s.delegate.apply(s, arguments)),
              !N)
            ) {
              if (!a || !i || !l || !g) return;
              (c = E ? e.Selector.query(E, null, !0) : l),
                !c &&
                  _(l) &&
                  (N = e.on(
                    "available",
                ...
                !N &&
                  c &&
                  (A.splice(2, 2, c),
                  (N = e.Event._attach(A, { facade: !1 })),
                  (N.sub.filter = g),
                  (N.sub._notify = r.notifySub));
            }
            return (
              N &&
                t &&
          ...
          (r.notifySub = function (a, i, l) {
            ...
            if (g) {
              for (
                g = T(g),
                  A = i[0] = new e.DOMEventFacade(i[0], l.el, l),
                  A.container = e.one(l.el),
                  E = 0,
                  h = g.length;
                E < h &&
                !A.stopped &&
                ((A.currentTarget = e.one(g[E])),
                (s = this.fn.apply(this.context || A.currentTarget, i)),
                s !== !1);
                ++E
              );
              return s;
            ...
            (r.compileFilter = e.cached(function (a) {
              return function (i, l) {
                return n(
                  i._node,
                  a,
                  l.currentTarget === l.target ? null : l.currentTarget._node
                );
              };
            })),
            (r._disabledRE = /^(?:button|input|select|textarea)$/i),
            (r._applyFilter = function (a, i, l) {
              var g = i[0],
                A = l.el,
                ...
                s = !1;
              if (
                (typeof SVGElementInstance != "undefined" &&
                  !E.nodeType &&
                  E.correspondingElement &&
                  (E = E.correspondingUseElement || E.correspondingElement),
                E.nodeType === 3 && (E = E.parentNode),
                E.disabled && r._disabledRE.test(E.nodeName))
              )
                return h;
              if ((i.unshift(E), _(a)))
                for (
                  ;
                  E && ((s = E === A), n(E, a, s ? null : A) && h.push(E), !s);

                )
                  E = E.parentNode;
              else {
                for (
                  i[0] = e.one(E), i[1] = new e.DOMEventFacade(g, A, l);
                  E && (a.apply(i[0], i) && h.push(E), E !== A);

                )
                  (E = E.parentNode), (i[0] = e.one(E));
                i[1] = g;
              }
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = e.Event._GESTURE_MAP,
            m = { start: T.start, end: T.end, move: T.move },
            _ = "start",
            v = "end",
            u = "move",
            n = "ownerDocument",
          ...
          e.Event.define("flick", {
            ...
            processArgs: function (h) {
              ...
              return (
                d in s || (s[d] = this.MIN_VELOCITY),
                r in s || (s[r] = this.MIN_DISTANCE),
                a in s || (s[a] = this.PREVENT_DEFAULT),
                s
              );
            },
            _onStart: function (h, s, c, o) {
              var t = !0,
                ...
                f,
                b,
                N = c._extra.preventDefault,
                O = h;
              h.touches && ((t = h.touches.length === 1), (h = h.touches[0])),
                t &&
                  (N && (!N.call || N(h)) && O.preventDefault(),
                  (h.flick = { time: new Date().getTime() }),
                  (c[i] = h),
                  (p = c[g]),
                  (b = s.get(E) === 9 ? s : s.get(n)),
                  p ||
                    ((p = b.on(m[v], e.bind(this._onEnd, this), null, s, c, o)),
                    (c[g] = p)),
                  (c[A] = b.once(
                    m[u],
                    e.bind(this._onMove, this),
                    null,
                    s,
                    c,
                    o
            ...
            _onEnd: function (h, s, c, o) {
              var t = new Date().getTime(),
                ...
                S,
                D = c[A];
              D && (D.detach(), delete c[A]),
                f &&
                  (h.changedTouches &&
                    (h.changedTouches.length === 1 && h.touches.length === 0
                      ? (b = h.changedTouches[0])
                      : (f = !1)),
                  f &&
                    ((C = c._extra),
                    (y = C[a]),
                    y && (!y.call || y(h)) && h.preventDefault(),
                    (N = p.flick.time),
                    (t = new Date().getTime()),
                    (O = t - N),
                    (I = [b.pageX - p.pageX, b.pageY - p.pageY]),
                    C.axis
                      ? (S = C.axis)
                      : (S = Math.abs(I[0]) >= Math.abs(I[1]) ? "x" : "y"),
                    (U = I[S === "x" ? 0 : 1]),
                    (x = O !== 0 ? U / O : 0),
                    isFinite(x) &&
                      Math.abs(U) >= C[r] &&
    ...
    950122: function () {
      YUI.add(
        ...
        function (e, q) {
          var T = e.Event,
            ...
            u = (function () {
              ...
              return (
                r &&
                  ((a = r.createElement("p")),
                  a.setAttribute("onbeforeactivate", ";"),
                  (d = a.onbeforeactivate !== void 0)),
                d
              );
            })();
          function n(d, r, a) {
              ...
              d,
              {
                ...
                _attach: function (l, g, A) {
                  return e.DOM.isWindow(l)
                    ...
                    : T._attach([r, this._proxy, l, this, g, A], {
                        capture: !0,
                      });
                },
                _proxy: function (l, g, A) {
                  var E = l.target,
                    ...
                    o = u || E !== h,
                    t;
                  (g.currentTarget = A ? E : h),
                    (g.container = A ? h : null),
                    s
                      ? (o = !0)
                      : ((s = {}),
                        E.setData(i, s),
                        o &&
                          ((t = T._attach([a, this._notify, E._node]).sub),
                          (t.once = !0))),
                    s[c] || (s[c] = []),
                    s[c].push(g),
                    o || this._notify(l);
                  ...
                  for (
                      ...
                      o &&
                        ...
                        h.some(function (x) {
                          var S = e.stamp(x),
                            ...
                            L;
                          if (D)
                            for (o--, M = 0, L = D.length; M < L; ++M)
                              D[M].handle.sub.filter && c.push(D[M]);
                          return !o;
                        }),
                        (o = O));
                    o && (t = h.shift());
                    ...
                    if (((b = e.stamp(t)), (p = E[b]), p)) {
                      for (
                        ...
                        (l.currentTarget = t),
                        I.filter &&
                          ((N = I.filter.apply(t, [t, l].concat(I.args || []))),
                          c.splice(v(c, f), 1)),
                        N && ((l.container = f.container), (U = f.fire(l))),
                        !(U === !1 || l.stopped === 2));
                        ++y
                      );
                      delete p[b], o--;
                    ...
                    if (l.stopped !== 2)
                      for (
                        ...
                        ((f = c[y]),
                        (I = f.handle.sub),
                        I.filter.apply(t, [t, l].concat(I.args || [])) &&
          ...
          u
            ? (n("focus", "beforeactivate", "focusin"),
              n("blur", "beforedeactivate", "focusout"))
            : (n("focus", "focus", "focus"), n("blur", "blur", "blur"));
        },
        "3.17.2",
    ...
    105495: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          (_.delegate = _.on),
            (_.detachDelegate = _.detach),
            e.Event.define("hover", _);
        },
        "3.17.2",
    ...
    541903: function () {
      YUI.add(
        ...
        function (e, q) {
            ...
            n = {
              ...
              processArgs: function (d) {
                var r = d.splice(3, 1)[0],
                  a = e.Array.hash(
                    r.match(/\+(?:alt|ctrl|meta|shift)\b/g) || []
                  ),
                  i = {
                    ...
                    (g = u(l[h])),
                      !!g &&
                        (+g == g
                          ...
                          : ((E = g.toLowerCase()),
                            this.KEY_MAP[E]
                              ? ((i.keys[this.KEY_MAP[E]] = a),
                                i.type || (i.type = "down"))
                              : ((g = g.charAt(0)),
                                (A = g.toUpperCase()),
                                a["+shift"] && (g = A),
                                (i.keys[g.charCodeAt(0)] =
                                  g === A
                                    ? e.merge(a, { "+shift": !0 })
                                    : a))));
          ...
          (n.delegate = n.on),
            (n.detachDelegate = n.detach),
            e.Event.define("key", n, !0);
        },
        "3.17.2",
        { requires: ["event-synthetic"] }
      );
    ...
    125057: function () {
      YUI.add(
        ...
        function (e, q) {
          var T = e.Env.evt.dom_wrappers,
            ...
            u = {
              ...
              on: function (n, d, r) {
                ...
                d.handle = e.Event._attach(i, { facade: !1 });
              },
              detach: function (n, d) {
                d.handle.detach();
              },
              delegate: function (n, d, r, a) {
                ...
                (d.handle = e.Event._attach(l, { facade: !1 })),
                  (d.handle.sub.filter = a),
                  (d.handle.sub.relProperty = this.relProperty),
                  (d.handle.sub._notify = this._filterNotify);
              },
              _filterNotify: function (n, d, r) {
                ...
                if (a)
                  for (
                    a = _(a), g = 0, A = a.length && (!l || !l.stopped);
                    g < A &&
                    ((h = a[0]),
                    !(
                      !m(h, i) &&
                      (l ||
                        ((l = new e.DOMEventFacade(d[0], h, r)),
                        (l.container = e.one(r.el))),
                      (l.currentTarget = e.one(h)),
                      (E = d[1].fire(l)),
                      E === !1)
                    ));
                    ++g
          ...
          e.Event.define("mouseenter", u, !0),
            e.Event.define(
              "mouseleave",
              e.merge(u, { proxyType: "mouseout", relProperty: "toElement" }),
              !0
            );
        },
        "3.17.2",
        ...
        function (e, q) {
          var T = "DOMMouseScroll",
            m = function (_) {
              ...
              return (
                e.UA.gecko
                  ? ((v[0] = T), (u = e.config.win))
                  : (u = e.config.doc),
                v.length < 3 ? (v[2] = u) : v.splice(2, 0, u),
                v
              );
            };
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = e.Event._GESTURE_MAP,
            ...
            S = function (R) {
              var k = R.getDOMNode();
              return R.compareTo(e.config.doc) && k.documentElement
                ? k.documentElement
                : !1;
            },
            D = function (R, k, F) {
            ...
            M = function (R) {
              var k = S(R) || R.getDOMNode(),
                F = R.getData(C);
              y &&
                (F || ((F = 0), R.setData(I, k.style.msTouchAction)),
                (k.style.msTouchAction = e.Event._DEFAULT_TOUCH_ACTION),
                F++,
                R.setData(C, F));
            },
            L = function (R) {
          ...
          (e.Event._DEFAULT_TOUCH_ACTION = "none"),
            P(r, {
              ...
              processArgs: function (R, k) {
                var F = U(this, R, k);
                return (
                  c in F || (F[c] = this.MIN_TIME),
                  o in F || (F[o] = this.MIN_DISTANCE),
                  F
                );
              },
                ...
                R.touches
                  ...
                  V &&
                    ...
                    G === 0 || j === 0
                      ...
                      : ((K = [R.pageX, R.pageY]),
                        G > 0 &&
                          ((H._ht = e.later(G, this, this._start, [
                            R,
                            k,
                            X,
                            H,
                        ...
                        j > 0 &&
                          (H._hm = z.on(
                            m[v],
                            e.bind(function (re) {
                              (Math.abs(re.pageX - K[0]) > j ||
                                Math.abs(re.pageY - K[1]) > j) &&
                                this._start(R, k, X, H);
                            }, this)
                          ))));
              },
              _cancel: function (R) {
                R._ht && (R._ht.cancel(), (R._ht = null)),
                  R._hme && (R._hme.detach(), (R._hme = null)),
                  R._hm && (R._hm.detach(), (R._hm = null));
              },
            ...
            P(n, {
              ...
              _onMove: function (R, k, F, X, B) {
                ...
                H &&
                  (R.touches &&
                    (R.touches.length === 1 ? D(R, R.touches[0]) : (H = !1)),
                  H && (w(R, V), (R.type = n), X.fire(R)));
              },
              PREVENT_DEFAULT: !1,
            }),
            P(d, {
              ...
              _onEnd: function (R, k, F, X, B) {
                ...
                H &&
                  (R.changedTouches &&
                    (R.changedTouches.length === 1
                      ? D(R, R.changedTouches[0])
                      : (H = !1)),
                  H &&
                    (w(R, V),
                    (R.type = d),
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          (e.Event.defineOutside = function (m, _) {
            ...
            var v = {
              on: function (u, n, d) {
                n.handle = e.one("doc").on(
                  m,
                  function (r) {
                    this.isOutside(u, r.target) &&
                      ((r.currentTarget = u), d.fire(r));
                  },
                  this
                );
              },
              ...
              e.UA.gecko && e.UA.gecko < 1.91
                ...
                : function (T, m, _) {
                    ...
                    m._handle = e.Event.attach("resize", function (u) {
                      m._timer && m._timer.cancel(),
                        (m._timer = e.later(v, e, function () {
                          _.fire(u);
                        }));
                    });
                  },
        ...
        function (e, q) {
          (function () {
            var T = e.Lang,
              ...
              A = { touchstart: 1, touchmove: 1, touchend: 1, touchcancel: 1 },
              E = { gesturestart: 1, gesturechange: 1, gestureend: 1 };
            e.mix(g, r), e.mix(g, i), e.mix(g, A);
            function h(p, f, b, N, O, y, C, I, U, x, S) {
              if ((p || e.error("simulateKeyEvent(): Invalid target."), v(f)))
              ...
              if (_(e.config.doc.createEvent)) {
                try {
                  (D = e.config.doc.createEvent("KeyEvents")),
                    D.initKeyEvent(f, b, N, O, y, C, I, U, x, S);
                } catch (M) {
                  try {
                ...
                n(e.config.doc.createEventObject)
                  ? ((D = e.config.doc.createEventObject()),
                    (D.bubbles = b),
                    (D.cancelable = N),
                    (D.view = O),
                    (D.ctrlKey = y),
            ...
            function s(p, f, b, N, O, y, C, I, U, x, S, D, M, L, w, P) {
              p || e.error("simulateMouseEvent(): Invalid target."),
                v(f)
                  ? !r[f.toLowerCase()] &&
                    !a[f] &&
                    e.error(
                      "simulateMouseEvent(): Event type '" +
                        f +
                        "' not supported."
                    )
                  : e.error(
              ...
              var R = null;
              if (_(e.config.doc.createEvent))
                (R = e.config.doc.createEvent("MouseEvents")),
                  R.initMouseEvent
                    ? R.initMouseEvent(
                        f,
                        b,
                    ...
                    : ((R = e.config.doc.createEvent("UIEvents")),
                      R.initEvent(f, b, N),
                      (R.view = O),
                      (R.detail = y),
                      (R.screenX = C),
                  ...
                  P &&
                    ...
                    (f === "mouseout"
                      ? (R.toElement = P)
                      : f === "mouseover" && (R.fromElement = P)),
                  p.dispatchEvent(R);
              else if (n(e.config.doc.createEventObject)) {
                switch (
                  ((R = e.config.doc.createEventObject()),
                  (R.bubbles = b),
                  (R.cancelable = N),
                  (R.view = O),
                  (R.detail = y),
            ...
            function c(p, f, b, N, O, y) {
              p || e.error("simulateUIEvent(): Invalid target."),
                v(f)
                  ? ((f = f.toLowerCase()),
                    l[f] ||
                      e.error(
                  ...
                  : e.error("simulateUIEvent(): Event type must be a string.");
              var C = null;
              u(b) || (b = f in g),
                u(N) || (N = f === "submit"),
                n(O) || (O = e.config.win),
                d(y) || (y = 1),
                _(e.config.doc.createEvent)
                  ? ((C = e.config.doc.createEvent("UIEvents")),
                    C.initUIEvent(f, b, N, O, y),
                    p.dispatchEvent(C))
                  : n(e.config.doc.createEventObject)
                  ? ((C = e.config.doc.createEventObject()),
                    (C.bubbles = b),
                    (C.cancelable = N),
                    (C.view = O),
                    (C.detail = y),
            ...
            function o(p, f, b, N, O, y, C, I, U, x, S, D, M, L, w, P) {
              ...
              (!e.UA.ios || e.UA.ios < 2) &&
                ...
                p || e.error("simulateGestureEvent(): Invalid target."),
                e.Lang.isString(f)
                  ? ((f = f.toLowerCase()),
                    E[f] ||
                      e.error(
                ...
                e.Lang.isBoolean(b) || (b = !0),
                e.Lang.isBoolean(N) || (N = !0),
                e.Lang.isObject(O) || (O = e.config.win),
                e.Lang.isNumber(y) || (y = 2),
                e.Lang.isNumber(C) || (C = 0),
                e.Lang.isNumber(I) || (I = 0),
                e.Lang.isNumber(U) || (U = 0),
                e.Lang.isNumber(x) || (x = 0),
                e.Lang.isBoolean(S) || (S = !1),
                e.Lang.isBoolean(D) || (D = !1),
                e.Lang.isBoolean(M) || (M = !1),
                e.Lang.isBoolean(L) || (L = !1),
                e.Lang.isNumber(w) || (w = 1),
                e.Lang.isNumber(P) || (P = 0),
                (R = e.config.doc.createEvent("GestureEvent")),
                R.initGestureEvent(
                  f,
                  b,
                  N,
            ...
            function t(
              ...
              var X;
              p || e.error("simulateTouchEvent(): Invalid target."),
                e.Lang.isString(f)
                  ? ((f = f.toLowerCase()),
                    A[f] ||
                      e.error(
                ...
                f === "touchstart" || f === "touchmove"
                  ? w.length === 0 &&
                    e.error("simulateTouchEvent(): No touch object in touches")
                  : f === "touchend" &&
                    R.length === 0 &&
                    e.error(
                      "simulateTouchEvent(): No touch object in changedTouches"
                    ),
                e.Lang.isBoolean(b) || (b = !0),
                e.Lang.isBoolean(N) || (N = f !== "touchcancel"),
                e.Lang.isObject(O) || (O = e.config.win),
                e.Lang.isNumber(y) || (y = 1),
                e.Lang.isNumber(C) || (C = 0),
                e.Lang.isNumber(I) || (I = 0),
                e.Lang.isNumber(U) || (U = 0),
                e.Lang.isNumber(x) || (x = 0),
                ...
                e.Lang.isBoolean(M) || (M = !1),
                e.Lang.isBoolean(L) || (L = !1),
                e.Lang.isNumber(k) || (k = 1),
                e.Lang.isNumber(F) || (F = 0),
                e.Lang.isFunction(e.config.doc.createEvent)
                  ? (e.UA.android
                      ? e.UA.android < 4
                        ? ((X = e.config.doc.createEvent("MouseEvents")),
                          X.initMouseEvent(
                            f,
                            b,
                            N,
                          ...
                          (X.targetTouches = P),
                          (X.changedTouches = R))
                        : ((X = e.config.doc.createEvent("TouchEvent")),
                          X.initTouchEvent(
                            w,
                            P,
                            R,
            ...
            e.Event.simulate = function (p, f, b) {
              (b = b || {}),
                r[f] || a[f]
                  ...
                  : l[f]
                  ? c(p, f, b.bubbles, b.cancelable, b.view, b.detail)
                  : A[f]
                  ? e.config.win &&
                    "ontouchstart" in e.config.win &&
                    !e.UA.phantomjs &&
                    !(e.UA.chrome && e.UA.chrome < 6)
                    ? t(
                        p,
                        f,
                        b.bubbles,
                  ...
                  : e.error(
                      "simulate(): Event '" + f + "' can't be simulated."
                    );
            };
          })();
        },
        ...
        function (e, q) {
            ...
            return (
              this.emitFacade
                ? ((!A || !A.preventDefault) &&
                  ...
                  (p.type = s.type),
                  (p.details = E.slice()),
                  t && (p.container = s.host))
                : t && u(A) && A.currentTarget && E.shift(),
              (c.context = o || p.currentTarget || s.host),
              (f = s.fire.apply(s, E)),
              A.prevented && s.preventedFn && s.preventedFn.apply(s, E),
              A.stopped && s.stoppedFn && s.stoppedFn.apply(s, E),
              (c.context = o),
              f
            );
          };
          ...
          l.prototype = {
            ...
            unregister: function (A) {
              ...
              E.length ||
                (delete h[this.key], e.Object.size(h) || delete m[this.domkey]);
            },
            detachAll: function () {
              for (var A = this.handles, E = A.length; --E >= 0; )
                A[E].detach();
            },
          };
          function g() {
          ...
          e.mix(
            g,
            {
              ...
              _deleteSub: function (A) {
                if (A && A.fn) {
                  ...
                  (this._subscribers = []),
                    T.keepDeprecatedSubs && (this.subscribers = {}),
                    E[h](A.node, A, this.notifier, A.filter),
              ...
              prototype: {
                ...
                _on: function (A, E) {
                  var h = [],
                    ...
                    f;
                  return (
                    (p = n(o) ? r(o) : _(o || e.one(e.config.win))),
                    !p.length && n(o)
                      ? ((f = e.on(
                          "available",
                          function () {
                          ...
                          function (b) {
                            ...
                            (b = e.one(b)),
                              b &&
                                ...
                                (!this.preventDups ||
                                  !this.getSubs(b, A, null, !0)) &&
                                  h.push(this._subscribe(b, t, N, c, O)));
                          },
                          this
                        ),
                        h.length === 1 ? h[0] : new e.EventHandle(h))
                  );
                },
            ...
            (e.SyntheticEvent = g),
            (e.Event.define = function (A, E, h) {
              var s, c, o;
              return (
                A && A.type
                  ? ((s = A), (h = E))
                  : E && (s = e.merge({ type: A }, E)),
                s
                  ? (h || !e.Node.DOM_EVENTS[s.type]) &&
                    ((c = function () {
                    ...
                    (o = new c()),
                    (A = o.type),
                    (e.Node.DOM_EVENTS[A] = e.Env.evt.plugins[A] =
                      {
                        eventDef: o,
                        on: function () {
    ...
    931619: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          function d(r, a) {
            (a = a || e.Object.values(n)),
              e.Array.each(a, function (i) {
                var l = r[i];
                l && (l.detach(), (r[i] = null));
              });
          }
          e.Event.define(v, {
            ...
            _start: function (r, a, i, l, g) {
              var A = { canceled: !1, eventType: r.type },
                E = i.preventMouse || !1;
              (r.button && r.button === 3) ||
                (r.touches && r.touches.length !== 1) ||
                ((A.node = g ? r.currentTarget : a),
                r.touches
                  ? (A.startXY = [r.touches[0].pageX, r.touches[0].pageY])
                  : (A.startXY = [r.pageX, r.pageY]),
                r.touches
                  ? ((i[n.END] = a.once(
                      "touchend",
                      this._end,
                  ...
                  ? (i.preventMouse = !1)
                  : u.test(A.eventType) &&
                    ((i[n.END] = a.once(m.end, this._end, this, a, i, l, g, A)),
                    (i[n.CANCEL] = a.once(
                      m.cancel,
                      this.detach,
                      this,
            ...
            _end: function (r, a, i, l, g, A) {
              var E = A.startXY,
                ...
                c = 15;
              i._extra &&
                i._extra.sensitivity >= 0 &&
                (c = i._extra.sensitivity),
                r.changedTouches
                  ? ((h = [
                      r.changedTouches[0].pageX,
                      r.changedTouches[0].pageY,
                    ]),
                    (s = [
                      r.changedTouches[0].clientX,
                      r.changedTouches[0].clientY,
                    ]))
                  : ((h = [r.pageX, r.pageY]), (s = [r.clientX, r.clientY])),
                Math.abs(h[0] - E[0]) <= c &&
                  Math.abs(h[1] - E[1]) <= c &&
                  ((r.type = v),
                  (r.pageX = h[0]),
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          (e.DOMEventFacade.prototype._touch = function (n, d, r) {
            ...
            if (n.touches)
              for (
                this.touches = [], A = {}, a = 0, i = n.touches.length;
                a < i;
                ++a
              )
                (g = n.touches[a]),
                  (A[e.stamp(g)] = this.touches[a] =
                    new e.DOMEventFacade(g, d, r));
            if (n.targetTouches)
              for (
                this.targetTouches = [], a = 0, i = n.targetTouches.length;
                a < i;
                ++a
              )
                (g = n.targetTouches[a]),
                  (l = A && A[e.stamp(g, !0)]),
                  (this.targetTouches[a] = l || new e.DOMEventFacade(g, d, r));
            if (n.changedTouches)
              for (
                this.changedTouches = [], a = 0, i = n.changedTouches.length;
                a < i;
                ++a
              )
                (g = n.changedTouches[a]),
                  (l = A && A[e.stamp(g, !0)]),
                  (this.changedTouches[a] = l || new e.DOMEventFacade(g, d, r));
            T in n && (this[T] = n[T]),
              m in n && (this[m] = n[m]),
              _ in n && (this[_] = n[_]);
          }),
            ...
            v && v.PointerEvent
              ? ((u.start = "pointerdown"),
                (u.end = "pointerup"),
                (u.move = "pointermove"),
                (u.cancel = "pointercancel"))
              : v && "ontouchstart" in v && !(e.UA.chrome && e.UA.chrome < 6)
              ? ((u.start = "touchstart"),
                (u.end = "touchend"),
                (u.move = "touchmove"),
                (u.cancel = "touchcancel"))
              : v && "msPointerEnabled" in v.navigator
              ? ((u.start = "MSPointerDown"),
                (u.end = "MSPointerUp"),
                (u.move = "MSPointerMove"),
                (u.cancel = "MSPointerCancel"))
              : ((u.start = "mousedown"),
                (u.end = "mouseup"),
                (u.move = "mousemove"),
                (u.cancel = "mousecancel")),
            (e.Event._GESTURE_MAP = u);
        },
        "3.17.2",
        { requires: ["node-base"] }
      );
          ...
          var T = "_valuechange",
            ...
            u = {
                ...
                (A = i.prevVal),
                  ...
                  E !== A &&
                    ...
                    e.Object.some(i.notifiers, function (o) {
                      ...
                      if (
                        ((l !== 1 || t.el === c) && o.fire(g),
                        (p = t && t._facade ? t._facade.stopped : 0),
                        p > l && ((l = p), l === 1 && (c = t.el)),
                        l === 2)
                      )
                        return !0;
              ...
              _startPolling: function (n, d, r) {
                var a, i;
                if (
                  !(!n.test("input,textarea,select") && !(i = u._isEditable(n)))
                ) {
                  if (
                    ((a = n.getData(T)),
                    a ||
              ...
              _stopPolling: function (n, d) {
                if (!!n._node) {
                  ...
                  clearInterval(r.interval),
                    ...
                    u._stopTimeout(n),
                    d
                      ? r.notifiers && delete r.notifiers[e.stamp(d)]
                      : (r.notifiers = {});
                }
              },
              ...
              _onFocus: function (n, d) {
                ...
                a ||
                  ...
                  r.setData(T, a)),
                  (a.prevVal = a.isEditable
                    ? r.getDOMNode().innerHTML
                    : r.get(m)),
                  u._startPolling(r, d, { e: n });
              },
              _onKeyDown: function (n, d) {
                u._startPolling(n.currentTarget, d, { e: n });
              },
              _onKeyUp: function (n, d) {
                (n.charCode === 229 || n.charCode === 197) &&
                  u._startPolling(n.currentTarget, d, { e: n, force: !0 });
              },
              ...
              _onSubscribe: function (n, d, r, a) {
                ...
                if (
                  ...
                  (i.delegated = !0),
                    (i.getNodes = function () {
                      return (
                        (A = n.all("input,textarea,select").filter(a)),
                        (E = n
                          .all('[contenteditable="true"],[contenteditable=""]')
                          .filter(a)),
                        A.concat(E)
                      );
                    }),
                  ...
                  if (
                    ((g = u._isEditable(n)),
                    !n.test("input,textarea,select") && !g)
                  )
                    return;
                  n.getData(T) ||
                    n.setData(T, {
              ...
              _onUnsubscribe: function (n, d, r) {
                ...
                r._handles && r._handles.detach(),
                  a.delegated
                    ? a.getNodes().each(function (i) {
                        u._stopPolling(i, r);
                      })
                    : u._stopPolling(n, r);
              },
      ...
      YUI.add(
        ...
        function (e, q) {
          var q = "gesture-simulate",
            ...
            _ = { touchstart: 1, touchmove: 1, touchend: 1, touchcancel: 1 },
            v = e.config.doc,
            u,
            n = 20,
            d,
            ...
            b = "y";
          function N(O) {
            O || e.error(q + ": invalid target node"),
              (this.node = O),
              (this.target = e.Node.getDOMNode(O));
          ...
          (N.prototype = {
            ...
            _getDims: function () {
              ...
              return (
                this.target.getBoundingClientRect
                  ? ((O = this.target.getBoundingClientRect()),
                    "height" in O
                      ? (C = O.height)
                      : (C = Math.abs(O.bottom - O.top)),
                    "width" in O
                      ? (y = O.width)
                      : (y = Math.abs(O.right - O.left)))
                  : ((O = this.node.get("region")),
                    (y = O.width),
                    (C = O.height)),
                [y, C]
              );
            ...
            _calculateDefaultPoint: function (O) {
              var y;
              return (
                !e.Lang.isArray(O) || O.length === 0
                  ? (O = [d, r])
                  : (O.length == 1 && ((y = this._getDims[1]), (O[1] = y / 2)),
                    (O[0] = this.node.getX() + O[0]),
                    (O[1] = this.node.getY() + O[1])),
                O
              );
            },
            rotate: function (O, y, C, I, U, x, S) {
              var D,
                M = C,
                L = I;
              (!e.Lang.isNumber(M) || !e.Lang.isNumber(L) || M < 0 || L < 0) &&
                ((D =
                ...
                (M = D),
                (L = D)),
                e.Lang.isNumber(S) || e.error(q + "Invalid rotation detected."),
                this.pinch(O, y, M, L, U, x, S);
            },
            pinch: function (O, y, C, I, U, x, S) {
              ...
              if (
                ...
                (!e.Lang.isNumber(R) ||
                  ...
                  R < 0 ||
                  k < 0) &&
                  e.error(q + "Invalid startRadius and endRadius detected."),
                (!e.Lang.isNumber(U) || U <= 0) && (U = a.DURATION_PINCH),
                !e.Lang.isNumber(x))
              )
                x = 0;
              else for (x = x % 360; x < 0; ) x += 360;
              for (
                e.Lang.isNumber(S) || (S = 0),
                  e.AsyncQueue.defaults.timeout = L,
                  D = new e.AsyncQueue(),
                  X = y[0],
                  B = y[1],
                  j = x,
                  W = x + S,
                  z.start = [
                    X + R * Math.sin(this._toRadian(j)),
                    B - R * Math.cos(this._toRadian(j)),
                  ],
                  z.end = [
                    X + k * Math.sin(this._toRadian(W)),
                    B - k * Math.cos(this._toRadian(W)),
                  ],
                  K.start = [
                    X - R * Math.sin(this._toRadian(j)),
                    B + R * Math.cos(this._toRadian(j)),
                  ...
                  D.add({
                    fn: function () {
                      ...
                      ($ = {
                        ...
                        (Q = this._createTouchList([
                          e.merge({ identifier: P++ }, $),
                          e.merge({ identifier: P++ }, J),
                        ])),
                        (Z = {
                  ...
                  se = function ($) {
                    var J = R + F * $,
                      ...
                      le,
                      fe;
                    (ae = { pageX: Z, pageY: Q, clientX: Z, clientY: Q }),
                      (oe = { pageX: ee, pageY: ie, clientX: ee, clientY: ie }),
                      (fe = this._createTouchList([
                        e.merge({ identifier: P++ }, ae),
                        e.merge({ identifier: P++ }, oe),
                      ])),
                      (le = { pageX: ne, pageY: ue, clientX: ne, clientY: ue }),
                      this._simulateEvent(
                        this.target,
                        l,
                        e.merge(
                ...
                D.add({ fn: se, args: [M], context: this });
              D.add({
                fn: function () {
                  ...
                  (J = {
                    ...
                    (ee = this._createTouchList([
                      e.merge({ identifier: P++ }, J),
                      e.merge({ identifier: P++ }, Z),
                    ])),
                    (Q = {
            ...
            tap: function (O, y, C, I, U) {
              ...
              for (
                y = this._calculateDefaultPoint(y),
                  (!e.Lang.isNumber(C) || C < 1) && (C = 1),
                  e.Lang.isNumber(I) || (I = a.HOLD_TAP),
                  e.Lang.isNumber(U) || (U = a.DELAY_TAP),
                  M = {
                    pageX: y[0],
                    pageY: y[1],
                    clientX: y[0],
                  ...
                  D = this._createTouchList([e.merge({ identifier: 0 }, M)]),
                  w = function () {
                    this._simulateEvent(
                      this.target,
                      i,
                      e.merge(
                        { touches: D, targetTouches: D, changedTouches: D },
                        M
                      )
                    );
                  },
                  P = function () {
                    this._simulateEvent(
                      ...
                      g,
                      e.merge(
                        { touches: S, targetTouches: S, changedTouches: D },
                        M
                      )
                    );
                  },
                ...
                x.add({ fn: w, context: this, timeout: L === 0 ? 0 : U }),
                  x.add({ fn: P, context: this, timeout: I });
              C > 1 &&
                !T &&
                x.add({
                  fn: function () {
              ...
              (y = this._calculateDefaultPoint(y)),
                e.Lang.isString(C)
                  ? ((C = C.toLowerCase()),
                    C !== f &&
                      C !== b &&
                      e.error(q + "(flick): Only x or y axis allowed"))
                  : (C = f),
                e.Lang.isNumber(I) || (I = a.DISTANCE_FLICK),
                e.Lang.isNumber(U)
                  ? U > a.MAX_DURATION_FLICK && (U = a.MAX_DURATION_FLICK)
                  : (U = a.DURATION_FLICK),
                Math.abs(I) / U < a.MIN_VELOCITY_FLICK &&
                  (U = Math.abs(I) / a.MIN_VELOCITY_FLICK),
                (x = {
                  start: e.clone(y),
            ...
            move: function (O, y, C) {
              var I;
              e.Lang.isObject(y)
                ? (e.Lang.isArray(y.point)
                    ? (y.point = this._calculateDefaultPoint(y.point))
                    : (y.point = this._calculateDefaultPoint([])),
                  e.Lang.isNumber(y.xdist) || (y.xdist = a.DISTANCE_MOVE),
                  e.Lang.isNumber(y.ydist) || (y.ydist = 0))
                : (y = {
                ...
                e.Lang.isNumber(C)
                  ? C > a.MAX_DURATION_MOVE && (C = a.MAX_DURATION_MOVE)
                  : (C = a.DURATION_MOVE),
                (I = {
            ...
            _move: function (O, y, C) {
              ...
              for (
                e.Lang.isNumber(C)
                  ...
                  : (C = a.DURATION_MOVE),
                  e.Lang.isObject(y)
                    ? (e.Lang.isArray(y.start) || (y.start = [d, r]),
                      e.Lang.isArray(y.end) ||
                        (y.end = [d + a.DISTANCE_MOVE, r]))
                    : (y = { start: [d, r], end: [d + a.DISTANCE_MOVE, r] }),
                  e.AsyncQueue.defaults.timeout = x,
                  I = new e.AsyncQueue(),
                  I.add({
                    fn: function () {
                      var P = {
                        ...
                        R = this._createTouchList([
                          e.merge({ identifier: L++ }, P),
                        ]);
                      this._simulateEvent(
                        this.target,
                        i,
                        e.merge(
                          { touches: R, targetTouches: R, changedTouches: R },
                          P
                        )
                      );
                    },
                  ...
                  S = Math.floor(C / x),
                  D = (y.end[0] - y.start[0]) / S,
                  M = (y.end[1] - y.start[1]) / S,
                  w = function (P) {
                    var R = y.start[0] + D * P,
                      k = y.start[1] + M * P,
                      F = { pageX: R, pageY: k, clientX: R, clientY: k },
                      X = this._createTouchList([
                        e.merge({ identifier: L++ }, F),
                      ]);
                    this._simulateEvent(
                      this.target,
                      l,
                      e.merge(
                        { touches: X, targetTouches: X, changedTouches: X },
                        F
                      )
                    );
                  },
                ...
                I.add({ fn: w, args: [U], context: this });
              I.add({
                fn: function () {
                  var P = {
                      pageX: y.end[0],
                    ...
                    R = this._createTouchList([e.merge({ identifier: L }, P)]);
                  this._simulateEvent(
                    this.target,
                    l,
                    e.merge(
                ...
                I.add({
                  fn: function () {
                    ...
                    this._simulateEvent(
                      ...
                      g,
                      e.merge(
                        { touches: R, targetTouches: R, changedTouches: k },
                        P
                      )
                    );
                  },
            ...
            _createTouchList: function (O) {
              ...
              return (
                !!O && e.Lang.isArray(O)
                  ? (e.UA.android && e.UA.android >= 4) ||
                    (e.UA.ios && e.UA.ios >= 2)
                    ? (e.each(O, function (U) {
                        U.identifier || (U.identifier = 0),
                          U.pageX || (U.pageX = 0),
                          U.pageY || (U.pageY = 0),
                          U.screenX || (U.screenX = 0),
                          U.screenY || (U.screenY = 0),
                          y.push(
                            v.createTouch(
                              e.config.win,
                              I.target,
                      ...
                      (C = v.createTouchList.apply(v, y)))
                    : e.UA.ios && e.UA.ios < 2
                    ? e.error(
                        q + ": No touch event simulation framework present."
                      )
                    : ((C = []),
                      e.each(O, function (U) {
                        U.identifier || (U.identifier = 0),
                          U.clientX || (U.clientX = 0),
                          U.clientY || (U.clientY = 0),
                          U.pageX || (U.pageX = 0),
                          U.pageY || (U.pageY = 0),
                          U.screenX || (U.screenX = 0),
                          U.screenY || (U.screenY = 0),
                  ...
                  : e.error(q + ": Invalid touchPoints passed"),
                C
              );
            },
            _simulateEvent: function (O, y, C) {
              ...
              _[y]
                ? T
                  ? e.Event.simulate(O, y, C)
                  : this._isSingleTouch(
                      C.touches,
                      C.targetTouches,
                      C.changedTouches
                    )
                  ? ((y = { touchstart: o, touchmove: c, touchend: s }[y]),
                    (C.button = 0),
                    (C.relatedTarget = null),
                    (I = y === s ? C.changedTouches : C.touches),
                    (C = e.mix(
                      C,
                      {
            ...
            _isSingleTouch: function (O, y, C) {
              return (
                O && O.length <= 1 && y && y.length <= 1 && C && C.length <= 1
              );
            },
          }),
            (e.GestureSimulation = N),
            (e.GestureSimulation.defaults = a),
            (e.GestureSimulation.GESTURES = m),
            (e.Event.simulateGesture = function (O, y, C, I) {
              O = e.one(O);
              var U = new e.GestureSimulation(O);
              if (
                ((y = y.toLowerCase()),
                !I && e.Lang.isFunction(C) && ((I = C), (C = {})),
                (C = C || {}),
                m[y])
              )
                switch (y) {
                  ...
                  case "doubletap":
                    ...
                    break;
                  case "press":
                    e.Lang.isNumber(C.hold)
                      ? C.hold < a.MIN_HOLD_PRESS
                        ? (C.hold = a.MIN_HOLD_PRESS)
                        : C.hold > a.MAX_HOLD_PRESS &&
                          (C.hold = a.MAX_HOLD_PRESS)
                      : (C.hold = a.HOLD_PRESS),
                      U.tap(I, C.point, 1, C.hold);
                    break;
                  case "move":
        ...
        function (e, q) {
          ...
          (g.NAME = "historyBase"),
            ...
            (g.html5 = !!(
              ...
              ("onpopstate" in d || e.UA.gecko >= 2) &&
              (!e.UA.android || e.UA.android >= 2.4)
            )),
            (g.nativeHashChange =
              ("onhashchange" in d || "onhashchange" in u) && (!n || n > 7)),
            e.mix(
              g.prototype,
              {
                _init: function (E) {
                  ...
                  (E = this._config = E || {}),
                    (this.force = !!E.force),
                    (h = this._initialState =
                      this._initialState || E.initialState || null),
                    this.publish(a, {
                      broadcast: 2,
                ...
                _change: function (E, h, s) {
                  return (
                    ...
                    s.merge &&
                      A(h) &&
                      A(_._state) &&
                      (h = e.merge(_._state, h)),
                    this._resolveChanges(E, h, s),
                    this
                  );
                },
                ...
                _fireRemoveEvent: function (E, h, s) {
                  this.fire(h + "Remove", { prevVal: s, src: E });
                },
                _resolveChanges: function (E, h, s) {
                  ...
                  h || (h = {}),
                    ...
                    (o || this.force) &&
                      this._fireEvents(
                        E,
                        { changed: c, newState: h, prevState: t, removed: p },
                        s
                      );
                },
            ...
            (_.getIframeHash = function () {
              ...
              (_._updateIframe = function (n, d) {
                ...
                !r ||
                  !a ||
                  (d
                    ? a.replace(n.charAt(0) === "#" ? n : "#" + n)
                    : (r.open().close(), (a.hash = n)));
              }),
              T.before(_._updateIframe, _, "replaceHash", _, !0),
              v ||
                e.on("domready", function () {
                  ...
                  (v = m._iframe =
                    ...
                    e.config.doc.documentElement.appendChild(v),
                    _._updateIframe(n || "#"),
                    e.on(
                      "hashchange",
                      function (d) {
                        (n = d.newHash),
                          _.getIframeHash() !== n && _._updateIframe(n);
                      },
                      u
                    ),
                    e.later(
        ...
        (function (e) {
          ...
          e.add(
            ...
            function (T) {
              ...
              T.extend(
                ...
                m,
                {
                  _init: function (s) {
                    var c = E.parseHash();
                    (s = s || {}),
                      (this._initialState = s.initialState
                        ? T.merge(s.initialState, c)
                        : c),
                      T.after(
                        "hashchange",
                        T.bind(this._afterHashChange, this),
                        g
                      ),
                  ...
                  _storeState: function (s, c) {
                    var o = E.decode,
                      t = E.createHash(c);
                    E.superclass._storeState.apply(this, arguments),
                      s !== d &&
                        o(E.getHash()) !== o(t) &&
                        E[s === m.SRC_REPLACE ? "replaceHash" : "setHash"](t);
                  },
                ...
                },
                {
                  ...
                  parseHash: function (s) {
                    var c = E.decode,
                      ...
                      y;
                    for (
                      s = _.isValue(s) ? s : E.getHash(),
                        O &&
                          ((y = s.indexOf(O)),
                          (y === 0 || (y === 1 && s.charAt(0) === "#")) &&
                            (s = s.replace(O, ""))),
                        f = s.match(E._REGEX_HASH) || [],
                        o = 0,
                        t = f.length;
                      o < t;
                      ++o
                      ...
                      (p = f[o]),
                        (b = p.split("=")),
                        b.length > 1 ? (N[c(b[0])] = c(b[1])) : (N[c(p)] = "");
                    return N;
                  },
                  replaceHash: function (s) {
                    ...
                    s.charAt(0) === "#" && (s = s.substring(1)),
                      c.replace(o + "#" + (E.hashPrefix || "") + s);
                  },
                  setHash: function (s) {
                    var c = T.getLocation();
                    s.charAt(0) === "#" && (s = s.substring(1)),
                      (c.hash = (E.hashPrefix || "") + s);
                  },
                }
              );
              ...
              h ||
                ((h = T.guid()),
                (T.config.win._YUI_HISTORY_HASH_ENVIRONMENT_ID = h),
                q &&
                  console.log(
                    "Created the hash",
                    h,
                ...
                (a = r[h]),
                a || ((a = []), (r[h] = a)),
                T.Event.define("hashchange", {
                  on: function (s, c, o) {
                    (s.compareTo(g) || s.compareTo(T.config.doc.body)) &&
                      a.push(o);
                  },
                ...
                (l = E.getUrl()),
                m.nativeHashChange
                  ? (n._hashHandle || (n._hashHandle = {}),
                    n._hashHandle[h] ||
                      ((n._hashHandle[h] = T.Event.attach(
                        "hashchange",
                        function (s) {
                          var c = E.getHash(),
                            o = E.getUrl();
                      ...
                      q &&
                        console.log(
                          "Binded hashchange event listener for ",
                          h,
                          " on window",
                          T.config.win
                        ),
                      T.on("beforeunload", function () {
                        n._hashHandle[h].detach(),
                          (n._hashHandle[h] = null),
                          delete n._hashHandle[h],
                          q &&
                            console.log(
                              "DETACHED hashchange event listener for ",
                              h,
                              " on window",
                              T.config.win
                            );
                      })))
                  : (n._hashPoll || (n._hashPoll = {}),
                    n._hashPoll[h] ||
                      ((n._hashPoll[h] = T.later(
                        50,
                        null,
                        function () {
                          var s = E.getHash(),
                      ...
                      q &&
                        console.log(
                          "Binded hashchange poller for ",
                          h,
                          " on window",
                          T.config.win
                        ),
                      T.on("beforeunload", function () {
                        n._hashPoll[h].cancel(),
                          (n._hashPoll[h] = null),
                          delete n._hashPoll[h],
                          q &&
                            console.log(
                              "DETACHED hashchange poller for ",
                              h,
                              " on window",
                              T.config.win
                            );
                ...
                (T.HistoryHash = E),
                (A === !1 ||
                  (!T.History && A !== !0 && (!m.html5 || !T.HistoryHTML5))) &&
                  (T.History = E);
            },
            "3.17.2",
            {
          ...
          e.extend(
            ...
            T,
            {
              _init: function (r) {
                ...
                e.Object.isEmpty(a) && (a = null),
                  r || (r = {}),
                  r.initialState &&
                  m.type(r.initialState) === "object" &&
                  m.type(a) === "object"
                    ? (this._initialState = e.merge(r.initialState, a))
                    : (this._initialState = a),
                  e.on("popstate", this._onPopState, _, this),
                  d.superclass._init.apply(this, arguments);
              },
              _storeState: function (r, a, i) {
                r !== u &&
                  _.history[r === n ? "replaceState" : "pushState"](
                    a,
                    i.title || e.config.doc.title || "",
                    i.url || e.config.doc.URL
                  ),
            ...
            { NAME: "historyhtml5", SRC_POPSTATE: u }
          ),
            e.Node.DOM_EVENTS.popstate || (e.Node.DOM_EVENTS.popstate = 1),
            (e.HistoryHTML5 = d),
            (v === !0 || (v !== !1 && T.html5)) && (e.History = d);
        },
        "3.17.2",
        {
          optional: ["json"],
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          e.mix(e.namespace("Intl"), {
            ...
            e.Intl.publish("intl:langChange", { emitFacade: !0 });
        },
        "3.17.2",
        ...
        function (e, q) {
          ...
          (u.prototype = {
            ...
            _init: function (i) {
              ...
              for (
                l.cfg = i || {},
                  e.augment(l, e.EventTarget),
                  g = 0,
                  A = T.length;
                g < A;
                ++g
              )
                l.publish("io:" + T[g], e.merge({ broadcast: 1 }, i)),
                  l.publish("io-trn:" + T[g], i);
            },
            _create: function (i, l) {
              var g = this,
                A = { id: e.Lang.isNumber(l) ? l : g._id++, uid: g._uid },
                E = i.xdr ? i.xdr.use : null,
                h = i.form && i.form.upload ? "iframe" : null,
                s;
              return (
                E === "native" &&
                  ((E = e.UA.ie && !a ? "xdr" : null),
                  g.setHeader("X-Requested-With")),
                (s = E || h),
                (A = s
                  ? e.merge(e.IO.customTransport(s), A)
                  : e.merge(e.IO.defaultTransport(), A)),
                A.notify &&
                  (i.notify = function (c, o, t) {
                    g.notify(c, o, t);
                  }),
                s ||
                  (_ &&
                    _.FormData &&
                    i.data instanceof _.FormData &&
                    ((A.c.upload.onprogress = function (c) {
                      g.progress(A, c, i);
                    }),
            ...
            _destroy: function (i) {
              _ &&
                ...
                !i.xdr &&
                (n && !i.upload
                  ? (i.c.onreadystatechange = null)
                  : i.upload
                  ? ((i.c.upload.onprogress = null),
                    (i.c.onload = null),
                    (i.c.onerror = null))
                  : e.UA.ie && !i.e && i.c.abort()),
                (i = i.c = null);
            },
            _evt: function (i, l, g) {
              var A = this,
                ...
                o = "io-trn:" + i;
              this.detach(o),
                l.e && (l.c = { status: 0, statusText: l.e }),
                (E = [
                  s ? { id: l.id, data: l.c, cfg: g, arguments: h } : l.id,
                ]),
                s ||
                  (i === T[0] ||
                    i === T[2] ||
                    (l.evt ? E.push(l.evt) : E.push(l.c)),
                  h && E.push(h)),
                E.unshift(c),
                A.fire.apply(A, E),
                g.on &&
                  ((E[0] = o),
                  A.once(o, g.on[i], g.context || e),
                  A.fire.apply(A, E));
            },
            start: function (i, l) {
              this._evt(T[0], i, l);
            ...
            _retry: function (i, l, g) {
              return (
                this._destroy(i), (g.xdr.use = "flash"), this.send(l, g, i.id)
              );
            },
            ...
            _setHeaders: function (i, l) {
              (l = e.merge(this._headers, l)),
                e.Object.each(l, function (g, A) {
            ...
            _rS: function (i, l) {
              var g = this;
              i.c.readyState === 4 &&
                (l.timeout && g._clearTimeout(i.id),
                setTimeout(function () {
            ...
            send: function (i, l, g) {
              ...
              if (
                ((l = l ? e.Object(l) : {}),
                (A = t._create(l, g)),
                (E = l.method ? l.method.toUpperCase() : "GET"),
                (c = l.sync),
                (o = l.data),
                e.Lang.isObject(o) &&
                  !o.nodeType &&
                  !A.upload &&
                  e.QueryString &&
                  e.QueryString.stringify &&
                  (l.data = o = e.QueryString.stringify(o)),
                l.form)
              ) {
              ...
              try {
                if (
                  (A.c.open(E, p, !c, l.username || null, l.password || null),
                  t._setHeaders(A.c, l.headers || {}),
                  t.start(A, l),
                  l.xdr && l.xdr.credentials && a && (A.c.withCredentials = !0),
                  A.c.send(o),
                  c)
                ) {
              ...
              return (
                l.timeout && t._startTimeout(A, l.timeout),
                {
                  id: A.id,
                  abort: function () {
          ...
          e.mix(e.IO, {
            ...
            customTransport: function (i) {
              var l = { c: e.IO.transports[i]() };
              return (
                (l[i === "xdr" || i === "flash" ? "xdr" : "notify"] = !0), l
              );
            },
          }),
              ...
              notify: function (i, l, g) {
                ...
                switch (i) {
                  ...
                  case "transport error":
                    (l.c = { status: 0, statusText: i }), (i = "failure");
                  default:
                    A[i].apply(A, [l, g]);
                }
              },
        ...
        function (e, q) {
          ...
          (e.IO.stringify = function (m, _) {
            ...
            var v = e.IO.prototype._serialize(
              { id: m, useDisabled: _.useDisabled },
              _.extra && typeof _.extra == "object"
                ? e.QueryString.stringify(_.extra)
                : _.extra
            );
            return v;
          }),
              ...
              e.IO.prototype,
              {
                _serialize: function (m, _) {
                  var v = [],
                    ...
                    n = 0,
                    d =
                      typeof m.id == "string" ? m.id : m.id.getAttribute("id"),
                    r,
                    a,
                    i,
                    l,
                    ...
                    c;
                  if (
                    (d || ((d = e.guid("io:")), m.id.setAttribute("id", d)),
                    (a = e.config.doc.getElementById(d)),
                    !a || !a.elements)
                  )
                    return _ || "";
                  for (A = 0, E = a.elements.length; A < E; ++A)
                    if (
                      ...
                      switch (((i = T(i) + "="), (l = T(r.value)), r.type)) {
                        case "select-one":
                          r.selectedIndex > -1 &&
                            ((c = r.options[r.selectedIndex]),
                            (v[n++] =
                              i +
                              T(
                                c.attributes.value &&
                                  c.attributes.value.specified
                                  ? c.value
                                  : c.text
                              )));
                          break;
                        case "select-multiple":
                          if (r.selectedIndex > -1)
                            for (
                              h = r.selectedIndex, s = r.options.length;
                              h < s;
                              ++h
                            )
                              (c = r.options[h]),
          ...
          e.mix(
            e.IO.prototype,
            {
              ...
              _qShift: function () {
                ...
                (_._qActiveId = v.id),
                  (_._qState = 0),
                  _.send(v.uri, v.cfg, v.id);
              },
              queue: function (_, v) {
                var u = this,
                  n = { uri: _, cfg: v, id: this._id++ };
                return (
                  u._qInit ||
                    (e.on(
                      "io:complete",
              ...
              _qNext: function (_) {
                var v = this;
                (v._qState = 1),
                  v._qActiveId === _ && v._q.size() > 0 && v._qShift();
              },
              qPromote: function (_) {
                this._q.promote(_);
              },
    ...
    343140: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          function d(r) {
            e.Event.purgeElement("#io_iframe" + r, !1),
              e.one("body").removeChild(e.one("#io_iframe" + r));
          }
          e.mix(
            e.IO.prototype,
            {
              _addData: function (r, a) {
                ...
                var i = [],
                  ...
                  g,
                  A;
                for (g = 0, A = l.length - 1; g < A; g++)
                  (i[g] = m.createElement("input")),
                    (i[g].type = "hidden"),
                    (i[g].name = v(l[g].substring(l[g].lastIndexOf("&") + 1))),
                    (i[g].value =
                      g + 1 === A
                        ? v(l[g + 1])
                        : v(l[g + 1].substring(0, l[g + 1].lastIndexOf("&")))),
                    r.appendChild(i[g]);
                return i;
              },
              ...
              _setAttrs: function (r, a, i) {
                (this._originalFormAttrs = {
                  ...
                  r.setAttribute("target", "io_iframe" + a),
                  r.setAttribute(
                    e.UA.ie && !_ ? "encoding" : "enctype",
                    "multipart/form-data"
                  );
              },
              ...
              _uploadComplete: function (r, a) {
                ...
                try {
                  g
                    ? ((A = g.one("pre:first-child")),
                      (r.c.responseText = A ? A.get("text") : g.get("text")))
                    : (r.c.responseXML = l._node);
                } catch (E) {
                  r.e = "upload failure";
                }
                i.complete(r, a),
              ...
              _upload: function (r, a, i) {
                var l = this,
                  g =
                    typeof i.form.id == "string"
                      ? m.getElementById(i.form.id)
                      : i.form.id,
                  A;
                return (
                  l._setAttrs(g, r.id, a),
                  i.data && (A = l._addData(g, i.data)),
                  i.timeout && l._startUploadTimeout(r, i),
                  g.submit(),
                  l.start(r, i),
                  i.data && l._removeData(g, A),
                  {
                    id: r.id,
                    abort: function () {
                      if (
                        ((r.status = 0),
                        (r.statusText = "abort"),
                        e.one("#io_iframe" + r.id))
                      )
                        d(r.id), l.complete(r, i), l.end(r, i);
                      else return !1;
                    },
                    isInProgress: function () {
                ...
                return (
                  a &&
                    ...
                    i &&
                      ...
                      (i =
                        typeof i.id == "string"
                          ? m.getElementById(i.id)
                          : i.id),
                      i && l._resetAttrs(i, this._originalFormAttrs))),
                  u.call(this, r, a)
                );
              },
            },
    ...
    480149: function () {
      YUI.add(
        "io-xdr",
        function (e, q) {
          var T = e.publish("io:xdrReady", { fireOnce: !0 }),
            m = {},
            _ = {},
            v = e.config.doc,
            u = e.config.win,
          ...
          function r(l, g, A) {
            return (
              g === "flash" && (l.c.responseText = decodeURI(l.c.responseText)),
              A === "xml" &&
                (l.c.responseXML = e.DataType.XML.parse(l.c.responseText)),
              l
            );
          }
          function a(l, g) {
          ...
          e.mix(e.IO.prototype, {
            ...
            transport: function (l) {
              l.id === "flash" &&
                (d(
                  e.UA.ie
                    ? l.src + "?d=" + new Date().valueOf().toString()
                    : l.src,
                  e.id,
                  l.uid
                ),
                (e.IO.transports.flash = function () {
          ...
          (m.prototype = {
            _init: function (_, v) {
              (this.url = _),
                (this._requests = {}),
                (this._timeouts = {}),
                (v = T(v) ? { on: { success: v } } : v || {});
              var u = v.on || {};
              u.success || (u.success = this._defaultCallback(_, v)),
                (this._config = e.merge(
                  {
                    context: this,
                    args: [],
                    format: this._format,
            ...
            send: function () {
              var _ = this,
                ...
                d;
              if (
                (u.allowCache && (_._proxy = n),
                _._requests[n] === void 0 && (_._requests[n] = 0),
                _._timeouts[n] === void 0 && (_._timeouts[n] = 0),
                _._requests[n]++,
                v.unshift(_.url, "YUI.Env.JSONP." + n),
                (d = u.format.apply(_, v)),
                !u.on.success)
              )
                return _;
              function r(a, i) {
                return T(a)
                  ? function (l) {
                      var g = !0,
                        A = "_requests";
                      i
                        ? (++_._timeouts[n], --_._requests[n])
                        : (_._requests[n] || ((g = !1), (A = "_timeouts")),
                          --_[A][n]),
                        !_._requests[n] &&
                          !_._timeouts[n] &&
                          delete YUI.Env.JSONP[n],
                        g && a.apply(u.context, [l].concat(u.args));
                    }
                  : null;
              }
              return (
                (YUI.Env.JSONP[n] = r(u.on.success)),
                e.Get.js(d, {
    ...
    317375: function () {
      YUI.add(
        ...
        function (e, q) {
          ...
          e.Node.importMethod(e.DOM, T),
            e.NodeList.importMethod(e.Node.prototype, T);
          var m = e.Node,
            _ = e.DOM;
          (m.create = function (u, n) {
            ...
            e.mix(m.prototype, {
              ...
              _insert: function (u, n) {
                ...
                return (
                  typeof n == "number"
                    ? (n = this._node.childNodes[n])
                    : n && n._node && (n = n._node),
                  u && typeof u != "string" && (u = u._node || u._nodes || u),
                  (r = _.addHTML(d, u, n)),
                  r
                );
              },
              ...
              getContent: function () {
                ...
                return (
                  u._node.nodeType === 11 &&
                    (u = u.create("<div/>").append(u.cloneNode(!0))),
                  u.get("innerHTML")
                );
              },
            }),
            ...
            e.NodeList.importMethod(e.Node.prototype, [
              "append",
              "insert",
              "appendChild",
              "insertBefore",
          ...
          (m.ATTRS = {
            ...
            children: {
              getter: function () {
                ...
                if (!n)
                  for (
                    d = u.childNodes, n = [], r = 0, a = d.length;
                    r < a;
                    ++r
                  )
                    d[r].tagName && (n[n.length] = d[r]);
                return e.all(n);
              },
            },
            value: {
          ...
          (m.DOM_EVENTS = {
            ...
            e.mix(m.DOM_EVENTS, e.Env.evt.plugins),
            e.augment(m, e.EventTarget),
            e.mix(m.prototype, {
              purge: function (u, n) {
            ...
            e.mix(e.NodeList.prototype, {
              ...
              once: function (u, n, d) {
                return e.once.apply(
                  e,
                  this._prepEvtArgs.apply(this, arguments)
                );
              },
              after: function (u, n, d) {
                return e.after.apply(
                  e,
                  this._prepEvtArgs.apply(this, arguments)
                );
              },
              onceAfter: function (u, n, d) {
                return e.onceAfter.apply(
                  e,
                  this._prepEvtArgs.apply(this, arguments)
                );
              },
            }),
            v.importMethod(e.Node.prototype, ["detach", "detachAll"]),
            e.mix(e.Node.ATTRS, {
              offsetHeight: {
                setter: function (u) {
            ...
            e.mix(e.Node.prototype, {
              sizeTo: function (u, n) {
                ...
                arguments.length < 2 &&
                  ((d = e.one(u)),
                  (u = d.get("offsetWidth")),
                  (n = d.get("offsetHeight"))),
                  this.setAttrs({ offsetWidth: u, offsetHeight: n });
              },
            }),
            e.config.doc.documentElement.hasAttribute ||
              (e.Node.prototype.hasAttribute = function (u) {
                return u === "value" && this.get("value") !== ""
                  ? !0
                  : !!(
                      this._node.attributes[u] &&
                      this._node.attributes[u].specified
                    );
              }),
            ...
            e.config.doc.createElement("form").elements.nodeType &&
            ...
            e.mix(e.Node.prototype, {
              ...
              getData: function (u) {
                ...
                return (
                  arguments.length
                    ? u in n
                      ? (d = n[u])
                      : (d = this._getDataAttribute(u))
                    : typeof n == "object" &&
                      n !== null &&
                      ((d = {}),
                      e.Object.each(n, function (r, a) {
                        d[a] = r;
                      }),
                      (d = this._getDataAttributes(d))),
                  d
                );
              },
              _getDataAttributes: function (u) {
                ...
                for (
                  ...
                  (l = d[n].name),
                    l.indexOf(a) === 0 &&
                      ((l = l.substr(i)),
                      l in u || (u[l] = this._getDataAttribute(l))),
                    (n += 1);
                return u;
              },
              ...
              setData: function (u, n) {
                return (
                  this._initData(),
                  arguments.length > 1 ? (this._data[u] = n) : (this._data = u),
                  this
                );
              },
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = ".",
            ...
            a = e.DOM,
            i = function (s) {
              if (s && s.closest && s.closest("[data-yui-ignore-cache]"))
                return null;
              if (!this.getDOMNode) return new i(s);
              if (typeof s == "string" && ((s = i._fromString(s)), !s))
                return null;
              var c = s.nodeType !== 9 ? s.uniqueID : s[n];
              c &&
                i._instances[c] &&
                i._instances[c]._node !== s &&
                (s[n] = null),
                (c = c || e.stamp(s)),
                c || (c = e.guid()),
                (this[n] = c),
          ...
          (i.ATTRS = {}),
              ...
              return (
                s &&
                  (s.indexOf("doc") === 0
                    ...
                    : s.indexOf("win") === 0
                    ? (s = e.config.win)
                    : (s = e.Selector.query(s, null, !0))),
                s || null
              );
            }),
            (i.NAME = "node"),
            (i.re_aria = /^(?:role$|aria-)/),
            (i.SHOW_TRANSITION = "fadeIn"),
            (i.HIDE_TRANSITION = "fadeOut"),
            (i._instances = {}),
            (i.getDOMNode = function (s) {
                ...
                s
                  ? (typeof s == "object" || typeof s == "function") &&
                    (_ in s || a.isWindow(s)
                      ...
                      ? (s = e.one(
                          s.correspondingUseElement || s.correspondingElement
                        ))
                      : ((s.item && !s._nodes) || (s[0] && s[0][_])) &&
                        (s = e.all(s)))
                  : typeof s == "undefined"
                  ? (s = c)
                  : s === null && (s = null),
              ...
              s &&
                ...
                (i.prototype[s] = function () {
                  var t = r.call(arguments),
                    ...
                    f;
                  return (
                    t[0] && t[0]._node && (t[0] = t[0]._node),
                    t[1] && t[1]._node && (t[1] = t[1]._node),
                    t.unshift(p._node),
                    (f = c.apply(o || p, t)),
                    f && (f = i.scrubVal(f, p)),
                    typeof f != "undefined" || (f = p),
                    f
                  );
                });
            }),
            (i.importMethod = function (s, c, o) {
              typeof c == "string"
                ? ((o = o || c), i.addMethod(o, s[c], s))
                : e.Array.each(c, function (t) {
                    i.importMethod(s, t);
                  });
            }),
            (i.one = function (s) {
              ...
              if (s) {
                ...
                typeof SVGElementInstance != "undefined" &&
                  ...
                  (s.nodeType || e.DOM.isWindow(s)) &&
                    ((t =
                      s.uniqueID && s.nodeType !== 9 ? s.uniqueID : s._yuid),
                    (c = i._instances[t]),
                    (o = c ? c._node : null),
                    (!c || (o && s !== o)) &&
                      ((c = new i(s)),
                      s.nodeType != 11 && (i._instances[c[n]] = c)));
              }
              return c;
            }),
            (i.DEFAULT_SETTER = function (s, c) {
              ...
              return (
                s.indexOf(T) > -1
                  ? ((t = s), (s = s.split(T)), e.Object.setValue(o, s, c))
                  : typeof o[s] != "undefined" && (o[s] = c),
                c
              );
            }),
            (i.DEFAULT_GETTER = function (s) {
              var c = this._stateProxy,
                o;
              return (
                s.indexOf && s.indexOf(T) > -1
                  ? (o = e.Object.getValue(c, s.split(T)))
                  : typeof c[s] != "undefined" && (o = c[s]),
                o
              );
            }),
            e.mix(
              i.prototype,
              {
                ...
                toString: function () {
                  ...
                  return (
                    c &&
                      ((o = c.attributes),
                      (t = o && o.id ? c.getAttribute("id") : null),
                      (p =
                        o && o.className ? c.getAttribute("className") : null),
                      (s = c[m]),
                      t && (s += "#" + t),
                      p && (s += "." + p.replace(" ", ".")),
                      (s += " " + this[n])),
                ...
                get: function (s) {
                  var c;
                  return (
                    this._getAttr ? (c = this._getAttr(s)) : (c = this._get(s)),
                    c ? (c = i.scrubVal(c, this)) : c === null && (c = null),
                    c
                  );
                },
                _get: function (s) {
                  ...
                  return (
                    c && c.getter
                      ? (o = c.getter.call(this))
                      : i.re_aria.test(s)
                      ? (o = this._node.getAttribute(s, 2))
                      : (o = i.DEFAULT_GETTER.apply(this, arguments)),
                    o
                  );
                },
                set: function (s, c) {
                  ...
                  return (
                    this._setAttr
                      ...
                      : o && o.setter
                      ? o.setter.call(this, c, s)
                      : i.re_aria.test(s)
                      ? this._node.setAttribute(s, c)
                      : i.DEFAULT_SETTER.apply(this, arguments),
                    this
                  );
                },
                setAttrs: function (s) {
                ...
                inDoc: function (s) {
                  var c = this._node;
                  return c && ((s = s ? s._node || s : c[v]), s.documentElement)
                    ? a.contains(s.documentElement, c)
                    : !1;
                },
                getById: function (s) {
                  var c = this._node,
                ...
                ancestor: function (s, c, o) {
                  return (
                    arguments.length === 2 &&
                      (typeof c == "string" || typeof c == "function") &&
                      (o = c),
                    e.one(a.ancestor(this._node, l(s), c, l(o)))
                  );
                },
                ancestors: function (s, c, o) {
                  return (
                    arguments.length === 2 &&
                      (typeof c == "string" || typeof c == "function") &&
                      (o = c),
                    e.all(a.ancestors(this._node, l(s), c, l(o)))
                  );
                },
                previous: function (s, c) {
                  return e.one(
                    a.elementByAxis(this._node, "previousSibling", l(s), c)
                  );
                },
                next: function (s, c) {
                  return e.one(
                    a.elementByAxis(this._node, "nextSibling", l(s), c)
                  );
                },
                siblings: function (s) {
                ...
                all: function (s) {
                  ...
                  return (
                    this._node &&
                      ((c = e.all(e.Selector.query(s, this._node))),
                      (c._query = s),
                      (c._queryRoot = this._node)),
                    c || e.all([])
                  );
                },
                test: function (s) {
                ...
                replace: function (s) {
                  var c = this._node;
                  return (
                    typeof s == "string" && (s = i.create(s)),
                    c.parentNode.replaceChild(i.getDOMNode(s), c),
                    this
                  );
                },
                replaceChild: function (s, c) {
                  return (
                    typeof s == "string" && (s = a.create(s)),
                    e.one(
                      this._node.replaceChild(i.getDOMNode(s), i.getDOMNode(c))
                    )
                  );
                },
                destroy: function (s) {
                  ...
                  this.purge(),
                    ...
                    this.clearData(),
                    s &&
                      e.NodeList.each(this.all("*"), function (t) {
                        (o = i._instances[t[c]]),
                          o ? o.destroy() : e.Event.purgeElement(t);
                      }),
                    (this._node = null),
                    (this._stateProxy = null),
                    delete i._instances[this._yuid];
                },
                ...
                swap: e.config.doc.documentElement.swapNode
                  ? function (s) {
          ...
          var g = function (s) {
            ...
            s &&
              (typeof s == "string"
                ? ((this._query = s), (s = e.Selector.query(s)))
                : s.nodeType || a.isWindow(s)
                ? (s = [s])
                : typeof SVGElementInstance != "undefined" &&
                  s.correspondingElement
                ? (s = [s.correspondingUseElement || s.correspondingElement])
          ...
          (g.NAME = "NodeList"),
              ...
              s &&
                ...
                (g.prototype[s] = function () {
                  var t = [],
                    p = arguments;
                  return (
                    e.Array.each(this._nodes, function (f) {
                      var b =
                          f.uniqueID && f.nodeType !== 9 ? "uniqueID" : "_yuid",
                        N = e.Node._instances[f[b]],
                        O,
                        y;
                      N || (N = g._getTempNode(f)),
                        (O = o || N),
                        (y = c.apply(O, p)),
                        y !== void 0 && y !== N && (t[t.length] = y);
                    }),
                    t.length ? t : this
                  );
                });
            ...
            (g._getTempNode = function (s) {
              var c = g._tempNode;
              return (
                c || ((c = e.Node.create("<div></div>")), (g._tempNode = c)),
                (c._node = s),
                (c._stateProxy = s),
                c
              );
            ...
            e.mix(
              g.prototype,
              {
                ...
                each: function (s, c) {
                  var o = this;
                  return (
                    e.Array.each(this._nodes, function (t, p) {
                ...
                batch: function (s, c) {
                  ...
                  return (
                    e.Array.each(this._nodes, function (t, p) {
                      ...
                      return (
                        f || (f = g._getTempNode(t)), s.call(c || f, f, p, o)
                      );
                    }),
                    o
                  );
                    ...
                    o &&
                      (t ||
                        (c &&
                          ...
                          c[0].ownerDocument &&
                          (t = c[0].ownerDocument)),
                      (this._nodes = e.Selector.query(o, t))),
                    this
                  );
                },
                size: function () {
                ...
                toString: function () {
                  ...
                  return (
                    o &&
                      ...
                      (s += t[m]),
                      t.id && (s += "#" + t.id),
                      t.className && (s += "." + t.className.replace(" ", ".")),
                      o.length > 1 && (s += "...[" + o.length + " items]")),
                    s || c
                  );
                },
            ...
            g.importMethod(e.Node.prototype, [
              "destroy",
              "empty",
              "remove",
              "set",
            ...
            (g.prototype.get = function (s) {
              ...
              return (
                o[0] &&
                  ((f = e.Node._instances[o[0]._yuid] || p(o[0])),
                  (b = f._get(s)),
                  b && b.nodeType && (t = !0)),
                e.Array.each(o, function (N) {
                  (f = e.Node._instances[N._yuid]),
                    f || (f = p(N)),
                    (b = f._get(s)),
                    t || (b = e.Node.scrubVal(b, f)),
                    c.push(b);
                }),
                t ? e.all(c) : c
              );
          ...
          e.Object.each(h, function (s, c) {
            A.prototype[c] = function () {
              for (
                var o = [], t = 0, p, f;
                typeof (p = arguments[t++]) != "undefined";

              )
                o.push(p._node || p._nodes || p);
              return (
                (f = E[c].apply(this._nodes, o)),
                s ? (f = e.all(f)) : (f = e.Node.scrubVal(f)),
                f
              );
            };
          }),
        ...
        function (e, q) {
          (e.Node.prototype._ioComplete = function (T, m, _) {
            ...
            m &&
              m.responseText &&
              ((d = m.responseText),
              v && ((n = e.DOM.create(d)), (d = e.Selector.query(v, n))),
              this.setContent(d)),
              u && u.call(this, T, m);
          }),
      ...
      YUI.add(
        ...
        function (e, q) {
          (e.Node.plug = function () {
            ...
            return (
              T.unshift(e.Node), e.Plugin.Host.plug.apply(e.Base, T), e.Node
            );
          }),
            (e.Node.unplug = function () {
              var T = e.Array(arguments);
              return (
                T.unshift(e.Node), e.Plugin.Host.unplug.apply(e.Base, T), e.Node
              );
            }),
            ...
            (e.NodeList.prototype.plug = function () {
              var T = arguments;
              return (
                e.NodeList.each(this, function (m) {
      ...
      YUI.add(
        ...
        function (e, q) {
          e.each(
            ...
            function (T) {
              e.Node.ATTRS[T] = {
                getter: function () {
                  ...
                  return (
                    m.unshift(e.Node.getDOMNode(this)), e.DOM[T].apply(this, m)
                  );
                },
              };
            }
            ...
            (e.Node.ATTRS.scrollLeft = {
              ...
              setter: function (T) {
                ...
                m &&
                  ("scrollLeft" in m
                    ? (m.scrollLeft = T)
                    : (m.document || m.nodeType === 9) &&
                      e.DOM._getWin(m).scrollTo(T, e.DOM.docScrollY(m)));
              },
            }),
              ...
              setter: function (T) {
                ...
                m &&
                  ("scrollTop" in m
                    ? (m.scrollTop = T)
                    : (m.document || m.nodeType === 9) &&
                      e.DOM._getWin(m).scrollTo(e.DOM.docScrollX(m), T));
              },
            }),
            e.Node.importMethod(e.DOM, [
              "getXY",
            ...
            (e.Node.prototype.intersect = function (T, m) {
              var _ = e.Node.getDOMNode(this);
              return (
                e.instanceOf(T, e.Node) && (T = e.Node.getDOMNode(T)),
                e.DOM.intersect(_, T, m)
              );
            }),
        ...
        function (e, q) {
          (function (m) {
            m.mix(m.Node.prototype, {
              ...
              m.NodeList.importMethod(m.Node.prototype, [
                "getStyle",
                "getComputedStyle",
                "setStyle",
                "setStyles",
          ...
          e.mix(T.prototype, {
            ...
            _isHidden: function () {
              return (
                ...
                e.DOM.getComputedStyle(this._node, "display") === "none"
              );
            },
            ...
            _toggleView: function (m, _) {
              return (
                ...
                typeof m != "boolean" && (m = this._isHidden() ? 1 : 0),
                m ? this._show() : this._hide(),
                typeof _ == "function" && _.call(this),
                this
              );
            },
            hide: function (m) {
          ...
          (e.augment = function (r, a, i, l, g) {
            ...
            return (
              ...
              E &&
                ...
                (f = function (b, N, O) {
                  for (var y in p)
                    u.call(p, y) && b[y] === t[y] && (b[y] = p[y]);
                  return a.apply(b, g), N.apply(b, O);
                }),
                l
                  ? e.Array.each(l, function (b) {
                      b in h && c(h[b], b);
                    })
                  : e.Object.each(h, c, null, !0)),
              e.mix(s, o || h, i, l),
              E || a.apply(s, g),
              r
            );
            ...
            (e.clone = function (r, a, i, l, g, A) {
              ...
              return (
                e.each(
                  ...
                  function (t, p) {
                    (p || p === 0) &&
                      (!i || i.call(l || this, t, p, this, r) !== !1) &&
                      p !== v &&
                      (p == "prototype" ||
                        (this[p] = e.clone(t, a, i, l, g || r, h)));
                  },
                  E
                ),
                A ||
    ...
    693373: function () {
      YUI.add(
        ...
        function (e, q) {
          function T(m) {
            this.hasImpl && this.hasImpl(e.Plugin.Base)
              ? T.prototype.initializer.apply(this, arguments)
              : T.superclass.constructor.apply(this, arguments);
          }
          (T.ATTRS = { host: { writeOnce: !0 } }),
            (T.NAME = "plugin"),
            (T.NS = "plugin"),
            e.extend(T, e.Base, {
              _handles: null,
              ...
              destructor: function () {
                if (this._handles)
                  for (var m = 0, _ = this._handles.length; m < _; m++)
                    this._handles[m].detach();
              },
              doBefore: function (m, _, v) {
                ...
                return (
                  m in u
                    ? (n = this.beforeHostMethod(m, _, v))
                    : u.on && (n = this.onHostEvent(m, _, v)),
                  n
                );
              },
              doAfter: function (m, _, v) {
                ...
                return (
                  m in u
                    ? (n = this.afterHostMethod(m, _, v))
                    : u.after && (n = this.afterHostEvent(m, _, v)),
                  n
                );
              },
          ...
          (m.prototype = {
            plug: function (_, v) {
              ...
              if (T.isArray(_))
                ...
                _ && !T.isFunction(_) && ((v = _.cfg), (_ = _.fn)),
                  _ &&
                    _.NS &&
                    ((d = _.NS),
                    (v = v || {}),
                    (v.host = this),
                    this.hasPlugin(d)
                      ? this[d].setAttrs && this[d].setAttrs(v)
                      : ((this[d] = new _(v)), (this._plugins[d] = _)));
              return this;
            },
            unplug: function (_) {
              var v = _,
              ...
              if (_)
                T.isFunction(_) &&
                  ((v = _.NS), v && (!u[v] || u[v] !== _) && (v = null)),
                  v &&
                    (this[v] &&
                      (this[v].destroy && this[v].destroy(), delete this[v]),
                    u[v] && delete u[v]);
              else
                for (v in this._plugins)
                  this._plugins.hasOwnProperty(v) && this.unplug(v);
              return this;
            },
            ...
            _initPlugins: function (_) {
              (this._plugins = this._plugins || {}),
                this._initConfigPlugins && this._initConfigPlugins(_);
            },
          ...
          (T.prototype._initConfigPlugins = function (_) {
            ...
            (T.plug = function (_, v, u) {
              ...
              if (_ !== e.Base)
                for (
                  _._PLUG = _._PLUG || {},
                    m.isArray(v) || (u && (v = { fn: v, cfg: u }), (v = [v])),
                    d = 0,
                    r = v.length;
                  d < r;
                  d++
                )
                  (n = v[d]), (a = n.NAME || n.fn.NAME), (_._PLUG[a] = n);
            }),
            (T.unplug = function (_, v) {
              ...
              if (_ !== e.Base)
                for (
                  ...
                  (u = v[n]),
                    (r = u.NAME),
                    _._PLUG[r] ? delete _._PLUG[r] : (_._UNPLUG[r] = u);
            });
        },
        "3.17.2",
        ...
        function (e, q) {
          ...
          e.mix(_.prototype, {
            then: function (u, n) {
              ...
              return new d(function (a, i) {
                r._addCallbacks(
                  typeof u == "function" ? _._wrap(a, i, u) : a,
                  typeof n == "function" ? _._wrap(a, i, n) : i
                );
              });
            },
            catch: function (u) {
              ...
              return function (r) {
                ...
                try {
                  ...
                  i instanceof Error
                    ...
                    : console.error(
                        "Non-error error: Please throw actual errors!\n" + i
                      ),
                    n(i);
                  return;
                }
            ...
            (_.resolve = function (u) {
              return _.isPromise(u) && u.constructor === this
                ? u
                : new this(function (n) {
                    n(u);
                  });
            ...
            (_.all = function (u) {
              ...
              return new n(function (d, r) {
                if (!T.isArray(u)) {
                  r(
                    new TypeError(
                      "Promise.all expects an array of values or promises"
                    )
                  );
                  return;
                }
            ...
            (_.race = function (u) {
              ...
              return new n(function (d, r) {
                if (!T.isArray(u)) {
                  r(
                    new TypeError(
                      "Promise.race expects an array of values or promises"
                    )
                  );
                  return;
                }
                for (var a = 0, i = u.length; a < i; a++)
                  n.resolve(u[a]).then(d, r);
              });
            }),
            (e.Promise = _);
          function v(u) {
          ...
          e.mix(
            v.prototype,
            {
              fulfill: function (u) {
                this._status === "pending" &&
                  ((this._result = u), (this._status = "fulfilled")),
              ...
              reject: function (u) {
                this._status === "pending" &&
                  ((this._result = u), (this._status = "rejected")),
              ...
              _addCallbacks: function (u, n) {
                var d = this._callbacks,
                  ...
                  a = this._status,
                  i = this._result;
                d && typeof u == "function" && d.push(u),
                  r && typeof n == "function" && r.push(n),
                  a === "fulfilled"
                    ? this.fulfill(i)
                    : a === "rejected" && this.reject(i);
              },
              getStatus: function () {
                return this._status;
              },
            ...
            (e.Promise.Resolver = v),
            (e.when = function (u, n, d) {
            ...
            for (d in _)
              if (_.hasOwnProperty(d))
                if (e.Lang.isArray(_[d]))
                  for (r = 0, a = _[d].length; r < a; r++)
                    u.push(m(n ? d + "[]" : d) + "=" + m(_[d][r]));
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = e.namespace("QueryString"),
            m = [],
            _ = e.Lang;
          (T.escape = encodeURIComponent),
            (T.stringify = function (v, u, n) {
              var d,
                r,
                a,
                i,
              ...
              if (_.isNull(v) || _.isUndefined(v) || _.isFunction(v))
                return n ? T.escape(n) + E : "";
              if (
                ((_.isBoolean(v) ||
                ...
                return T.escape(n) + E + T.escape(v);
              if (_.isArray(v)) {
                for (
                  g = [], n = h ? n + "[]" : n, i = v.length, a = 0;
                  a < i;
                  a++
                )
                  g.push(T.stringify(v[a], u, n));
                return g.join(A);
              }
              ...
              for (a in v)
                v.hasOwnProperty(a) &&
                  ((l = d + a + r), g.push(T.stringify(v[a], u, l)));
          ...
          (function (T) {
            ...
            var m = "compareDocumentPosition",
              ...
              v = {
                ...
                _compare:
                  "sourceIndex" in T.config.doc.documentElement
                    ? function (u, n) {
                        var d = u.sourceIndex,
                          r = n.sourceIndex;
                        return d === r ? 0 : d > r ? 1 : -1;
                      }
                    : T.config.doc.documentElement[m]
                    ? function (u, n) {
                        return u[m](n) & 4 ? -1 : 1;
                      }
                    : function (u, n) {
                ...
                _sort: function (u) {
                  return (
                    u &&
                      ((u = T.Array(u, 0, !0)), u.sort && u.sort(v._compare)),
                    u
                  );
                },
                _deDupe: function (u) {
                  var n = [],
                    ...
                    r;
                  for (d = 0; (r = u[d++]); )
                    r._found || ((n[n.length] = r), (r._found = !0));
                  for (d = 0; (r = n[d++]); )
                ...
                query: function (u, n, d, r) {
                  ...
                  var a = [],
                    i =
                      T.Selector.useNative && T.config.doc.querySelector && !r,
                    l = [[u, n]],
                    g,
                    A,
                    E,
                    h = i ? T.Selector._nativeQuery : T.Selector._bruteQuery;
                  if (u && h) {
                    for (
                      !r && (!i || n.tagName) && (l = v._splitQueries(u, n)),
                        E = 0;
                      (g = l[E++]);
                ...
                _replaceSelector: function (u) {
                  var n = T.Selector._parse("esc", u),
                    ...
                    r;
                  return (
                    (u = T.Selector._replace("esc", u)),
                    (r = T.Selector._parse("pseudo", u)),
                    (u = v._replace("pseudo", u)),
                    (d = T.Selector._parse("attr", u)),
                    (u = T.Selector._replace("attr", u)),
                    { esc: n, attrs: d, pseudos: r, selector: u }
                  );
                },
                _restoreSelector: function (u) {
                  var n = u.selector;
                  return (
                    (n = T.Selector._restore("attr", n, u.attrs)),
                    (n = T.Selector._restore("pseudo", n, u.pseudos)),
                    (n = T.Selector._restore("esc", n, u.esc)),
                    n
                  );
                },
                _replaceCommas: function (u) {
                  ...
                  return (
                    u &&
                      ((u = u.replace(/,/g, "\uE007")),
                      (n.selector = u),
                      (u = T.Selector._restoreSelector(n))),
                    u
                  );
                },
                _splitQueries: function (u, n) {
                  ...
                  if (n)
                    for (
                      n.nodeType === 1 &&
                        ((i = T.Selector._escapeId(T.DOM.getId(n))),
                        i || ((i = T.guid()), T.DOM.setId(n, i)),
                        (a = '[id="' + i + '"] ')),
                        l = 0,
                        g = d.length;
                      l < g;
                ...
                _nativeQuery: function (u, n, d) {
                  if (
                    (T.UA.webkit || T.UA.opera) &&
                    u.indexOf(":checked") > -1 &&
                    T.Selector.pseudos &&
                    T.Selector.pseudos.checked
                  )
                ...
                filter: function (u, n) {
                  ...
                  if (u && n)
                    for (r = 0; (a = u[r++]); )
                      T.Selector.test(a, n) && (d[d.length] = a);
                  return d;
                },
                test: function (u, n, d) {
                  var r = !1,
                      ...
                      for (
                        i = n.split(","),
                          !d &&
                            ...
                            l
                              ? (d = l)
                              : ((E = u[_].createDocumentFragment()),
                                E.appendChild(u),
                                (d = E),
                                (a = !0))),
                          d = d || u[_],
                          h = T.Selector._escapeId(T.DOM.getId(u)),
                          h || ((h = T.guid()), T.DOM.setId(u, h)),
                          s = 0;
                        (o = i[s++]);
        ...
        function (e, q) {
          ...
          (v.prototype.push = function (t) {
            ...
            (v.prototype.shift = function () {
              ...
              return (
                (this[t] = void 0),
                (this.front = (t + 1) & (this.capacity - 1)),
                this.length--,
                p
              );
            }),
            ...
            (v.prototype.snap = function (t) {
              return typeof t != "number"
                ? this.minCapacity
                : n(Math.min(this.maxCapacity, Math.max(this.minCapacity, t)));
            }),
            (v.prototype.maxCapacity = (1 << 30) | 0),
            (v.prototype.minCapacity = 16),
            (v.prototype.growFactor = 8);
          ...
          if (A)
            a = function () {
              var t = g.domain;
              t && ((l = l || _("domain")), (l.active = g.domain = null)),
                r && i ? setImmediate(E) : g.nextTick(E),
                t && (l.active = g.domain = t);
            };
          else if (i)
            a = function () {
              setImmediate(E);
      ...
      YUI.add(
        ...
        function (e, q) {
          ...
          (c._TRANSFORM = "transform"),
            (c._toCamel = function (t) {
              return (
                (t = t.replace(/-([a-z])/gi, function (p, f) {
            ...
            (c.useNative = !1),
            "transition" in u &&
            "transitionProperty" in u &&
            "transitionDuration" in u &&
            "transitionTimingFunction" in u &&
            "transitionDelay" in u
              ? ((c.useNative = !0), (c.supported = !0))
              : e.Array.each(h, function (t) {
                  var p = t + "Transition";
                  p in _[v].style &&
                    ((T = t),
                    (m = c._toHyphen(t) + "-"),
            ...
            typeof u.transform == "undefined" &&
              e.Array.each(h, function (t) {
                var p = t + "Transform";
                typeof u[p] != "undefined" && (c._TRANSFORM = p);
              }),
            T && ((n = T + "Transition"), (d = T + "TransitionProperty")),
            (r = m + "transition-property"),
            (a = m + "transition-duration"),
            (i = m + "transition-timing-function"),
            (l = m + "transition-delay"),
            (g = "transitionend"),
            (A = "on" + T.toLowerCase() + "transitionend"),
            (g = s[T] || g),
            (c.fx = {}),
            (c.toggles = {}),
            (c._hasEnd = {}),
            (c._reKeywords =
              /^(?:node|duration|iterations|easing|delay|on|onstart|onend)$/i),
            (e.Node.DOM_EVENTS[g] = 1),
            (c.NAME = "transition"),
            (c.DEFAULT_EASING = "ease"),
            (c.DEFAULT_DURATION = 0.5),
            (c.DEFAULT_DELAY = 0),
            (c._nodeAttrs = {}),
            (c.prototype = {
              constructor: c,
                ...
                return (
                  ...
                  !f._running &&
                    ...
                    (f._duration =
                      "duration" in p
                        ? p.duration
                        : f.constructor.DEFAULT_DURATION),
                    (f._delay =
                      "delay" in p ? p.delay : f.constructor.DEFAULT_DELAY),
                    (f._easing = p.easing || f.constructor.DEFAULT_EASING),
                    (f._count = 0),
                    (f._running = !1)),
                  f
                );
              ...
              addProperty: function (t, p) {
                ...
                y || (y = c._nodeAttrs[N] = {}),
                  ...
                  p && p.value !== void 0
                    ? (S = p.value)
                    : p !== void 0 && ((S = p), (p = E)),
                  typeof S == "function" && (S = S.call(O, O)),
                  x &&
                    x.transition &&
                    x.transition !== f &&
                    x.transition._count--,
                  ...
                  (C = e.DOM.getComputedStyle(b, t)),
                  (I = typeof S == "string" ? C : parseFloat(C)),
                  c.useNative &&
                    I === S &&
                    setTimeout(function () {
              ...
              initAttrs: function (t) {
                ...
                t.transform &&
                  !t[c._TRANSFORM] &&
                  ((t[c._TRANSFORM] = t.transform), delete t.transform);
                for (p in t)
                  t.hasOwnProperty(p) &&
                    !c._reKeywords.test(p) &&
                    (this.addProperty(p, t[p]),
                    f.style[p] === "" &&
                      e.DOM.setStyle(f, p, e.DOM.getComputedStyle(f, p)));
              },
              run: function (t) {
                var p = this,
                  f = p._node,
                  b = p._config,
                  N = { type: "transition:start", config: b };
                return (
                  p._running ||
                    ((p._running = !0),
                    b.on && b.on.start && b.on.start.call(e.one(f), N),
                    p.initAttrs(p._config),
                    (p._callback = t),
                    p._start()),
                  p
                );
              ...
              _runNative: function () {
                ...
                for (L in O)
                  (D = c._toHyphen(L)),
                    ...
                    (M = O[L]) &&
                      M.transition === t &&
                      (L in p.style
                        ? ((U += t._prepDur(M.duration) + ","),
                          (S += t._prepDur(M.delay) + ","),
                          (x += M.easing + ","),
                          (I += D + ","),
                          (y += D + ": " + M.value + "; "))
                ...
                (I = I.replace(/,$/, ";")),
                  ...
                  (S = S.replace(/,$/, ";")),
                  c._hasEnd[f] ||
                    (p.addEventListener(g, t._onNativeEnd, ""),
                    (c._hasEnd[f] = !0)),
                  (b.cssText += I + U + x + S + y);
              },
              _end: function (t) {
                var p = this,
                  ...
                  b = p._callback,
                  N = p._config,
                  O = { type: "transition:end", config: N, elapsedTime: t },
                  y = e.one(f);
                (p._running = !1),
                  (p._callback = null),
                  f &&
              ...
              _endNative: function (t) {
                var p = this._node,
                  f = p.ownerDocument.defaultView.getComputedStyle(p, "")[
                    c._toCamel(r)
                  ];
                (t = c._toHyphen(t)),
                  typeof f == "string" &&
                    ((f = f.replace(new RegExp("(?:^|,\\s)" + t + ",?"), ",")),
                    (f = f.replace(/^,|,$/, "")),
                    (p.style[n] = f));
              },
              _onNativeEnd: function (t) {
                ...
                I &&
                  ...
                  x && x.on && x.on.end && x.on.end.call(e.one(p), U),
                  I._count <= 0 && (I._end(O), (p.style[d] = "")));
              },
              destroy: function () {
                var t = this,
                  p = t._node;
                p &&
                  (p.removeEventListener(g, t._onNativeEnd, !1),
                  (t._node = null));
              },
            }),
            (e.Transition = c),
            (e.TransitionNative = c),
            (e.Node.prototype.transition = function (t, p, f) {
              ...
              return (
                N && !N._running ? N.init(this, p) : (N = new c(this._node, p)),
                N.run(f),
                this
              );
            }),
            (e.Node.prototype.show = function (t, p, f) {
              return (
                ...
                t &&
                  ...
                  (typeof t != "string" &&
                    !t.push &&
                    (typeof p == "function" && ((f = p), (p = t)),
                    (t = c.SHOW_TRANSITION)),
                  this.transition(t, p, f)),
                this
              );
            }),
            (e.NodeList.prototype.show = function (t, p, f) {
              for (var b = this._nodes, N = 0, O; (O = b[N++]); )
                e.one(O).show(t, p, f);
              return this;
            });
          var o = function (t, p, f) {
            return function () {
              p && p.call(t),
                f && typeof f == "function" && f.apply(t._node, arguments);
            };
          };
          (e.Node.prototype.hide = function (t, p, f) {
            ...
            (e.NodeList.prototype.transition = function (t, p, f) {
              for (
                var b = this._nodes, N = this.size(), O = 0, f = f === !0, y;
                (y = b[O++]);

              )
                O < N && f ? e.one(y).transition(t) : e.one(y).transition(t, p);
              return this;
            }),
            (e.Node.prototype.toggleView = function (t, p, f) {
              ...
              return (
                ...
                typeof p == "undefined" &&
                  ...
                  (p = !this._toggles[t]),
                (p = p ? 1 : 0),
                p ? this._show() : (f = o(this, this._hide, f)),
                (this._toggles[t] = p),
                this.transition(e.Transition.toggles[t][p], f),
                this
              );
            }),
            (e.NodeList.prototype.toggleView = function (t, p, f) {
              for (var b = this._nodes, N = 0, O; (O = b[N++]); )
                (O = e.one(O)), O.toggleView.apply(O, arguments);
              return this;
            }),
            e.mix(c.fx, {
        ...
        function (e, q) {
          ...
          function B(H) {
            var V = this,
              ...
              W = V.constructor;
            (V._strs = {}),
              (V._cssPrefix = W.CSS_PREFIX || v(W.NAME.toLowerCase())),
              (H = H || {}),
              B.superclass.constructor.call(V, H),
              (j = V.get(N)),
              j && (j !== L && (G = j), V.render(G));
          }
          (B.NAME = "widget"),
            (P = B.UI_SRC = "ui"),
            (B.ATTRS = R),
            (R[b] = { valueFn: "_guid", writeOnce: L }),
            (R[O] = { value: w, readOnly: L }),
            (R[E] = { valueFn: "_defaultBB", setter: "_setBB", writeOnce: L }),
            (R[h] = { valueFn: "_defaultCB", setter: "_setCB", writeOnce: L }),
            (R[f] = { value: null, validator: "_validTabIndex" }),
            (R[l] = { value: w, readOnly: L }),
            (R[i] = { value: w }),
            (R[r] = { value: L }),
            (R[A] = { value: D }),
            (R[g] = { value: D }),
            (R[C] = { value: {}, setter: "_strSetter", getter: "_strGetter" }),
            (R[N] = { value: w, writeOnce: L }),
            (B.CSS_PREFIX = v(B.NAME.toLowerCase())),
            (B.getClassName = function () {
              return v.apply(_, [B.CSS_PREFIX].concat(e.Array(arguments), !0));
            }),
            (u = B.getClassName),
            (B.getByNode = function (H) {
              var V,
                G = u();
              return (
                (H = m.one(H)),
                H &&
                  ((H = H.ancestor("." + G, !0)), H && (V = X[e.stamp(H, !0)])),
                V || null
              );
            }),
            e.extend(B, e.Base, {
              getClassName: function () {
                return v.apply(
                  _,
                  [this._cssPrefix].concat(e.Array(arguments), !0)
                );
              },
              ...
              destroy: function (H) {
                return (
                  (this._destroyAllNodes = H), B.superclass.destroy.apply(this)
                );
              },
              _destroyBox: function () {
                ...
                (j = H && H.compareTo(V)),
                  ...
                  this._unbindUI(H),
                  V && (G && V.empty(), V.remove(L)),
                  j || (G && H.empty(), H.remove(L));
              },
              render: function (H) {
                return (
                  !this.get(y) &&
                    ...
                    this.fire(N, { parentNode: H ? m.one(H) : null })),
                  this
                );
              },
              _defRenderFn: function (H) {
                (this._parentNode = H.parentNode),
                  this.renderer(),
                  this._set(O, L),
              ...
              _renderBox: function (H) {
                ...
                W && !W.compareTo(G) && !G.inDoc(z) && W.replace(G),
                  !j.compareTo(G.get(s)) &&
                    !j.compareTo(G) &&
                    (G.inDoc(z) && G.replace(j), j.appendChild(G)),
                  (H = H || (te && m.one(te))),
                  H ? H.appendChild(j) : j.inDoc(z) || m.one(p).insert(j, 0);
              },
              _setBB: function (H) {
                return this._setBox(this.get(b), H, this.BOUNDING_TEMPLATE, !0);
              },
              _setCB: function (H) {
                return this.CONTENT_TEMPLATE === null
                  ? this.get(E)
                  : this._setBox(null, H, this.CONTENT_TEMPLATE, !1);
              },
              _defaultBB: function () {
                var H = this.get(t),
              ...
              _setBox: function (H, V, G, j) {
                return (
                  ...
                  V ||
                    ((V = m.create(G)),
                    j
                      ? (this._bbFromTemplate = !0)
                      : (this._cbFromTemplate = !0)),
                  V.get(b) || V.set(b, H || e.guid()),
                  V
                );
              },
              _renderUI: function () {
              ...
              _renderBoxClassNames: function () {
                var H = this._getClasses(),
                  ...
                  G = this.get(E),
                  j;
                for (G.addClass(u()), j = H.length - 3; j >= 0; j--)
                  (V = H[j]),
                    G.addClass(V.CSS_PREFIX || v(V.NAME.toLowerCase()));
              ...
              _removeLoadingClassNames: function () {
                var H = this.get(E),
                  ...
                  j = u(x);
                H.removeClass(j).removeClass(G),
                  V.removeClass(j).removeClass(G);
              },
              _bindUI: function () {
              ...
              _bindDOM: function () {
                var H = this.get(E).get(c),
                  V = B._hDocFocus;
                V ||
                  ((V = B._hDocFocus = H.on("focus", this._onDocFocus, this)),
                  (V.listeners = { count: 0 })),
                  (V.listeners[e.stamp(this, !0)] = !0),
                  V.listeners.count++,
                  F &&
                    (this._hDocMouseDown = H.on(
                      "mousedown",
              ...
              _unbindDOM: function (H) {
                var V = B._hDocFocus,
                  G = e.stamp(this, !0),
                  j,
                  W = this._hDocMouseDown;
                V &&
                  ((j = V.listeners),
                  j[G] && (delete j[G], j.count--),
                  j.count === 0 && (V.detach(), (B._hDocFocus = null))),
                  F && W && W.detach();
              },
              _syncUI: function () {
              ...
              _uiSetFocused: function (H, V) {
                var G = this.get(E);
                G.toggleClass(this.getClassName(l), H),
                  V !== P && (H ? G.focus() : G.blur());
              },
      ...
      YUI.add(
        ...
        function (e, q) {
          var T = e.Widget,
            ...
            u = "contentBox";
          (T.HTML_PARSER = {}),
            (T._buildCfg = { aggregates: ["HTML_PARSER"] }),
            (T.ATTRS[v] = {
              value: null,
              setter: m.one,
              getter: "_getSrcNode",
            ...
            e.mix(T.prototype, {
              ...
              _preAddAttrs: function (n, d, r) {
                ...
                this.addAttrs(a, d, r),
                  ...
                  delete n.srcNode,
                  delete n.id,
                  this._applyParser && this._applyParser(d);
              },
              ...
              _applyParser: function (n) {
                ...
                a &&
                  r &&
                  e.Object.each(a, function (g, A, E) {
                    (l = null),
                      _.isFunction(g)
                        ? (l = g.call(d, r))
                        : _.isArray(g)
                        ? ((l = r.all(g[0])), l.isEmpty() && (l = null))
                        : (l = r.one(g)),
                      l != null && ((i = i || {}), (i[A] = l));
                  }),
              ...
              _getHtmlParser: function () {
                ...
                for (r = n.length - 1; r >= 0; r--)
                  (a = n[r].HTML_PARSER), a && e.mix(d, a, !0);
                return d;
              },
            });
        },
          ...
          e.mix(
            m.prototype,
            {
              _destroyUIEvents: function () {
                ...
                e.each(n, function (r, a) {
                  r.instances[d] &&
                    ...
                    e.Object.isEmpty(r.instances) &&
                      (r.handle.detach(), n[a] && delete n[a]));
                });
              },
                ...
                i ||
                  ((l = r.delegate(
                    ...
                    function (g) {
                      ...
                      A &&
                        A._filterUIEvent(g) &&
                        A.fire(g.type, { domEvent: g });
                    },
                    "." + e.Widget.getClassName()
                  )),
                  (n[a] = i = { instances: {}, handle: l })),
                  (i.instances[e.stamp(this)] = 1);
              },
              _filterUIEvent: function (d) {
                return (
                  d.currentTarget.compareTo(d.container) ||
                  d.container.compareTo(this._getUIEventNode())
                );
              },
              _getUIEvent: function (d) {
                if (v.isString(d)) {
                  ...
                  return (
                    r &&
                      ((a = r.indexOf(u)),
                      a > -1 && (r = r.substring(a + u.length)),
                      this.UI_EVENTS[r] && (i = r)),
                    i
                  );
                }
              },
              _initUIEvent: function (d) {
                ...
                r &&
                  !a[r] &&
                  ((this._uiEvtsInitQueue = a[r] = 1),
                  this.after(_, function () {
                    this._createUIEvent(r), delete this._uiEvtsInitQueue[r];
                  }));
              },
              on: function (d) {
                return (
                  this._initUIEvent(d), m.superclass.on.apply(this, arguments)
                );
              },
              publish: function (d, r) {
                var a = this._getUIEvent(d);
                return (
                  a && r && r.defaultFn && this._initUIEvent(a),
                  m.superclass.publish.apply(this, arguments)
                );
              },
            },
            !0
    ...
    677582: function () {
      YUI.add(
        "yui-throttle",
        function (e, q) {
          /*! Based on work by Simon Willison: http://gist.github.com/292562 */ e.throttle =
            function (T, m) {
              if (((m = m || e.config.throttleTime || 150), m === -1))
                return function () {
