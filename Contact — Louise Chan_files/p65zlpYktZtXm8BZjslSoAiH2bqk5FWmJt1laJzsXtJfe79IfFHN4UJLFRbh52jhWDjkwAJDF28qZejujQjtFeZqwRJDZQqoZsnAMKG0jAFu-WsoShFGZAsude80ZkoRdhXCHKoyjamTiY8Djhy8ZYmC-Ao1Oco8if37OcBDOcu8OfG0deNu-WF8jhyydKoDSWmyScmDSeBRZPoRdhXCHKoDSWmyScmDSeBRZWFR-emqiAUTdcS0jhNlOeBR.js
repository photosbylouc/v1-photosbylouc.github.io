...
window.Typekit.config = {
  a: "646866",
  dl: "AAAA5wAAAAreiGdvGvnJFfPl81OIut-hfEBKIx0aBktOUx0NAAAAQA",
  fi: [12783, 12786, 31623, 12790, 34661, 34669, 34662, 34670, 8482],
  fc: [
    {
      id: 12783,
      family: "franklin-gothic-urw",
      src: "https://use.typekit.net/af/801a74/000000000000000000012126/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "300",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      id: 12786,
      family: "franklin-gothic-urw",
      src: "https://use.typekit.net/af/b825af/0000000000000000000118b1/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      id: 31623,
      family: "franklin-gothic-urw",
      src: "https://use.typekit.net/af/522391/000000000000000077359dfb/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "300",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      id: 12790,
      family: "franklin-gothic-urw",
      src: "https://use.typekit.net/af/9a7284/0000000000000000000118b2/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      ...
      src: "https://use.typekit.net/af/272149/00000000000000007735adb1/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "300",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      id: 34669,
      family: "halyard-display",
      src: "https://use.typekit.net/af/e51fb7/00000000000000007735adc9/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      id: 34662,
      family: "halyard-display",
      src: "https://use.typekit.net/af/6bc5ed/00000000000000007735adb4/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "300",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      id: 34670,
      family: "halyard-display",
      src: "https://use.typekit.net/af/8ac9a7/00000000000000007735adcc/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      ...
      src: "https://use.typekit.net/af/3cbd9b/000000000000000000012d68/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "normal",
        stretch: "normal",
  ...
  ht: "tk",
  js: "1.21.0",
  kt: "646866_621b349ddf5a684fd223e99e",
  l: "typekit",
  ps: 2,
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2022-12-21 10:17:43 UTC"}*/
(function (window, document, undefined) {
  ...
  function xa(a) {
    ...
    d
      ? l() - a.F >= a.I
        ? wa() && ya(a, b, c) && (!a.A || a.A.hasOwnProperty(a.b.b))
          ? Q(a, a.D)
          : Q(a, a.H)
        : za(a)
      : Q(a, a.D);
        ...
        if (null === S)
          if (window.FontFace) {
            var e = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent),
              ia = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(
                window.navigator.userAgent
              );
            S = e
              ? 42 < parseInt(e[1], 10)
              : ia && /Apple/.exec(window.navigator.vendor)
              ? 603 <= parseInt(ia[1], 10)
              : !0;
          } else S = !1;
        S
          ? (c = new Aa(
  ...
  for (
    var W, m = window.Typekit.config || {}, Ha = [], Ja = m.fc, Ka = 0;
    Ka < Ja.length;
    Ka++
  )
    Ha.push(Ja[Ka].id);
